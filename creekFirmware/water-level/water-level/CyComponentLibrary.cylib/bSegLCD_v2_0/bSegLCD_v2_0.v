...
`include "cypress.v"
`ifdef bSegLCD_v2_0_ALREADY_INCLUDED
`else
`define bSegLCD_v2_0_ALREADY_INCLUDED
    ...
    */
    ...
    if (PowerMode == 0) begin: NoSleep 
       ...
       cy_psoc3_dp8 #(.cy_dpconfig_a(
        ...
        assign lp_ack = async_lp_ack;//pre_lp_ack;
...
`endif /*bSegLCD_v2_0_ALREADY_INCLUDED*/
