...
*
* Summary:
* Get the number of bytes used in the RX software buffer
*
* Parameters:
* -None-
*
* Return:
* uint8: The number of bytes used in the RX software Buffer
*
* Theory:
*
* Side Effects:
...
*
* Summary:
* Get the number of bytes used in the TX software buffer
*
* Parameters:
* -None-
*
* Return:
* uint8: The number of bytes used in the TX software Buffer
*
* Theory:
*
* Side Effects:
