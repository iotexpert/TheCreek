...
#if !defined(CY_SPIM_v1_0_`$INSTANCE_NAME`_H)
#define CY_SPIM_v1_0_`$INSTANCE_NAME`_H
...
#define `$INSTANCE_NAME`_AUX_CONTROLDP0	    (* (`$RegDefReplacementString` *) `$INSTANCE_NAME`_BSPIM_`$VerilogSectionReplacementString`_dp_u0__DP_AUX_CTL_REG)
#define `$INSTANCE_NAME`_AUX_CONTROLDP0_PTR (  (`$RegDefReplacementString` *) `$INSTANCE_NAME`_BSPIM_`$VerilogSectionReplacementString`_dp_u0__DP_AUX_CTL_REG)
#if (`$INSTANCE_NAME`_DATAWIDTH > 8)
    #define `$INSTANCE_NAME`_AUX_CONTROLDP1	     (* (`$RegDefReplacementString` *) `$INSTANCE_NAME`_BSPIM_`$VerilogSectionReplacementString`_dp_u1__DP_AUX_CTL_REG)
    #define `$INSTANCE_NAME`_AUX_CONTROLDP1_PTR       ((`$RegDefReplacementString` *) `$INSTANCE_NAME`_BSPIM_`$VerilogSectionReplacementString`_dp_u1__DP_AUX_CTL_REG)
#endif
...
#endif  /* CY_SPIM_v1_0_`$INSTANCE_NAME`_H */