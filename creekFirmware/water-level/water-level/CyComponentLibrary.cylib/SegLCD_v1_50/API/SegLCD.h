...
#define `$INSTANCE_NAME`_FRAME_CNT7_PERIOD_REG    (* (reg8 *) `$INSTANCE_NAME`_bLCDDSD_DivCounter__CONTROL_AUX_CTL_REG)
...
#define `$INSTANCE_NAME`_FRAME_CNT7_PERIOD_PTR    ((reg8 *) `$INSTANCE_NAME`_bLCDDSD_DivCounter__CONTROL_AUX_CTL_REG)
#if(`$INSTANCE_NAME`_DRIVER_POWER_MODE == `$INSTANCE_NAME`_LOW_POWER)
    #define `$INSTANCE_NAME`_LOW_DRIVE_DELAY_PTR  ((reg8 *) `$INSTANCE_NAME`_bLCDDSD_LowPower_bLowPowerdp_u0__D0_REG)
#endif /* `$INSTANCE_NAME`_DRIVER_POWER_MODE */

/* Obsolete register names, not for use in new designs */
#define `$INSTANCE_NAME`_LCDDAC_CONTROL            `$INSTANCE_NAME`_LCDDAC_CONTROL_REG
#define `$INSTANCE_NAME`_CONTRAST_CONTROL          `$INSTANCE_NAME`_CONTRAST_CONTROL_REG
#define `$INSTANCE_NAME`_DRIVER_CONTROL            `$INSTANCE_NAME`_DRIVER_CONTROL_REG
#define `$INSTANCE_NAME`_PWR_MGR                   `$INSTANCE_NAME`_PWR_MGR_REG

#define `$INSTANCE_NAME`_CONTROL                   `$INSTANCE_NAME`_CONTROL_REG
#define `$INSTANCE_NAME`_CNT_DELAY                 `$INSTANCE_NAME`_CNT_DELAY_REG
#define `$INSTANCE_NAME`_EN_HI_DELAY               `$INSTANCE_NAME`_EN_HI_DELAY_REG
#define `$INSTANCE_NAME`_CNT_PERIOD                `$INSTANCE_NAME`_CNT_PERIOD_REG
#define `$INSTANCE_NAME`_FRAME_CNT7_PERIOD         `$INSTANCE_NAME`_FRAME_CNT7_PERIOD_REG

#if(`$INSTANCE_NAME`_DRIVER_POWER_MODE == `$INSTANCE_NAME`_LOW_POWER)
    #define `$INSTANCE_NAME`_LOW_DRIVE_DELAY       `$INSTANCE_NAME`_LOW_DRIVE_DELAY_REG
#endif /* `$INSTANCE_NAME`_DRIVER_POWER_MODE */

#define `$INSTANCE_NAME`_LCDDAC_SWITCH_REG0        `$INSTANCE_NAME`_LCDDAC_SWITCH_REG0_PTR
#define `$INSTANCE_NAME`_LCDDAC_SWITCH_REG1        `$INSTANCE_NAME`_LCDDAC_SWITCH_REG1_PTR
#define `$INSTANCE_NAME`_LCDDAC_SWITCH_REG2        `$INSTANCE_NAME`_LCDDAC_SWITCH_REG2_PTR
#define `$INSTANCE_NAME`_LCDDAC_SWITCH_REG3        `$INSTANCE_NAME`_LCDDAC_SWITCH_REG3_PTR
#define `$INSTANCE_NAME`_LCDDAC_SWITCH_REG4        `$INSTANCE_NAME`_LCDDAC_SWITCH_REG4_PTR
...
#define `$INSTANCE_NAME`_CNT_DELAY_VAL            (`$INSTANCE_NAME`_HI_DRIVE_TIME)
    ...
    #define `$INSTANCE_NAME`_LOW_POWER_DELAY_VAL  (`$INSTANCE_NAME`_LOW_DRIVE_INIT_TIME)
