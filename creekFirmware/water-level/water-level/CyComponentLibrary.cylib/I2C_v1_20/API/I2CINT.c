...
//        }
                ...
                case `$INSTANCE_NAME`_SM_MSTR_RD_ADDR:    /* After address is sent, Read some data */
                    ...
                    else if(`$INSTANCE_NAME`_CHECK_ADDR_NAK(tmpCsr))
                    {
                        if(`$INSTANCE_NAME`_mstrControl & `$INSTANCE_NAME`_MSTR_NO_STOP)
                        {
                           ...
                           `$INSTANCE_NAME`_mstrStatus |= `$INSTANCE_NAME`_MSTAT_ERR_ADDR_NAK | `$INSTANCE_NAME`_MSTAT_XFER_HALT; 
    ...
    else  /******** Slave Mode ********/                                        
    {
            ...
            if(tmpCsr & `$INSTANCE_NAME`_CSR_ADDRESS)  
            {
            ...
            if( tmpCsr & `$INSTANCE_NAME`_CSR_STOP_STATUS)         /* Check if Stop was detected */
            {
