/*******************************************************************************
* File Name:  B_SPI_Master_v2_20.v 
...
********************************************************************************/
`include "cypress.v"
`ifdef B_SPI_Master_v2_20__V_ALREADY_INCLUDED
`else
`define B_SPI_Master_v2_20__V_ALREADY_INCLUDED
module B_SPI_Master_v2_20(
...
***************************************************************************/    
	...
	generate
        if(BidirectMode) begin: BidirMode
            ...
            assign pre_tx_enable  = control[CTRL_TX_PERMISSION];
...
`endif /* B_SPIM_v2_10__V_ALREADY_INCLUDED */
