...
#if !defined(CY_Timer_v2_10_`$INSTANCE_NAME`_H)
#define CY_Timer_v2_10_`$INSTANCE_NAME`_H
...
typedef struct `$INSTANCE_NAME`_backupStruct
{
    uint8 TimerEnableState;
            ...
            `$RegSizeReplacementString` TimerUdb;                 /* Timer internal counter value      */
            `$RegSizeReplacementString` TimerPeriod;              /* Timer Period value       */
            uint8 InterruptMaskValue;       /* Timer Compare Value */
            #if (`$INSTANCE_NAME`_UsingHWCaptureCounter)
                `$RegSizeReplacementString` TimerCaptureCounter;  /* Timer Capture Counter Value */
            ...
            #if (`$INSTANCE_NAME`_UsingHWCaptureCounter)
                `$RegSizeReplacementString` TimerCaptureCounter;
...
***************************************/
    ...
    ***************************************/
    ...
    #define `$INSTANCE_NAME`_RT1_MASK                        (0x03u << `$INSTANCE_NAME`_RT1_SHIFT)
    #define `$INSTANCE_NAME`_SYNC                            (0x03u << `$INSTANCE_NAME`_RT1_SHIFT)
    #define `$INSTANCE_NAME`_SYNCDSI_SHIFT                   0x00u
    /* Sync all DSI inputs with Mask  */
    #define `$INSTANCE_NAME`_SYNCDSI_MASK                    (0x0Fu << `$INSTANCE_NAME`_SYNCDSI_SHIFT)
    /* Sync all DSI inputs */
    #define `$INSTANCE_NAME`_SYNCDSI_EN                      (0x0Fu << `$INSTANCE_NAME`_SYNCDSI_SHIFT)
    ...
    /* As defined in Register Map, part of TMRX_SR0 register */
    #define `$INSTANCE_NAME`_STATUS_TC_INT_MASK_SHIFT        (`$INSTANCE_NAME`_STATUS_TC_SHIFT - 4)
    /* As defined in Register Map, part of TMRX_SR0 register, Shared with Compare Status */
    #define `$INSTANCE_NAME`_STATUS_CAPTURE_INT_MASK_SHIFT   (`$INSTANCE_NAME`_STATUS_CAPTURE_SHIFT - 4)
    ...
    #define `$INSTANCE_NAME`_STATUS_TC_INT_MASK              (0x01u << `$INSTANCE_NAME`_STATUS_TC_INT_MASK_SHIFT)
    /* Interrupt Enable Bit-Mask for interrupt on Capture */
    #define `$INSTANCE_NAME`_STATUS_CAPTURE_INT_MASK         (0x01u << `$INSTANCE_NAME`_STATUS_CAPTURE_INT_MASK_SHIFT)
    ...
    ***************************************/
    ...
    #define `$INSTANCE_NAME`_STATUS_TC_INT_MASK             (0x01u << `$INSTANCE_NAME`_STATUS_TC_SHIFT)
    /* Interrupt Enable Bit-Mask */
    #define `$INSTANCE_NAME`_STATUS_CAPTURE_INT_MASK        (0x01u << `$INSTANCE_NAME`_STATUS_CAPTURE_SHIFT)
    ...
    /* Interrupt Enable Bit-Mask */
    #define `$INSTANCE_NAME`_STATUS_FIFOFULL_INT_MASK       (0x01u << `$INSTANCE_NAME`_STATUS_FIFOFULL_SHIFT)
...
#endif  /* CY_Timer_v2_10_`$INSTANCE_NAME`_H */
