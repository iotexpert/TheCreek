...
#define `$INSTANCE_NAME`_INIT_INTERRUPTS_MODE     ((`$IntOnTC`u << `$INSTANCE_NAME`_STATUS_TC_INT_EN_MASK_SHIFT) | (`$IntOnCMP2` << `$INSTANCE_NAME`_STATUS_CMP2_INT_EN_MASK_SHIFT) | (`$IntOnCMP1` << `$INSTANCE_NAME`_STATUS_CMP1_INT_EN_MASK_SHIFT ) | (`$IntOnKill` << `$INSTANCE_NAME`_STATUS_KILL_INT_EN_MASK_SHIFT ))
