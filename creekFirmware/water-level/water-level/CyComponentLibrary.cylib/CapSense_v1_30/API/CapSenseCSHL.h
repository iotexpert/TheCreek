...
/* Widget Types */
#define `$INSTANCE_NAME`_CSHL_TYPE_BUTTON                   0u
#define `$INSTANCE_NAME`_CSHL_TYPE_LINEAR_SLIDER            1u
#define `$INSTANCE_NAME`_CSHL_TYPE_RADIAL_SLIDER            2u
#define `$INSTANCE_NAME`_CSHL_TYPE_TOUCHPAD                 3u
#define `$INSTANCE_NAME`_CSHL_TYPE_MATRIX_BUTTONS           4u
#define `$INSTANCE_NAME`_CSHL_TYPE_PROXIMITY                5u
...
#define `$INSTANCE_NAME`_CSHL_X_TOUCH                       1u
#define `$INSTANCE_NAME`_CSHL_Y_TOUCH                       2u
#define `$INSTANCE_NAME`_CSHL_TRUE_TOUCH                    3u
...
#define  `$INSTANCE_NAME`_CSHL_MAX_FINGERS                  1u

/* Radial Slider defines */
#define `$INSTANCE_NAME`_CSHL_ROTARY_SLIDER_A360            (360u)
#define `$INSTANCE_NAME`_CSHL_ROTARY_SLIDER_A270            (270u)
#define `$INSTANCE_NAME`_CSHL_ROTARY_SLIDER_A180            (180u)
#define `$INSTANCE_NAME`_CSHL_ROTARY_SLIDER_A90             (90u)
