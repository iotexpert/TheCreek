...
namespace  CapSense_v1_30
{
    ...
    public class CyLocalParams
    {
        ...
        public const string m_Conponent_prefix = "CapSense__";
    ...
    public class CyAmuxBParams : ICyMyPostSerialization
    {
        ...
        [XmlIgnore()]
        public E_VREF_OPTIONS m_VrefOptions = E_VREF_OPTIONS.Ref_Vref;

        [XmlElement("m_VrefVdacValue")]
        public CyIntElement m_VrefVdacValue = new CyIntElement(64);
        ...
        public void ExecutePostSerialization()
        {
            ...
            m_VrefVdacValue.TakeMinMax(0, 255);
        }
