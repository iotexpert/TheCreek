...
namespace CapSense_v1_30
{
    ...
    {
        //Default values
        const ushort m_def_IDACSettings = 20;
        const ushort m_def_IDACRange = 0;
        const ushort m_def_CIS = 0;
        ...
        [XmlIgnore()]
        [NonSerialized]
        public CyShareSSProps m_baseProps;
        ...
        public void SetDefaultValues()
        {
            ...
            m_IDACSettings = new CyIntElement(m_def_IDACSettings);
            m_CIS = m_def_CIS;
        ...
        {
            m_IDACSettings.TakeMinMax(0,255);
        }
    ...
    {
        const ushort m_def_PrescPer = 20;
        const ushort m_def_Scanlength = 6;
        const ushort m_def_SettlingTime = 6;
        const ushort m_def_Resolution = 0;
        const ushort m_def_ScanSpeed = 0;

        [XmlAttribute("RefVal")]
        public int m_RefVal = 0;

        [XmlElement("PrescPer")]
        public CyIntElement m_PrescPer = new CyIntElement(m_def_PrescPer);

        //CSD
        [XmlAttribute("Resolution")]
        public int m_Resolution = m_def_Resolution;
        [XmlAttribute("ScanSpeed")]
        public int m_ScanSpeed = m_def_ScanSpeed;

        //CSA
        [XmlElement("Scanlength")]
        public CyIntElement m_Scanlength = new CyIntElement(m_def_Scanlength);

        [XmlElement("SettlingTime")]
        public CyIntElement m_SettlingTime = new CyIntElement(m_def_SettlingTime);
        ...
        public void SetDefaultValues()
        {
            m_PrescPer = new CyIntElement(m_def_PrescPer);
            m_Resolution = m_def_Resolution;
            m_ScanSpeed = m_def_ScanSpeed;
            ExecutePostSerialization();
        }
        public void ExecutePostSerialization()
        {
