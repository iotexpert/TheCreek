...
namespace  CapSense_v1_30
{
    public partial class CyScanSlotsTab : CyMyICyParamEditTemplate
    {
            ...
            : base()
        {
            ...
            LabelHeadRight.Text = "Right " + CyGeneralParams.STR_AB_HEAD;
            LabelHeadRight.BackColor = CyGeneralParams.COLOR_RIGHT;
            LabelHeadLeft.BackColor = CyGeneralParams.COLOR_LEFT;
            ...
            this.cmdPromoteL.Image = ((System.Drawing.Image)(
                global:: CapSense_v1_30.Properties.Resources.ResourceManager.GetObject("cmdpromote")));
            this.cmdPromoteR.Image = ((System.Drawing.Image)(
                global:: CapSense_v1_30.Properties.Resources.ResourceManager.GetObject("cmdpromote")));
            this.cmdDemoteL.Image = ((System.Drawing.Image)(
                global:: CapSense_v1_30.Properties.Resources.ResourceManager.GetObject("cmddemote")));
        ...
        {
            sCLeftHalf.SplitterDistance = sCLeftHalf.Height - 133;
            sCRightHalf.SplitterDistance = sCRightHalf.Height - 133;
        ...
        private void dgScanSlots_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
                ...
                if (GetSelectedRowsCount(sender) > 0)
                {
                    ...
                    //Set Label for side
                    if (dgInput.SelectedRows .Count > 1) GetSSLabel(side).Text = "";
                    else
                    ...
                    GetSSProperties(side).CombineProperties();
                }
        }
        ...
        #region CyRowComparer
        private class CyRowComparer : System.Collections.IComparer
        {
            private static int sortOrderModifier = 1;
            int col;

            public CyRowComparer(int col1, SortOrder sortOrder1)
            {
            ...
            public int Compare(object x, object y)
            {
                ...
                int CompareResult = 0;
                int f1 = Convert.ToInt32(DataGridViewRow1.Cells[col].Value.ToString());
                int f2 = Convert.ToInt32(DataGridViewRow2.Cells[col].Value.ToString());
