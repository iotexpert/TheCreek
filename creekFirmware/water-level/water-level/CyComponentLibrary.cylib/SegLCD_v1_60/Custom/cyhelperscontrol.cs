...
namespace SegLCD_v1_60
{
    ...
    public partial class CyHelpers : UserControl
    {
        ...
        private void buttonAddHelper_Click(object sender, EventArgs e)
        {
            ...
            if (!fitInSpace)
            {
                MessageBox.Show(Properties.Resources.NOT_ENOUGH_SEG_COM_MSG, CyLCDParameters.WARNING_MSG_TITLE,
        ...
        private bool AddSymbol()
        {
            ...
            for (int i = 0; i < segCount; i++)
            {
                ...
                segmentTitles[i] = defaultNamePattern.IsMatch(pixelName)
                                       ? pixelName.Remove(0, defaultName.Length)
                                       : pixelName;
            }
        ...
        {
            Font font = new Font(FONT_ARIAL, 10);
    ...
    internal class CyLCDSegment
    {
        ...
        private void DrawTitle(Graphics g)
        {
            ...
            using (Font fnt = new Font(CyHelpers.FONT_ARIAL, 8))
            {
