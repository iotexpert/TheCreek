...
#define `$INSTANCE_NAME`_DEFAULT_REF_VOLTAGE    `$Ref_Voltage`      /* ADC reference voltage. */
#define `$INSTANCE_NAME`_DEFAULT_REF_VOLTAGE_MV `$Ref_Voltage_mV`   /* ADC reference voltage in mV */
...
#define `$INSTANCE_NAME`_SAR_TR0      (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__TR0 )
#define `$INSTANCE_NAME`_SAR_CSR0     (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__CSR0 )
#define `$INSTANCE_NAME`_SAR_CSR1     (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__CSR1 )
#define `$INSTANCE_NAME`_SAR_CSR2     (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__CSR2 )
#define `$INSTANCE_NAME`_SAR_CSR3     (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__CSR3 )
#define `$INSTANCE_NAME`_SAR_CSR4     (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__CSR4 )
#define `$INSTANCE_NAME`_SAR_CSR5     (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__CSR5 )
#define `$INSTANCE_NAME`_SAR_CSR6     (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__CSR6 )
#define `$INSTANCE_NAME`_SAR_CSR7     (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__CSR7 )
#define `$INSTANCE_NAME`_SAR_SW0      (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__SW0 )
#define `$INSTANCE_NAME`_SAR_SW2      (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__SW2 )
#define `$INSTANCE_NAME`_SAR_SW3      (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__SW3 )
#define `$INSTANCE_NAME`_SAR_SW4      (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__SW4 )
#define `$INSTANCE_NAME`_SAR_SW6      (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__SW6 )
#define `$INSTANCE_NAME`_SAR_CLK      (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__CLK )
#define `$INSTANCE_NAME`_SAR_WRK0     (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__WRK0 )
#define `$INSTANCE_NAME`_SAR_WRK1     (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__WRK1 )
#define `$INSTANCE_NAME`_PWRMGR_SAR   (* (reg8 *) `$INSTANCE_NAME`_ADC_SAR__PM_ACT_CFG )     /* SAR Power manager Reg */

/* This is only valid if there is an internal clock */
#if(`$INSTANCE_NAME`_DEFAULT_INTERNAL_CLK)
    /* Clock Power manager Reg */
    #define `$INSTANCE_NAME`_PWRMGR_CLK (* (reg8 *) `$INSTANCE_NAME`_theACLK__PM_ACT_CFG )
...
#define `$INSTANCE_NAME`_ACT_PWR_SAR_EN   `$INSTANCE_NAME`_ADC_SAR__PM_ACT_MSK /* Power enable mask */
...
#define `$INSTANCE_NAME`_SAR_CAP_TRIM_MASK          0x07
#define `$INSTANCE_NAME`_SAR_CAP_TRIM_0             0x00    /*decrease attenuation capacitor by 0*/
#define `$INSTANCE_NAME`_SAR_CAP_TRIM_1             0x01    /*decrease by 0.5 LSB*/
#define `$INSTANCE_NAME`_SAR_CAP_TRIM_2             0x02    /*decrease by 2*0.5 LSB = 1 LSB*/
#define `$INSTANCE_NAME`_SAR_CAP_TRIM_3             0x03    /*decrease by 3*0.5 LSB = 1.5 LSB*/
#define `$INSTANCE_NAME`_SAR_CAP_TRIM_4             0x04    /*decrease by 4*0.5 LSB = 2 LSB*/
#define `$INSTANCE_NAME`_SAR_CAP_TRIM_5             0x05    /*decrease by 5*0.5 LSB = 2.5 LSB*/
#define `$INSTANCE_NAME`_SAR_CAP_TRIM_6             0x06    /*decrease by 6*0.5 LSB = 3 LSB*/
#define `$INSTANCE_NAME`_SAR_CAP_TRIM_7             0x07    /*decrease by 7*0.5 LSB = 3.5 LSB*/

#define `$INSTANCE_NAME`_SAR_TRIMUNIT               0x08    /*Increase by 6fF*/
...
#define `$INSTANCE_NAME`_SAR_SAMPLE_WIDTH           0x04u   /* sample time width + resolution +1 clock cycle */
