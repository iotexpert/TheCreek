...
/* Function Prototypes */
uint8 CyUSB_PowerOnCheck(void)  `=ReentrantKeil("CyUSB_PowerOnCheck")`;
void CyIMO_SetTrimValue(uint8 freq) `=ReentrantKeil("CyIMO_SetTrimValue")`;
void CyBusClk_Internal_SetDivider(uint16 divider)`=ReentrantKeil("CyBusClk_Internal_SetDivider")`;
...
uint32 CyDisableInts(void) `=ReentrantKeil("CyDisableInts")`
{
    ...
    CY_SET_REG32(CY_INT_CLEAR_PTR, 0xFFFFFFFF);
...
void CyEnableInts(uint32 mask) `=ReentrantKeil("CyEnableInts")`
{
    ...
    *******************************************************************************/
    void CyIntEnable(uint8 number) CYREENTRANT
    {
        ...
        /* Get a pointer to the Interrupt enable register. */
        enableReg = CY_INT_ENABLE_PTR + ((number & CY_INT_NUMBER_MASK) >> 3);
    ...
    *******************************************************************************/
    uint8 CyIntGetState(uint8 number) `=ReentrantKeil("CyIntGetState")`
    {
        ...
        CYASSERT(number <= CY_INT_NUMBER_MAX);
        /* Get a pointer to the Interrupt enable register. */
        stateReg = CY_INT_ENABLE_PTR + ((number & CY_INT_NUMBER_MASK) >> 3);
    ...
    *******************************************************************************/
    void CyIntDisable(uint8 number) CYREENTRANT
    {
        ...
        /* Get a pointer to the Interrupt enable register. */
        clearReg = CY_INT_CLEAR_PTR + ((number & CY_INT_NUMBER_MASK) >> 3);
    ...
    *******************************************************************************/
    void CyIntSetPending(uint8 number) `=ReentrantKeil("CyIntSetPending")`
    {
        ...
        /* Get a pointer to the Interrupt set pending register. */
        pendReg = CY_INT_SET_PEND_PTR + ((number & CY_INT_NUMBER_MASK) >> 3);
    ...
    *******************************************************************************/
    void CyIntClearPending(uint8 number) `=ReentrantKeil("CyIntClearPending")`
    {
        ...
        /* Get a pointer to the Interrupt clear pending register. */
        pendReg = CY_INT_CLR_PEND_PTR + ((number & CY_INT_NUMBER_MASK) >> 3);
