...
static void CyPmSlpSaveSet(void) `=ReentrantKeil("CyPmSlpSaveSet")`;
static void CyPmSlpRestore(void) `=ReentrantKeil("CyPmSlpRestore")`;
...
static void CyPmHviLviRestore(void) `=ReentrantKeil("CyPmHviLviRestore")`;
    ...
    ***************************************************************************/
    ...
    static void CyPmDisablePicuInterrupts(void) `=ReentrantKeil("CyPmDisablePicuInterrupts")`;
    static void CyPmRestorePicuInterrupts(void) `=ReentrantKeil("CyPmRestorePicuInterrupts")`;
...
void CyPmFtwSetInterval(uint8 ftwInterval) `=ReentrantKeil("CyPmFtwSetInterval")`
{
    ...
    *
    *******************************************************************************/
    static void CyPmSavePicuInterrupts(void) `=ReentrantKeil("CyPmSavePicuInterrupts")`
    {
...
*  - Saves SC/CT routing connections (PSoC 3 and PSoC 5)
...
*  - Restores SC/CT routing connections (PSoC 3 and PSoC 5)
