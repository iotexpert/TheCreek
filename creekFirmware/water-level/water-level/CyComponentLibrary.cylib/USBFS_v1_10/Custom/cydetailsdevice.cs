...
namespace USBFS_v1_10
{
    public partial class CyDetailsDevice : UserControl
    {
        ...
        void rbMemoryMgmt_CheckedChanged(object sender, EventArgs e)
        {
            byte res = 0;
        ...
        private void buttonApply_Click(object sender, EventArgs e)
        {
            ...
            Descriptor.iSerialNumber = CyUSBFSParameters.SaveSpecialStringDescriptor(comboBoxSerial, "Serial", Parameters);
