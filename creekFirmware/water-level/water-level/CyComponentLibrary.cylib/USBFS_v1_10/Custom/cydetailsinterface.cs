...
namespace USBFS_v1_10
{
    public partial class CyDetailsInterface : UserControl
    {
        ...
        public CyDetailsInterface(InterfaceDescriptor descriptor, CyUSBFSParameters parameters, CyDeviceDescriptor parentForm)
        {
            InitializeComponent();
        ...
        private void buttonApply_Click(object sender, EventArgs e)
        {
            ...
            //if ((Descriptor.bInterfaceClass == CyUSBFSParameters.CLASS_HID) && (comboBoxClass.SelectedIndex != CLASS_HID_ITEM))
            //{
            //    needDeleteClass = true;
            //}
            //if ((Descriptor.bInterfaceClass == CyUSBFSParameters.CLASS_AUDIO) && (comboBoxClass.SelectedIndex != CLASS_AUDIO_ITEM))
            //{
            //    needDeleteClass = true;
            //}
            ...
            //Descriptor.iInterface = CyUSBFSParameters.SaveStringDescriptor(comboBoxInterfaceString, Parameters);
        ...
        private void comboBoxClass_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if ((Descriptor.bInterfaceClass == CyUSBFSParameters.CLASS_CDC) && (comboBoxClass.SelectedIndex != CLASS_CDC_ITEM))
            {
                needDeleteClass = true;
            }
