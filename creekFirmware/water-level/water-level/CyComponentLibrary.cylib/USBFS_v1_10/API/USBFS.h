...
#define `$INSTANCE_NAME`_USB_ISR_VECT   ((reg16 *) CYDEV_INTC_VECT_MBASE)

/************************************************
 *  Interrupt vectors, masks and priorities 
 ************************************************/
#define `$INSTANCE_NAME`_BUS_RESET_PRIOR     (`$INSTANCE_NAME`_bus_reset__INTC_PRIOR_NUM << 5)
...
#define `$INSTANCE_NAME`_SOF_PRIOR     (`$INSTANCE_NAME`_sof_int__INTC_PRIOR_NUM << 5)
...
#define `$INSTANCE_NAME`_EP_0_PRIOR     (`$INSTANCE_NAME`_ep_0__INTC_PRIOR_NUM << 5)
...
#define `$INSTANCE_NAME`_EP_1_PRIOR     (`$INSTANCE_NAME`_ep_1__INTC_PRIOR_NUM << 5)
...
#define `$INSTANCE_NAME`_EP_2_PRIOR     (`$INSTANCE_NAME`_ep_2__INTC_PRIOR_NUM << 5)
...
#define `$INSTANCE_NAME`_EP_3_PRIOR     (`$INSTANCE_NAME`_ep_3__INTC_PRIOR_NUM << 5)
...
#define `$INSTANCE_NAME`_EP_4_PRIOR     (`$INSTANCE_NAME`_ep_4__INTC_PRIOR_NUM << 5)
...
#define `$INSTANCE_NAME`_EP_5_PRIOR     (`$INSTANCE_NAME`_ep_5__INTC_PRIOR_NUM << 5)
...
#define `$INSTANCE_NAME`_EP_6_PRIOR     (`$INSTANCE_NAME`_ep_6__INTC_PRIOR_NUM << 5)
...
#define `$INSTANCE_NAME`_EP_7_PRIOR     (`$INSTANCE_NAME`_ep_7__INTC_PRIOR_NUM << 5)
...
#define `$INSTANCE_NAME`_EP_8_PRIOR     (`$INSTANCE_NAME`_ep_8__INTC_PRIOR_NUM << 5)
