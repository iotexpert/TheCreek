...
`#cy_declare_enum B_Timer__TriggerModes`
...
#define `$INSTANCE_NAME`_INIT_INTERRUPT_MODE       ((`$IntOnTC` << `$INSTANCE_NAME`_STATUS_TC_INT_MASK_SHIFT) | (`$InterruptOnCapture` << `$INSTANCE_NAME`_STATUS_CAPTURE_INT_MASK_SHIFT))
...
***************************************/
    ...
    ***************************************/
    ...
    /* `$INSTANCE_NAME`_STATUS_FIFO_FULLINT_SHIFT               Not valid for Fixed Function Block */
    ...
    #define `$INSTANCE_NAME`_STATUS_FIFO_FULLINT                (0x00u << `$INSTANCE_NAME`_STATUS_FIFO_FULLINT_SHIFT)
    ...
    ***************************************/
    ...
    #define `$INSTANCE_NAME`_STATUS_FIFO_FULLINT_SHIFT      0x00u  /* As defined by Verilog Implementation */
    ...
    #define `$INSTANCE_NAME`_STATUS_FIFO_FULLINT            (0x01u << `$INSTANCE_NAME`_STATUS_FIFO_FULLINT_SHIFT)   /* Sticky FIFO FULL Event Bit-Mask */ 
