...
#if !defined(CY_SPIS_v2_0_`$INSTANCE_NAME`_H)
#define CY_SPIS_v2_0_`$INSTANCE_NAME`_H
...
void  `$INSTANCE_NAME`_WriteTxData(`$RegSizeReplacementString` txDataByte);
...
#endif  /* CY_SPIS_v2_0_`$INSTANCE_NAME`_H */
