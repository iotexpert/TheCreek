...
namespace SPI_Slave_v2_0
{
    public partial class CySPIMControlAdv : UserControl, ICyParamEditingControl
    {
        ...
        private void SetInterruptOnTXEmpty()
        {
        ...
        private void SetInterruptOnSPIDone()
        {
            ...
            m_params.SetParams(CyParamNames.INTERRUPT_ON_DONE);
        }
        ...
        {
            m_params.InterruptOnRXEmpty = chbxIntOnRXEmpty.Checked;
            m_params.SetParams(CyParamNames.INTERRUPT_ON_RX_EMPTY);
        }
        ...
        private void SetInterruptOnRXFull()
        {
        ...
        private void SetMultiSlaveEnable()
        {
            m_params.MultiSlaveEnable = chbxMultiSlaveEnable.Checked;
            m_params.SetParams(CyParamNames.MULTI_SLAVE_ENABLE);
        }
        #endregion
