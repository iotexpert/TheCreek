/*******************************************************************************
*
* FILENAME:  B_UART_v2_20.v
* COMPONENT NAME:   B_UART_v2_20
...
`include "cypress.v"
`ifdef B_UART_v2_20_V_ALREADY_INCLUDED
`else
`define B_UART_v2_20_V_ALREADY_INCLUDED
module B_UART_v2_20
(
...
/**************************************************************************/
wire reset_reg_dp = (CY_UDB_V0) ? 1'b0 : reset_reg;

reg HalfDuplexSend_last;
wire reset_sr = (CY_UDB_V0) ? 1'b0 : (HalfDuplexSend ^ HalfDuplexSend_last) | reset_reg_dp;
if(HalfDuplexEn && CY_UDB_V1) 
begin
    always @(posedge clock_op) 
    begin    
...
begin:sRX
    ...
    */   
    ...
    (
        /* input          */  .clock(clock_op),
        /* input          */  .reset(HalfDuplexEn ? reset_sr : reset_reg_dp),  
...
endmodule /* B_UART_v2_20 */

`endif /* B_UART_v2_20_V_ALREADY_INCLUDED */
