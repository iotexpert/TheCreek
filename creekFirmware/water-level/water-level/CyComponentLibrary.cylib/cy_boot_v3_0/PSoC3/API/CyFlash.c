...
*
*******************************************************************************/
cystatus CySetTempInt(void) `=ReentrantKeil("CySetTempInt")`
{
    cystatus status;
...
cystatus CySetFlashEEBuffer(uint8 * buffer) `=ReentrantKeil("CySetFlashEEBuffer")`
{
    ...
    *
    *******************************************************************************/
    cystatus CyWriteRowConfig(uint8 arrayId, uint16 rowAddress, uint8 * rowData) `=ReentrantKeil("CyWriteRowConfig")`
    {
        uint32 offset;
        uint16 index;
        cystatus status;
