...
{    
    ...
    public class CyCustomizer : ICyParamEditHook_v1, ICyDRCProvider_v1
    {
        ...
        public DialogResult EditParams(ICyInstEdit_v1 edit, ICyTerminalQuery_v1 termQuery, ICyExpressMgr_v1 mgr)
        {
            ...
            editor.AddCustomPage(Properties.Resources.BasicTabTitle, new CySPISControl(parameters),
                configureExpressionViewDataChanged, BASIC_TABNAME);
            editor.AddCustomPage(Properties.Resources.AdvancedTabTitle, new CySPISControlAdv(parameters),
