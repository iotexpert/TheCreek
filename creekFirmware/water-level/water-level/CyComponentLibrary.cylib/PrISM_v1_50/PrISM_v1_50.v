...
`include "cypress.v"
`ifdef PrISM_v1_50_V_ALREADY_INCLUDED
`else
`define PrISM_v1_50_V_ALREADY_INCLUDED
...
(
    ...
    **************************************************************************/
    ...
    wire ctrl_enable_final = ctrl_enable & enable;
    wire [2:0] cs_addr = {1'b0, reset, ctrl_enable_final};
    ...
    */
    ...
    (
        /* input  */    .clock_in(clock),
        /* input  */    .enable(ctrl_enable_final),
    ...
    wire Pd0a = (ce0|cl0) & ~compare_type0 & ~kill & ~reset;   /* LESS_THEN_OR_EQUAL */
    wire Pd0b = ~cl0 & compare_type0 & ~kill & ~reset;         /* GREATER_THAN_OR_EQUAL */
    wire Pd1a = (ce1|cl1) & ~compare_type1 & ~kill & ~reset;   /* LESS_THEN_OR_EQUAL */
    wire Pd1b = ~cl1 & compare_type1 & ~kill & ~reset;         /* GREATER_THAN_OR_EQUAL */
...
endmodule   /* PrISM_v1_50 */
`endif      /* PrISM_v1_50_V_ALREADY_INCLUDED */
