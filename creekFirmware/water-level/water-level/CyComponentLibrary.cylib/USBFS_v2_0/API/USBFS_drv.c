...
volatile uint8 `$INSTANCE_NAME`_interfaceClass[`$INSTANCE_NAME`_MAX_INTERFACES_NUMBER];
...
*
* Global variables:
*  `$INSTANCE_NAME`_currentTD.pStatusBlock->status – updated by the completionCode
*    parameter.
