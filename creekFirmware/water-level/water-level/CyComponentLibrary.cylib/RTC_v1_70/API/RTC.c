...
/* Function Prototypes */
void `$INSTANCE_NAME`_SetInitValues(void) `=ReentrantKeil($INSTANCE_NAME . "_SetInitValues")`;
...
void `$INSTANCE_NAME`_DisableInt(void) `=ReentrantKeil($INSTANCE_NAME . "_DisableInt")`
{
    ...
    *
    *******************************************************************************/
    void `$INSTANCE_NAME`_DSTDateConversion(void) `=ReentrantKeil($INSTANCE_NAME . "_DSTDateConversion")`
    {
        uint8 week = 1u;
        uint8 day = 1u;
        uint8 dayOfWeek;
...
*
*******************************************************************************/
void `$INSTANCE_NAME`_WriteTime(`$INSTANCE_NAME`_TIME_DATE *timeDate) `=ReentrantKeil($INSTANCE_NAME . "_WriteTime")`
{
...
void `$INSTANCE_NAME`_SetInitValues(void) `=ReentrantKeil($INSTANCE_NAME . "_SetInitValues")`
{
    ...
    *
    *******************************************************************************/
    void `$INSTANCE_NAME`_WriteDSTStartDayOfMonth(uint8 dayOfMonth) `=ReentrantKeil($INSTANCE_NAME . "_WriteDSTStartDayOfMonth")`
    {
    ...
    *
    *******************************************************************************/
    void `$INSTANCE_NAME`_WriteDSTStartDayOfWeek(uint8 dayOfWeek) `=ReentrantKeil($INSTANCE_NAME . "_WriteDSTStartDayOfWeek")`
    {
    ...
    *
    *******************************************************************************/
    void `$INSTANCE_NAME`_WriteDSTStopDayOfMonth(uint8 dayOfMonth) `=ReentrantKeil($INSTANCE_NAME . "_WriteDSTStopDayOfMonth")`
    {
        /* Set DST Start day of month */
    ...
    *
    *******************************************************************************/
    void `$INSTANCE_NAME`_WriteDSTStopDayOfWeek(uint8 dayOfWeek) `=ReentrantKeil($INSTANCE_NAME . "_WriteDSTStopDayOfWeek")`
    {
