...
uint8 `$INSTANCE_NAME`_initVar = 0u;
    ...
    */
    ...
    uint8 `$INSTANCE_NAME`_cst0Td[2u];
    uint8 `$INSTANCE_NAME`_cst1Td[2u];
    /* Function prototype to set/release DMA */ 
    static void `$INSTANCE_NAME`_CstDmaInit(void); 
    static void `$INSTANCE_NAME`_CstDmaRelease(void);
...
*******************************************************************************/
    ...
    {          
        ...
        CyDmaTdSetConfiguration(
            ...
            TD_INC_SRC_ADR | `$INSTANCE_NAME`_Cst0_DMA__TD_TERMOUT_EN);
        ...
        CyDmaTdSetConfiguration(
            ...
            TD_INC_SRC_ADR | `$INSTANCE_NAME`_Cst1_DMA__TD_TERMOUT_EN);
...
*******************************************************************************/
    ...
    {          
        ...
        while(0u != (DMAC_CH[`$INSTANCE_NAME`_cst0Chan].basic_status[0] & STATUS_TD_ACTIVE));
        CyDmaChSetRequest(`$INSTANCE_NAME`_cst0Chan, CPU_TERM_CHAIN);
        CyDmaChEnable(`$INSTANCE_NAME`_cst0Chan, 1u);
        while(0u != (DMAC_CH[`$INSTANCE_NAME`_cst0Chan].basic_cfg[0] & STATUS_CHAIN_ACTIVE));    
        
        while(0u != (DMAC_CH[`$INSTANCE_NAME`_cst1Chan].basic_status[0] & STATUS_TD_ACTIVE));
        CyDmaChSetRequest(`$INSTANCE_NAME`_cst1Chan, CPU_TERM_CHAIN);
        CyDmaChEnable(`$INSTANCE_NAME`_cst1Chan, 1u);
        while(0u != (DMAC_CH[`$INSTANCE_NAME`_cst1Chan].basic_cfg[0] & STATUS_CHAIN_ACTIVE));
        
        /* Released all allocated TDs */
