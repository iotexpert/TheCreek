/*******************************************************************************
* File Name: GraphicLCDCtrl_v1_50.v
...
`include "cypress.v"
`ifdef GraphicLCDCtrl_V_v1_50_ALREADY_INCLUDED
`else
`define GraphicLCDCtrl_V_v1_50_ALREADY_INCLUDED
module GraphicLCDCtrl_v1_50 
(
    input    wire         clock,      /* Clock that operates this component  */
    input    wire [7:0]   di_lsb,     /* Lower 8 bits of the input data bus  */
    input    wire [7:0]   di_msb,     /* Upper 8 bits of the input data bus  */
    ...
    ***************************************************************************/
    /* Control Reg: Only bit 0 is used as an enable / ~reset */ 
    localparam GRAPH_LCD_CTL_ENABLE = 3'b0;
    localparam GRAPH_LCD_CTL_RESET  = 3'b1;
    wire [7:0] ctrl;
    wire reset;
    wire clock_enable;
    ...
    ***************************************************************************/
    ...
    localparam GRAPH_LCD_CTL_HV_DP_CONFIG = {
        ...
        `CS_CMP_SEL_CFGA, /*CS_REG0 Comment:PASS */
        `CS_ALU_OP__DEC, `CS_SRCA_A0, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC__ALU, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG1 Comment:COUNT0 */
        `CS_ALU_OP__DEC, `CS_SRCA_A1, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC_NONE, `CS_A1_SRC__ALU,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG2 Comment:COUNT1 */
        `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC___D0, `CS_A1_SRC___F1,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG3 Comment:LOAD_FP */
        `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC_NONE, `CS_A1_SRC___D1,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG4 Comment:LOAD_SYNC */
        `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC___F0, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG5 Comment:LOAD_BP */
        `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC_NONE, `CS_A1_SRC___F1,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG6 Comment:LOAD_ACTIVE */
        `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC_NONE, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
    ...
    ***************************************************************************/
    ...
    localparam GRAPH_LCD_CTL_ACCESS_STATE_READ1     = 3'd5;     /* Give time for the memory access */
    localparam GRAPH_LCD_CTL_ACCESS_STATE_READ2     = 3'd4;     /* Latch the read data */ 
            ...
            begin
                case (accessState)
                    ...
                    GRAPH_LCD_CTL_ACCESS_STATE_DECODE: 
                        if (cmdRead) 
                        begin
                            accessState <= GRAPH_LCD_CTL_ACCESS_STATE_READ1;
                        end
                        else 
                        begin
                            accessState <= GRAPH_LCD_CTL_ACCESS_STATE_WRITE1;
                        end
                    GRAPH_LCD_CTL_ACCESS_STATE_READ1: 
                        accessState <= GRAPH_LCD_CTL_ACCESS_STATE_READ2;
                    GRAPH_LCD_CTL_ACCESS_STATE_READ2: 
                        accessState <= GRAPH_LCD_CTL_ACCESS_STATE_NONE;
    ...
    /* Data is latched from Parallel in to F1. F1 write mode configured to be level */    
    reg getReadData;
    always @(posedge op_clk)
    begin
        getReadData <= (accessState == GRAPH_LCD_CTL_ACCESS_STATE_READ1);
    end
    ...
    ***************************************************************************/
    ...
    localparam ADDRESS_DP_CONFIG = {
        ...
        `CS_SHFT_OP_PASS, `CS_A0_SRC_NONE, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG0 Comment:DRIVE1 */
        `CS_ALU_OP__INC, `CS_SRCA_A0, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC__ALU, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG1 Comment:INC0 */
        `CS_ALU_OP_PASS, `CS_SRCA_A1, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC___D0, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG2 Comment:LOAD0 */
        `CS_ALU_OP_PASS, `CS_SRCA_A1, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC_NONE, `CS_A1_SRC___F1,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG3 Comment:LOAD1 */
        `CS_ALU_OP__ADD, `CS_SRCA_A0, `CS_SRCB_D1,
        `CS_SHFT_OP_PASS, `CS_A0_SRC__ALU, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG4 Comment:ENDOFLINE */
        `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC_NONE, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
    ...
    */
    ...
    localparam DATA_DP_CONFIG = {
        ...
        `CS_SHFT_OP_PASS, `CS_A0_SRC_NONE, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG0 Comment:DRIVE */
        `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC___F0, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG1 Comment:LOAD */
        `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC_NONE, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        ...
        1'b0, `SC_FIFO1_ALU, `SC_FIFO0_BUS,
        `SC_MSB_DSBL, `SC_MSB_BIT0, `SC_MSB_NOCHN,
        `SC_FB_NOCHN, `SC_CMP1_NOCHN,
        `SC_CMP0_NOCHN, /*SC_REG7 Comment: */
        10'h00, `SC_FIFO_CLK__DP,`SC_FIFO_CAP_AX,
...
`endif /* GraphicLCDCtrl_V_v1_50_ALREADY_INCLUDED */
