...
*                       inputs to zero.
*    1 0 1   5   INC OV: Increments Overvoltage glitch filter counter
*    1 1 0   6   INC OV: Increments Undervoltage glitch filter counter
...
`include "cypress.v"
`ifdef bVoltageFaultDetector_v2_0_V_ALREADY_INCLUDED
`else
`define bVoltageFaultDetector_v2_0_V_ALREADY_INCLUDED

module bVoltageFaultDetector_v2_0(pg_ov,pg_uv,en,clock,bus_clock,vs,pg_out,
                                  vdac_wr,res_rd,eoc,nrq,actual_pg);
    ...
    **************************************************************************/
    ...
    begin:Sts8
        ...
        if(CompareType != UV_ONLY)
        begin:OV
            cy_psoc3_status #(.cy_force_order(1), .cy_md_select(8'hff))
            OVStsReg8(
                /* input            */ .clock(clk_fin),
...
`endif /* bVoltageFaultDetector_v2_0_V_ALREADY_INCLUDED */
