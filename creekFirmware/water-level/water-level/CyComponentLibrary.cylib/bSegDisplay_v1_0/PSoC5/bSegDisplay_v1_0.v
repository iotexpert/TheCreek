...
`include "cypress.v"
`ifdef bSegDisplay_v1_0_V_ALREADY_INCLUDED
`else
`define bSegDisplay_v1_0_V_ALREADY_INCLUDED

module bSegDisplay_v1_0 (
...
`endif /*bSegDisplay_v1_0_ALREADY_INCLUDED*/
