//***************************************************************************************
//
// FILENAME:  B_SPI_Slave_v1_20.v
// MODULE NAME:   B_SPI_Slave_v1_20
// COMPONENT NAME: B_SPI_Slave_v1_20
// @Version@
//
// DESCRIPTION:
...
//***************************************************************************************
`include "cypress.v"
`ifdef B_SPIS_V_v1_10_ALREADY_INCLUDED
`else
`define B_SPIS_V_v1_10_ALREADY_INCLUDED
module B_SPI_Slave_v1_20(
...
/* STATUS_BIT: Status */ localparam SPIS_STS_TX_BUFFER_EMPTY_BIT         =    3'd4;
...
endgenerate
    ...
    assign status[SPIS_STS_TX_BUFFER_EMPTY_BIT] = miso_tx_empty;    //mosi_rx_empty;
...
`endif /* SPIS_V_v0_10_ALREADY_INCLUDED */
