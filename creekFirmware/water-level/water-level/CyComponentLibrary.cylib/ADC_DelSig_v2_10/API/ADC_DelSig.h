...
#define `$INSTANCE_NAME`_DEFAULT_RESOLUTION         (`$ADC_Resolution`u )
#define `$INSTANCE_NAME`_DEFAULT_RANGE              (`$ADC_Input_Range`u)    
#define `$INSTANCE_NAME`_DEFAULT_SRATE              (`$Sample_Rate`u)         
#define `$INSTANCE_NAME`_DEFAULT_REFERENCE          (`$ADC_Reference`u)       
#define `$INSTANCE_NAME`_DEFAULT_BUF_GAIN           (`$Input_Buffer_Gain`u)   
#define `$INSTANCE_NAME`_DEFAULT_STROBE             (`$Start_of_Conversion`u) 
#define `$INSTANCE_NAME`_DEFAULT_INTERNAL_CLK       (`$ADC_Clock`u)           
#define `$INSTANCE_NAME`_DEFAULT_CONV_MODE          (`$Conversion_Mode`u)     
...
#define `$INSTANCE_NAME`_DEFAULT_RANGE_VALUE        (`$ADC_Input_RangeValue`)
...
#define `$INSTANCE_NAME`_EN_PRESA                   (0x80) 
#define `$INSTANCE_NAME`_EN_PRESD                   (0x40)
...
#define `$INSTANCE_NAME`_IGNORE_PRESD1              (0x01) 
#define `$INSTANCE_NAME`_IGNORE_PRESA1              (0x02)
#define `$INSTANCE_NAME`_IGNORE_LPCOMPD1            (0x04)
#define `$INSTANCE_NAME`_IGNORE_LPCOMPA1            (0x08)
#define `$INSTANCE_NAME`_IGNORE_HBR1                (0x10)
...
#define `$INSTANCE_NAME`_IGNORE_PRESD2              (0x01) 
#define `$INSTANCE_NAME`_IGNORE_PRESA2              (0x02)
#define `$INSTANCE_NAME`_IGNORE_LPCOMPD2            (0x04)
#define `$INSTANCE_NAME`_IGNORE_LPCOMPA2            (0x08)
#define `$INSTANCE_NAME`_IGNORE_HBR2                (0x10)
...
#define `$INSTANCE_NAME`_DIS_HBR1                   (0x20) 
#define `$INSTANCE_NAME`_DIS_PRES1                  (0x10)
#define `$INSTANCE_NAME`_VMON_HVI_SEL               (0x08)
#define `$INSTANCE_NAME`_EN_HVI_A                   (0x04)
#define `$INSTANCE_NAME`_EN_LVI_A                   (0x02)
#define `$INSTANCE_NAME`_EN_LVI_D                   (0x01)
...
#define `$INSTANCE_NAME`_DIS_PRES2                  (0x08) 
#define `$INSTANCE_NAME`_DIS_HBR2                   (0x10)
...
#define `$INSTANCE_NAME`_DFLT_CLOCK_FREQ                  (`$DFLT_CLK_FREQ`u)
#define `$INSTANCE_NAME`_REFERENCE_VOLTAGE                (`$DFLT_REF_VOLTAGE`)
#define `$INSTANCE_NAME`_DFLT_COUNTS_PER_VOLT             (`$DFLT_COUNTS_PER_VOLT`u)
#define `$INSTANCE_NAME`_DEFAULT_IDEAL_DEC_GAIN           (`$DFLT_IDEAL_DEC_GAIN`)

#define `$INSTANCE_NAME`_DEFAULT_IDEAL_ODDDEC_GAIN        (`$DFLT_IDEAL_ODDDEC_GAIN`)

/* Input and DAC Cap values in pF */
#define `$INSTANCE_NAME`_DEFAULT_IPCAP1VALUE              (`$DFLT_IPCap1Value`)
#define `$INSTANCE_NAME`_DEFAULT_DACAPVALUE               (`$DFLT_DACCapValue`)


/* Default register settings for the Config 2 */
/* Sample Rate: `$Sample_Rate_Config2` Samples per Second */
/* Conversion Mode: `$Conversion_Mode_Config2` */
/* Input Buffer Gain: `$Input_Buffer_Gain_Config2`   */
/* ADC Reference: `$ADC_Reference_Config2` */
/* ADC Input Range: `$ADC_Input_Range_Config2`  */
/* ADC Resolution: `$ADC_Resolution_Config2` bits */
/* ADC Clock: `$DFLT_CLK_FREQ_CFG2` Hz */

#define `$INSTANCE_NAME`_DFLT_DEC_CR_CFG2                 (`$DFLT_DEC_CR_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DEC_SR_CFG2                 (`$DFLT_DEC_SR_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DEC_SHIFT1_CFG2             (`$DFLT_DEC_SHIFT1_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DEC_SHIFT2_CFG2             (`$DFLT_DEC_SHIFT2_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DEC_DR2_CFG2                (`$DFLT_DEC_DR2_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DEC_DR2H_CFG2               (`$DFLT_DEC_DR2H_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DEC_DR1_CFG2                (`$DFLT_DEC_DR1_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DEC_OCOR_CFG2               (`$DFLT_DEC_OCOR_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DEC_OCORM_CFG2              (`$DFLT_DEC_OCORM_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DEC_OCORH_CFG2              (`$DFLT_DEC_OCORH_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DEC_GVAL_CFG2               (`$DFLT_DEC_GVAL_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DEC_GCOR_CFG2               (`$DFLT_DEC_GCOR_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DEC_GCORH_CFG2              (`$DFLT_DEC_GCORH_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DEC_COHER_CFG2              (`$DFLT_DEC_COHER_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR0_CFG2                (`$DFLT_DSM_CR0_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR1_CFG2                (`$DFLT_DSM_CR1_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR2_CFG2                (`$DFLT_DSM_CR2_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR3_CFG2                (`$DFLT_DSM_CR3_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR4_CFG2                (`$DFLT_DSM_CR4_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR5_CFG2                (`$DFLT_DSM_CR5_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR6_CFG2                (`$DFLT_DSM_CR6_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR7_CFG2                (`$DFLT_DSM_CR7_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR8_CFG2                (`$DFLT_DSM_CR8_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR9_CFG2                (`$DFLT_DSM_CR9_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR10_CFG2               (`$DFLT_DSM_CR10_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR11_CFG2               (`$DFLT_DSM_CR11_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR12_CFG2               (`$DFLT_DSM_CR12_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR13_CFG2               (`$DFLT_DSM_CR13_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR14_CFG2               (`$DFLT_DSM_CR14_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR15_CFG2               (`$DFLT_DSM_CR15_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR16_CFG2               (`$DFLT_DSM_CR16_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR17_CFG2               (`$DFLT_DSM_CR17_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_REF0_CFG2               (`$DFLT_DSM_REF0_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_REF2_CFG2               (`$DFLT_DSM_REF2_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_REF3_CFG2               (`$DFLT_DSM_REF3_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_DEM0_CFG2               (`$DFLT_DSM_DEM0_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_DEM1_CFG2               (`$DFLT_DSM_DEM1_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_BUF0_CFG2               (`$DFLT_DSM_BUF0_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_BUF1_CFG2               (`$DFLT_DSM_BUF1_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_BUF2_CFG2               (`$DFLT_DSM_BUF2_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_BUF3_CFG2               (`$DFLT_DSM_BUF3_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_OUT0_CFG2               (`$DFLT_DSM_OUT0_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_OUT1_CFG2               (`$DFLT_DSM_OUT1_CFG2`)
#define `$INSTANCE_NAME`_DFLT_DSM_SW3_CFG2                (`$DFLT_DSM_SW3_CFG2`)
#define `$INSTANCE_NAME`_DEFAULT_SRATE_CFG2               (`$Sample_Rate_Config2`u )
#define `$INSTANCE_NAME`_CLOCKS_PER_SAMPLE_CFG2           (`$DFLT_CLOCKS_PER_SAMPLE_CFG2`)
#define `$INSTANCE_NAME`_DFLT_CLOCK_FREQ_CFG2             (`$DFLT_CLK_FREQ_CFG2`u)
#define `$INSTANCE_NAME`_REFERENCE_VOLTAGE_CFG2           (`$DFLT_REF_VOLTAGE_CFG2`)
#define `$INSTANCE_NAME`_DFLT_COUNTS_PER_VOLT_CFG2        (`$DFLT_COUNTS_PER_VOLT_CFG2`u)
#define `$INSTANCE_NAME`_DEFAULT_RESOLUTION_CFG2          (`$ADC_Resolution_Config2`u)
#define `$INSTANCE_NAME`_CONVMODE_CFG2                    (`$Conversion_Mode_Config2`u)
#define `$INSTANCE_NAME`_DEFAULT_IDEAL_DEC_GAIN_CFG2      (`$DFLT_IDEAL_DEC_GAIN_CFG2`)
#define `$INSTANCE_NAME`_DEFAULT_INPUT_RANGE_CFG2         (`$ADC_Input_Range_Config2`u)
#define `$INSTANCE_NAME`_DEFAULT_INPUT_RANGE_VALUE_CFG2   (`$ADC_Input_RangeValue_Config2`)

#define `$INSTANCE_NAME`_DEFAULT_INPUT_MODE_CFG2          (`$ADC_Input_Mode_Config2`)
#define `$INSTANCE_NAME`_DEFAULT_REFERENCE_CFG2           (`$ADC_Reference_Config2`u)
#define `$INSTANCE_NAME`_DEFAULT_BUFFER_GAIN_CONFIG2      (`$Input_Buffer_Gain_Config2`u)

/* Input and DAC Cap values in pF */
#define `$INSTANCE_NAME`_DEFAULT_IPCAP1VALUE_CFG2         (`$DFLT_IPCap1Value_CFG2`)
#define `$INSTANCE_NAME`_DEFAULT_DACAPVALUE_CFG2          (`$DFLT_DACCapValue_CFG2`)
#define `$INSTANCE_NAME`_DEFAULT_IDEAL_ODDDEC_GAIN_CFG2   (`$DFLT_IDEAL_ODDDEC_GAIN_CFG2`)


/* Default register settings for the following configuration */
/* Sample Rate: `$Sample_Rate_Config3` Samples per Second */
/* Conversion Mode: `$Conversion_Mode_Config3` */
/* Input Buffer Gain: `$Input_Buffer_Gain_Config3`   */
/* ADC Reference: `$ADC_Reference_Config3` */
/* ADC Input Range: `$ADC_Input_Range_Config3`  */
/* ADC Resolution: `$ADC_Resolution_Config3` bits */
/* ADC Clock: `$DFLT_CLK_FREQ_CFG3` Hz */

#define `$INSTANCE_NAME`_DFLT_DEC_CR_CFG3                 (`$DFLT_DEC_CR_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DEC_SR_CFG3                 (`$DFLT_DEC_SR_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DEC_SHIFT1_CFG3             (`$DFLT_DEC_SHIFT1_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DEC_SHIFT2_CFG3             (`$DFLT_DEC_SHIFT2_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DEC_DR2_CFG3                (`$DFLT_DEC_DR2_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DEC_DR2H_CFG3               (`$DFLT_DEC_DR2H_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DEC_DR1_CFG3                (`$DFLT_DEC_DR1_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DEC_OCOR_CFG3               (`$DFLT_DEC_OCOR_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DEC_OCORM_CFG3              (`$DFLT_DEC_OCORM_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DEC_OCORH_CFG3              (`$DFLT_DEC_OCORH_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DEC_GVAL_CFG3               (`$DFLT_DEC_GVAL_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DEC_GCOR_CFG3               (`$DFLT_DEC_GCOR_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DEC_GCORH_CFG3              (`$DFLT_DEC_GCORH_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DEC_COHER_CFG3              (`$DFLT_DEC_COHER_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR0_CFG3                (`$DFLT_DSM_CR0_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR1_CFG3                (`$DFLT_DSM_CR1_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR2_CFG3                (`$DFLT_DSM_CR2_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR3_CFG3                (`$DFLT_DSM_CR3_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR4_CFG3                (`$DFLT_DSM_CR4_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR5_CFG3                (`$DFLT_DSM_CR5_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR6_CFG3                (`$DFLT_DSM_CR6_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR7_CFG3                (`$DFLT_DSM_CR7_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR8_CFG3                (`$DFLT_DSM_CR8_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR9_CFG3                (`$DFLT_DSM_CR9_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR10_CFG3               (`$DFLT_DSM_CR10_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR11_CFG3               (`$DFLT_DSM_CR11_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR12_CFG3               (`$DFLT_DSM_CR12_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR13_CFG3               (`$DFLT_DSM_CR13_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR14_CFG3               (`$DFLT_DSM_CR14_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR15_CFG3               (`$DFLT_DSM_CR15_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR16_CFG3               (`$DFLT_DSM_CR16_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR17_CFG3               (`$DFLT_DSM_CR17_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_REF0_CFG3               (`$DFLT_DSM_REF0_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_REF2_CFG3               (`$DFLT_DSM_REF2_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_REF3_CFG3               (`$DFLT_DSM_REF3_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_DEM0_CFG3               (`$DFLT_DSM_DEM0_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_DEM1_CFG3               (`$DFLT_DSM_DEM1_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_BUF0_CFG3               (`$DFLT_DSM_BUF0_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_BUF1_CFG3               (`$DFLT_DSM_BUF1_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_BUF2_CFG3               (`$DFLT_DSM_BUF2_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_BUF3_CFG3               (`$DFLT_DSM_BUF3_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_OUT0_CFG3               (`$DFLT_DSM_OUT0_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_OUT1_CFG3               (`$DFLT_DSM_OUT1_CFG3`)
#define `$INSTANCE_NAME`_DFLT_DSM_SW3_CFG3                (`$DFLT_DSM_SW3_CFG3`)
#define `$INSTANCE_NAME`_DEFAULT_SRATE_CFG3               (`$Sample_Rate_Config3`u)
#define `$INSTANCE_NAME`_CLOCKS_PER_SAMPLE_CFG3           (`$DFLT_CLOCKS_PER_SAMPLE_CFG3`)
#define `$INSTANCE_NAME`_DFLT_CLOCK_FREQ_CFG3             (`$DFLT_CLK_FREQ_CFG3`u)
#define `$INSTANCE_NAME`_REFERENCE_VOLTAGE_CFG3           (`$DFLT_REF_VOLTAGE_CFG3`)
#define `$INSTANCE_NAME`_DFLT_COUNTS_PER_VOLT_CFG3        (`$DFLT_COUNTS_PER_VOLT_CFG3`u)
#define `$INSTANCE_NAME`_DEFAULT_RESOLUTION_CFG3          (`$ADC_Resolution_Config3`u)
#define `$INSTANCE_NAME`_CONVMODE_CFG3                    (`$Conversion_Mode_Config3`u)
#define `$INSTANCE_NAME`_DEFAULT_IDEAL_DEC_GAIN_CFG3      (`$DFLT_IDEAL_DEC_GAIN_CFG3`)
#define `$INSTANCE_NAME`_DEFAULT_INPUT_RANGE_CFG3         (`$ADC_Input_Range_Config3`u)
#define `$INSTANCE_NAME`_DEFAULT_INPUT_MODE_CFG3          (`$ADC_Input_Mode_Config3`)
#define `$INSTANCE_NAME`_DEFAULT_REFERENCE_CFG3           (`$ADC_Reference_Config3`u)
#define `$INSTANCE_NAME`_DEFAULT_BUFFER_GAIN_CONFIG3      (`$Input_Buffer_Gain_Config3`u)
#define `$INSTANCE_NAME`_DEFAULT_INPUT_RANGE_VALUE_CFG3   (`$ADC_Input_RangeValue_Config3`)

/* Input and DAC Cap values in pF */
#define `$INSTANCE_NAME`_DEFAULT_IPCAP1VALUE_CFG3         (`$DFLT_IPCap1Value_CFG3`)
#define `$INSTANCE_NAME`_DEFAULT_DACAPVALUE_CFG3          (`$DFLT_DACCapValue_CFG3`)
#define `$INSTANCE_NAME`_DEFAULT_IDEAL_ODDDEC_GAIN_CFG3   (`$DFLT_IDEAL_ODDDEC_GAIN_CFG3`)


/* Default register settings for the following configuration */
/* Sample Rate: `$Sample_Rate_Config4` Samples per Second */
/* Conversion Mode: `$Conversion_Mode_Config4` */
/* Input Buffer Gain: `$Input_Buffer_Gain_Config4`   */
/* ADC Reference: `$ADC_Reference_Config4` */
/* ADC Input Range: `$ADC_Input_Range_Config4`  */
/* ADC Resolution: `$ADC_Resolution_Config4` bits */
/* ADC Clock: `$DFLT_CLK_FREQ_CFG4` Hz */

#define `$INSTANCE_NAME`_DFLT_DEC_CR_CFG4                 (`$DFLT_DEC_CR_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DEC_SR_CFG4                 (`$DFLT_DEC_SR_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DEC_SHIFT1_CFG4             (`$DFLT_DEC_SHIFT1_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DEC_SHIFT2_CFG4             (`$DFLT_DEC_SHIFT2_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DEC_DR2_CFG4                (`$DFLT_DEC_DR2_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DEC_DR2H_CFG4               (`$DFLT_DEC_DR2H_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DEC_DR1_CFG4                (`$DFLT_DEC_DR1_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DEC_OCOR_CFG4               (`$DFLT_DEC_OCOR_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DEC_OCORM_CFG4              (`$DFLT_DEC_OCORM_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DEC_OCORH_CFG4              (`$DFLT_DEC_OCORH_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DEC_GVAL_CFG4               (`$DFLT_DEC_GVAL_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DEC_GCOR_CFG4               (`$DFLT_DEC_GCOR_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DEC_GCORH_CFG4              (`$DFLT_DEC_GCORH_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DEC_COHER_CFG4              (`$DFLT_DEC_COHER_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR0_CFG4                (`$DFLT_DSM_CR0_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR1_CFG4                (`$DFLT_DSM_CR1_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR2_CFG4                (`$DFLT_DSM_CR2_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR3_CFG4                (`$DFLT_DSM_CR3_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR4_CFG4                (`$DFLT_DSM_CR4_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR5_CFG4                (`$DFLT_DSM_CR5_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR6_CFG4                (`$DFLT_DSM_CR6_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR7_CFG4                (`$DFLT_DSM_CR7_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR8_CFG4                (`$DFLT_DSM_CR8_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR9_CFG4                (`$DFLT_DSM_CR9_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR10_CFG4               (`$DFLT_DSM_CR10_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR11_CFG4               (`$DFLT_DSM_CR11_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR12_CFG4               (`$DFLT_DSM_CR12_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR13_CFG4               (`$DFLT_DSM_CR13_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR14_CFG4               (`$DFLT_DSM_CR14_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR15_CFG4               (`$DFLT_DSM_CR15_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR16_CFG4               (`$DFLT_DSM_CR16_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_CR17_CFG4               (`$DFLT_DSM_CR17_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_REF0_CFG4               (`$DFLT_DSM_REF0_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_REF2_CFG4               (`$DFLT_DSM_REF2_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_REF3_CFG4               (`$DFLT_DSM_REF3_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_DEM0_CFG4               (`$DFLT_DSM_DEM0_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_DEM1_CFG4               (`$DFLT_DSM_DEM1_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_BUF0_CFG4               (`$DFLT_DSM_BUF0_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_BUF1_CFG4               (`$DFLT_DSM_BUF1_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_BUF2_CFG4               (`$DFLT_DSM_BUF2_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_BUF3_CFG4               (`$DFLT_DSM_BUF3_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_OUT0_CFG4               (`$DFLT_DSM_OUT0_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_OUT1_CFG4               (`$DFLT_DSM_OUT1_CFG4`)
#define `$INSTANCE_NAME`_DFLT_DSM_SW3_CFG4                (`$DFLT_DSM_SW3_CFG4`)
#define `$INSTANCE_NAME`_DEFAULT_SRATE_CFG4               (`$Sample_Rate_Config4`u)         
#define `$INSTANCE_NAME`_CLOCKS_PER_SAMPLE_CFG4           (`$DFLT_CLOCKS_PER_SAMPLE_CFG4`)
#define `$INSTANCE_NAME`_DFLT_CLOCK_FREQ_CFG4             (`$DFLT_CLK_FREQ_CFG4`u)
#define `$INSTANCE_NAME`_REFERENCE_VOLTAGE_CFG4           (`$DFLT_REF_VOLTAGE_CFG4`)
#define `$INSTANCE_NAME`_DFLT_COUNTS_PER_VOLT_CFG4        (`$DFLT_COUNTS_PER_VOLT_CFG4`u)
#define `$INSTANCE_NAME`_DEFAULT_RESOLUTION_CFG4          (`$ADC_Resolution_Config4`u)
#define `$INSTANCE_NAME`_CONVMODE_CFG4                    (`$Conversion_Mode_Config4`u)
#define `$INSTANCE_NAME`_DEFAULT_IDEAL_DEC_GAIN_CFG4      (`$DFLT_IDEAL_DEC_GAIN_CFG4`)
#define `$INSTANCE_NAME`_DEFAULT_INPUT_RANGE_CFG4         (`$ADC_Input_Range_Config4`u)
#define `$INSTANCE_NAME`_DEFAULT_INPUT_MODE_CFG4          (`$ADC_Input_Mode_Config4`)
#define `$INSTANCE_NAME`_DEFAULT_REFERENCEE_CFG4          (`$ADC_Reference_Config4`u)
#define `$INSTANCE_NAME`_DEFAULT_BUFFER_GAIN_CONFIG4      (`$Input_Buffer_Gain_Config4`u)
#define `$INSTANCE_NAME`_DEFAULT_INPUT_RANGE_VALUE_CFG4   (`$ADC_Input_RangeValue_Config4`)

/* Input cap and DAC Cap values in pF */
#define `$INSTANCE_NAME`_DEFAULT_IPCAP1VALUE_CFG4         (`$DFLT_IPCap1Value_CFG4`)
#define `$INSTANCE_NAME`_DEFAULT_DACAPVALUE_CFG4          (`$DFLT_DACCapValue_CFG4`)
#define `$INSTANCE_NAME`_DEFAULT_IDEAL_ODDDEC_GAIN_CFG4   (`$DFLT_IDEAL_ODDDEC_GAIN_CFG4`)
