...
namespace ADC_DelSig_v2_10
{
    public partial class CyADC_DelSigControl : UserControl
    {
        ...
        const string ERROR_REF_VOLTAGE = "You can choose either 'Internal 1.024 Volts' or 'Internal Vdda/3' or 'Internal Vdda/4' or ";
        ...
        private void m_cbInputRange_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (m_cbInputRange.Text.Equals(RANGE_VSSA_TO_VDDA))
            {
                ...
                HookAllEvents();
                m_cbReference.Enabled = false; 
                prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.ADC_REFERENCE, m_cbReference.Text);
            ...
            HookAllEvents();
            prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.REF_VOLTAGE, m_nudRefVoltage.Text);
            SetAParameter(ADC_DelSigParameters.REF_VOLTAGE, prm, true);
        }
        ...
        private void CheckRefVoltage(CyNumericUpDown nudRefVoltage, ComboBox cbReference)
        {
            ...
            if (cbReference.Text.Equals(INTERNAL_VDDA_4))
            {
                retVal /= 4;
                nudRefVoltage.Value = retVal;
            }
            else if (cbReference.Text.Equals(INTERNAL_VDDA_3))
            {
                retVal /= 3;
                nudRefVoltage.Value = retVal;
            }
            if (nudRefVoltage.Value > MAX_VREF_VALUE)
            {
                ...
                string errorMessage = string.Format("Warning: Parameter should be within value {0}-{1}\n",
        ...
        private bool CheckFreqConfig1(bool saveValue)
        {
            return CheckFreq(ADC_DelSigParameters.RESOLUTION, ADC_DelSigParameters.INPUT_BUFFER_GAIN,
                ...
                m_lbSPSRange, saveValue, ADC_DelSigParameters.INPUT_RANGE, m_cbInputRange);
        }
        ...
        private bool CheckFreqConfig2(bool saveValue)
        {
            return CheckFreq(ADC_DelSigParameters.RESOLUTION_CONFIG2, ADC_DelSigParameters.INPUT_BUFFER_GAIN_CONFIG2,
                ...
                m_lbSPSRange2, saveValue, ADC_DelSigParameters.INPUT_RANGE_CONFIG2, m_cbInputRange2);
        }
        ...
        private bool CheckFreqConfig3(bool saveValue)
        {
            return CheckFreq(ADC_DelSigParameters.RESOLUTION_CONFIG3, ADC_DelSigParameters.INPUT_BUFFER_GAIN_CONFIG3,
                ...
                m_lbSPSRange3, saveValue, ADC_DelSigParameters.INPUT_RANGE_CONFIG3, m_cbInputRange3);
        }
        ...
        private bool CheckFreqConfig4(bool saveValue)
        {
            return CheckFreq(ADC_DelSigParameters.RESOLUTION_CONFIG4, ADC_DelSigParameters.INPUT_BUFFER_GAIN_CONFIG4,
                ...
                m_lbSPSRange4, saveValue, ADC_DelSigParameters.INPUT_RANGE_CONFIG4, m_cbInputRange4);
        }
            ...
            TextBox tbClockFreq, Label lbSPSRange, bool saveValue, string sinputRange, ComboBox cbInputRange)
        {
            ...
            if (resolution > 15)
            {
                ...
                if (cbInputBufferMode.Items[cbInputBufferMode.SelectedIndex].ToString() == BYPASS_BUFFER) //Unbuffered Input
                    TheMaxFreq = (float)rc.MAX_FREQ_16_20_BITS[inputRange];
                else
                    TheMaxFreq = (float)rc.MAX_FREQ_16_20_BITS[inputRange] / gain;
            ...
            {
                if (cbInputBufferMode.Items[cbInputBufferMode.SelectedIndex].ToString() == BYPASS_BUFFER) //Unbuffered Input
                    TheMaxFreq = (float)rc.MAX_FREQ_8_15_BITS[inputRange];
                else
                    TheMaxFreq = (float)rc.MAX_FREQ_8_15_BITS[inputRange] / gain;
            ...
            {
                errorMessage = "The sample rate of " + (uint)nudConvRate.Value + " SPS has below the minimum limit of "
                    + minRate.ToString()
                    + " SPS for the conversion mode, resolution and frequency.";
                m_errorProvider.SetError(nudConvRate, errorMessage);
                m_errorProvider.SetError(cbResolution, errorMessage);
            ...
            switch (refVoltageConfIndex)
            {
                case 1:
                    ...
                    if (m_cbReference.SelectedItem.ToString().Contains(INTERNAL_BYPASSED) ||
                        ...
                        m_cbReference.SelectedItem.ToString().Equals(INTERNAL_VDDA_4) ||
                        m_cbReference.SelectedItem.ToString().Equals(INTERNAL_VDDA_3))
                ...
                case 2:
                    ...
                    if (m_cbReference2.SelectedItem.ToString().Contains(INTERNAL_BYPASSED) ||
                        ...
                        m_cbReference2.SelectedItem.ToString().Equals(INTERNAL_VDDA_4) ||
                        m_cbReference2.SelectedItem.ToString().Equals(INTERNAL_VDDA_3))
                ...
                case 3:
                    ...
                    if (m_cbReference3.SelectedItem.ToString().Contains(INTERNAL_BYPASSED) ||
                        ...
                        m_cbReference3.SelectedItem.ToString().Equals(INTERNAL_VDDA_4) ||
                        m_cbReference3.SelectedItem.ToString().Equals(INTERNAL_VDDA_3))
                ...
                case 4:
                    ...
                    if (m_cbReference4.SelectedItem.ToString().Contains(INTERNAL_BYPASSED) ||
                        ...
                        m_cbReference4.SelectedItem.ToString().Equals(INTERNAL_VDDA_4) ||
                        m_cbReference4.SelectedItem.ToString().Equals(INTERNAL_VDDA_3))
        ...
        private string ResolveInputEnumDisplayToId(ComboBox inputRange)
        {
            ...
            string prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.INPUT_RANGE, strSelected);
            return prm;
        }
        ...
        {
            decimal Vdda = Convert.ToDecimal(m_Component.GetCommittedParam(ADC_DelSigParameters.ADC_Vdda_Value).Value);
            return Vdda;
        }
        ...
        private void UpdateInputRangeList(ComboBox list, float vrefValue)
        {
            ...
            if (m_rbModeDifferential.Checked)
            {
                ...
                foreach (string str in modifiedInputRange)
                {
        ...
        private void UpdateInputRangeList(int index)
        {
            ...
            switch (index)
            {
                case 1:
                    ...
                    UpdateInputModeSelection(m_cbInputRange, ADC_DelSigParameters.INPUT_RANGE, 
                        prms.ADC_Input_Range.Expr);
                    break;
                case 2:
                    UpdateInputRangeList(m_cbInputRange2, vrefValue);
                    UpdateInputModeSelection(m_cbInputRange2, ADC_DelSigParameters.INPUT_RANGE_CONFIG2,
                        prms.ADC_Input_Range_Config2.Expr);
                    break;
                case 3:
                    UpdateInputRangeList(m_cbInputRange3, vrefValue);
                    UpdateInputModeSelection(m_cbInputRange3, ADC_DelSigParameters.INPUT_RANGE_CONFIG3,
                        prms.ADC_Input_Range_Config3.Expr);
                    break;
                case 4:
                    UpdateInputRangeList(m_cbInputRange4, vrefValue);
                    UpdateInputModeSelection(m_cbInputRange4, ADC_DelSigParameters.INPUT_RANGE_CONFIG4,
                        prms.ADC_Input_Range_Config4.Expr);
                    break;
                default:
                    break;
        ...
        private bool UpdateInputRangeList1(bool not)
        {
            ...
            IEnumerable<string> InputRangeEnums = m_Component.GetPossibleEnumValues(ADC_DelSigParameters.INPUT_RANGE);
            ADC_DelSigParameters prms = new ADC_DelSigParameters(m_Component);
            float.TryParse(prms.Ref_Voltage.Value, out vrefValue);
            ...
            UpdateInputModeSelection(m_cbInputRange, ADC_DelSigParameters.INPUT_RANGE, prms.ADC_Input_Range.Expr);
            UpdateInputModeSelection(m_cbInputRange2, ADC_DelSigParameters.INPUT_RANGE_CONFIG2, 
                prms.ADC_Input_Range_Config2.Expr);
            UpdateInputModeSelection(m_cbInputRange3, ADC_DelSigParameters.INPUT_RANGE_CONFIG3, 
                prms.ADC_Input_Range_Config3.Expr);
        ...
        private void m_cbInputRange2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (m_cbInputRange2.Text.Equals(RANGE_VSSA_TO_VDDA))
            {
                ...
                HookAllEvents();
                m_cbReference2.Enabled = false; 
                prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.ADC_REFERENCE_CONFIG2, m_cbReference2.Text);
            ...
            UpdateInputRangeList(2);
            HookAllEvents();
            prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.REF_VOLTAGE_CONFIG2, m_nudRefVoltage2.Text);
            SetAParameter(ADC_DelSigParameters.REF_VOLTAGE_CONFIG2, prm, true);
        }
        ...
        private void m_cbInputRange3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (m_cbInputRange3.Text.Equals(RANGE_VSSA_TO_VDDA))
            {
                ...
                HookAllEvents();
                m_cbReference3.Enabled = false;
                prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.ADC_REFERENCE_CONFIG3, m_cbReference3.Text);
            ...
            UpdateInputRangeList(3);
            HookAllEvents();
            prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.REF_VOLTAGE_CONFIG3, m_nudRefVoltage3.Text);
            SetAParameter(ADC_DelSigParameters.REF_VOLTAGE_CONFIG3, prm, true);
        }
        ...
        private void m_cbInputRange4_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (m_cbInputRange4.Text.Equals(RANGE_VSSA_TO_VDDA))
            {
                ...
                HookAllEvents();
                m_cbReference4.Enabled = false;
                prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.ADC_REFERENCE_CONFIG4, m_cbReference4.Text);
            ...
            UpdateInputRangeList(4);
            HookAllEvents();
            prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.REF_VOLTAGE_CONFIG4, m_nudRefVoltage4.Text);
            SetAParameter(ADC_DelSigParameters.REF_VOLTAGE_CONFIG4, prm, true);
        }
        ...
        private void CyADC_DelSigControl_Load(object sender, EventArgs e)
        {
            ...
            string prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.ADC_REFERENCE, m_cbReference.Text);
            SetAParameter(ADC_DelSigParameters.ADC_REFERENCE, prm, false);
            
            prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.ADC_REFERENCE_CONFIG2, m_cbReference2.Text);
            SetAParameter(ADC_DelSigParameters.ADC_REFERENCE_CONFIG2, prm, false);

            prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.ADC_REFERENCE_CONFIG3, m_cbReference3.Text);
            SetAParameter(ADC_DelSigParameters.ADC_REFERENCE_CONFIG3, prm, false);

            prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.ADC_REFERENCE_CONFIG4, m_cbReference4.Text);
            SetAParameter(ADC_DelSigParameters.ADC_REFERENCE_CONFIG4, prm, false);

            prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.REF_VOLTAGE, m_nudRefVoltage.Text);
            SetAParameter(ADC_DelSigParameters.REF_VOLTAGE, prm, false);

            prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.REF_VOLTAGE_CONFIG2, m_nudRefVoltage2.Text);
            SetAParameter(ADC_DelSigParameters.REF_VOLTAGE_CONFIG2, prm, false);

            prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.REF_VOLTAGE_CONFIG3, m_nudRefVoltage3.Text);
            SetAParameter(ADC_DelSigParameters.REF_VOLTAGE_CONFIG3, prm, false);

            prm = m_Component.ResolveEnumDisplayToId(ADC_DelSigParameters.REF_VOLTAGE_CONFIG4, m_nudRefVoltage4.Text);
            SetAParameter(ADC_DelSigParameters.REF_VOLTAGE_CONFIG4, prm, false);
            ...
            if (!m_cbInputBufferGain.Items.Contains(paramInputBufferGain))
            {
                ...
                SetAParameter(ADC_DelSigParameters.INPUT_BUFFER_GAIN, "Gain_1X", false);
            }
        }       
    }
