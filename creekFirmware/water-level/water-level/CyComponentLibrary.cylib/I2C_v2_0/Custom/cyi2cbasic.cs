...
namespace I2C_v2_0
{
    public partial class CyI2CBasic : UserControl, ICyParamEditingControl
    {
        ...
        public CyI2CBasic(CyI2CParameters inst)
        {
            ...
            cbMode.Items.AddRange(new string[3] {
        ...
        public void GetParams()
        {
            ...
            switch (m_params.Mode)
            {
                ...
                case CyEModeType.Master:
                    ...
                    break;
                case CyEModeType.Multi_Master:
                    cbMode.SelectedItem = CyI2CModesDisplayName.MULTI_MASTER;
                    break;
                case CyEModeType.Multi_Master_Slave:
        ...
        public void UpdateIFBC(CyClockData clock)
        {
            if (clock.IsFrequencyKnown)
            {
                ...
                lblBusSpeed.Text = "Bus Speed  = " + Math.Round(busSpeed, 3).ToString() + " KHz";
            }
            else
            {
                lblSourceFreq.Text = "Source Freq = UNKNOWN";
                lblBusSpeed.Text = "Bus Speed  = UNKNOWN";
            }
        }
        #endregion
        ...
        public void SetI2CMode()
        {
            switch (cbMode.SelectedItem.ToString())
            {
                ...
                case CyI2CModesDisplayName.MASTER:
                    m_params.Mode = CyEModeType.Master;
                    break;
                case CyI2CModesDisplayName.MULTI_MASTER:
                    m_params.Mode = CyEModeType.Multi_Master;
                    break;
                case CyI2CModesDisplayName.MULTI_MASTER_SLAVE:
                    m_params.Mode = CyEModeType.Multi_Master_Slave;
                    break;
                default:
                    break;
            }
        ...
        private void ComboBoxValidating(object sender, CancelEventArgs e)
        {
            ...
            {
                int value = 0;
                string message = "An I2C bus speed must be between 50 and 1000 kHz";
        ...
        private void SetWakeupEnabling()
        {
            if (m_params.Implementation == CyEImplementationType.FixedFunction
                ...
                && m_params.Mode == CyEModeType.Slave || m_params.Mode == CyEModeType.Multi_Master_Slave)
            {
        ...
        {
            bool enabling = (m_params.Mode == CyEModeType.Slave || m_params.Mode == CyEModeType.Multi_Master_Slave);
