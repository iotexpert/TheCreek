...
/* Print error if cy_boot version is below 2.30 */
#ifndef CY_PSOC5
...
#if(CY_PSOC5)
    /* This one is not used yet as it is no PSoC5 device for this component.
    * The constant is reserved for future device releases.
    */
