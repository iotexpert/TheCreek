...
#define `$INSTANCE_NAME`_VERTICAL_BG              (1u)    /* Horizontal Bar Graph */
#define `$INSTANCE_NAME`_HORIZONTAL_BG            (2u)    /* Vertical Bar Graph   */
...
void `$INSTANCE_NAME`_Wakeup(void);
...
#if((`$INSTANCE_NAME`_CUSTOM_CHAR_SET == `$INSTANCE_NAME`_VERTICAL_BG) || (`$INSTANCE_NAME`_CUSTOM_CHAR_SET == `$INSTANCE_NAME`_HORIZONTAL_BG))
    
    void  `$INSTANCE_NAME`_LoadCustomFonts(const uint8 * customData)`=ReentrantKeil($INSTANCE_NAME . "_LoadCustomFonts")`; 
    
    void  `$INSTANCE_NAME`_DrawHorizontalBG(uint8 row, uint8 column, uint8 maxCharacters, uint8 value) `=ReentrantKeil($INSTANCE_NAME . "_DrawHorizontalBG")`;
    
    void `$INSTANCE_NAME`_DrawVerticalBG(uint8 row, uint8 column, uint8 maxCharacters, uint8 value) `=ReentrantKeil($INSTANCE_NAME . "_DrawVerticalBG")`;
    ...
    #define `$INSTANCE_NAME`_PrintNumber(x)       `$INSTANCE_NAME`_PrintDecUint16(x)
    #define `$INSTANCE_NAME`_PrintInt8(x)         `$INSTANCE_NAME`_PrintHexUint8(x)
    #define `$INSTANCE_NAME`_PrintInt16(x)        `$INSTANCE_NAME`_PrintHexUint16(x)
