...
void `$INSTANCE_NAME`_SaveConfig(void)
{
    ...
    cymemcpy(`$INSTANCE_NAME`_backup.acu_ram, `$INSTANCE_NAME`_ACU_RAM, `$INSTANCE_NAME`_ACU_RAM_SIZE); 
}
...
void `$INSTANCE_NAME`_RestoreConfig(void) `=ReentrantKeil($INSTANCE_NAME . "_RestoreConfig")`
{
    ...
    cymemcpy(`$INSTANCE_NAME`_ACU_RAM, `$INSTANCE_NAME`_backup.acu_ram, `$INSTANCE_NAME`_ACU_RAM_SIZE); 
}
