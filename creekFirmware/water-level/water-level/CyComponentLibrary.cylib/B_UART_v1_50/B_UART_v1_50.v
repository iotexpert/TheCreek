/*******************************************************************************
*
* FILENAME:  B_UART_v1_50.v
* COMPONENT NAME:   B_UART_v1_50
...
`include "cypress.v"
`ifdef B_UART_v1_50_V_ALREADY_INCLUDED
`else
`define B_UART_v1_50_V_ALREADY_INCLUDED
module B_UART_v1_50
(
...
/* Polling require to start sampling on 2 bits before */
localparam [3:0] HalfBitCounts = ((OverSampleCount / 4'd2) + (Use23Polling * 4'd2) - 1);
...
begin : sCR
    ...
    else  /*support of sync mode for PSoC3 ES3 Rev */
    begin: SyncCtl
...
if (TXEnable == 1) begin : sTX
    ...
    localparam UART_TX_SHIFTER_DP_CONFIG = 
    {
        ...
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG3 Comment:SEND START */
        `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC_NONE, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        ...
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG5 Comment:SEND DATA (SR) */
        `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC_NONE, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        ...
        `CS_SHFT_OP_PASS, `CS_A0_SRC_NONE, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG7 Comment:SEND LAST BIT(PARITY/STOP1/2) */
    ...
    wire [6:0] txbitcount;
    wire counter_load = (tx_state == UART_TX_STATE_IDLE) | (tx_bitclk & ((NumStopBits == UART_NUM_STOP_BITS_1) ?
                                  (tx_state == UART_TX_STATE_SEND_STOP1) : (tx_state == UART_TX_STATE_SEND_STOP2)));
    wire counter_load_not = !counter_load;
    wire tx_bitclk_half;
    ...
    begin : sCLOCK
        ...
        assign tx_bitclk_enable_pre = (txbitcount[2:0] == 3'd0) && tx_count7_enable;
    ...
    begin : sCLOCK
        ...
        localparam UART_TX_BIT_CLK_DP_CONFIG = 
        {
            ...
            `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
            `CS_CMP_SEL_CFGA, /*CS_REG0 Comment:Counter load (A0 = 0)*/
            `CS_ALU_OP__INC, `CS_SRCA_A0, `CS_SRCB_D0,
            `CS_SHFT_OP_PASS, `CS_A0_SRC__ALU, `CS_A1_SRC_NONE,
            `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
            `CS_CMP_SEL_CFGA, /*CS_REG1 Comment: Count (A0++)*/
            `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
            `CS_SHFT_OP_PASS, `CS_A0_SRC_NONE, `CS_A1_SRC_NONE,
            `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
            ...
            `CS_CMP_SEL_CFGA, /*CS_REG7 Comment: */
              8'hFF, 8'h00,    /*SC_REG4    Comment: */
              8'hFF, dpTXBitClkGenCmask0,    /*SC_REG5    Comment:dpTXBitClkGenCmask0 = OverSampleCount-1 */
    ...
    assign tx_status[UART_TX_STS_TX_COMPLETE] = tx_fifo_empty & tx_bitclk & ((NumStopBits == UART_NUM_STOP_BITS_1) ?
               (tx_state == UART_TX_STATE_SEND_STOP1) : (tx_state == UART_TX_STATE_SEND_STOP2));
    ...
    */
    ...
    begin
        always @(posedge clock_op) 
        begin
            if(tx_state == UART_TX_STATE_SEND_DATA)
            begin
                tx_clk_reg <= tx_bitclk_half;
                tx_data_reg <= tx;
            end
            else
            begin
...
begin:sRX
    ...
    localparam UART_RX_SHIFTER_DP_CONFIG = 
    {
        ...
        `CS_SHFT_OP___SR, `CS_A0_SRC__ALU, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG3 Comment:GET DATA (SR) */
        ...
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG5 Comment:SEND START */
        `CS_ALU_OP_PASS, `CS_SRCA_A1, `CS_SRCB_D0,
        `CS_SHFT_OP_PASS, `CS_A0_SRC_NONE, `CS_A1_SRC_NONE,
        `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
        `CS_CMP_SEL_CFGA, /*CS_REG6 Comment:IDLE */
    ...
    assign rx_bitclk_pre = (rx_count[cl-1:0] == 4'd0) ? 1'b1 : 1'b0;
    ...
    begin : s23Poll
        ...
        assign rx_poll_bit0 = rx_count7_bit8_wire ?
                    ((rx_count[cl-1:0] == (HalfBitCounts + 4'd2)) ? 1'b1 : 1'b0) :
                    (rx_count[cl-1:0] == 4'd2) ? 1'b1 : 1'b0;
        ...
        assign pollingrange = rx_poll_bit0 | rx_poll_bit1 | rx_poll_bit2;
    ...
    begin
        ...
        assign rx_status[UART_RX_STS_ADDR_MATCH] = (FinalAddrMode  == UART_RX_ADDR_MODE_NONE) ? 1'b0 :
                                                                                ((rx_addressmatch1 ) & rx_load_fifo);
    
        assign tx_en = ( HwTXEnSignal && HalfDuplexSend && (rx_state != UART_RX_STATE_IDLE)) ? 1'b1 : 1'b0;
        
        /* TX CRC outputs impelementation 
        * tx_clk and tx_data are synchronized to clock
        */  
        reg tx_clk_reg;
        reg tx_data_reg;
        ...
        begin
            always @(posedge clock_op) 
            begin
                if(rx_state == UART_HD_STATE_SEND_DATA)
                begin 
                    tx_clk_reg <= (rx_count[cl-1:0] == ((OverSampleCount / 4'd2) - 4'd2));
                    tx_data_reg <= tx;
                end    
                else
                begin
    ...
    begin
        assign rx_status[UART_RX_STS_MRKSPC] =  (FinalAddrMode == UART_RX_ADDR_MODE_HW_BYTE_BYTE) ?
                                                    (rx_markspace_status & (rx_addressmatch1 | rx_addressmatch2)) :
                                                (FinalAddrMode == UART_RX_ADDR_MODE_HW_DET_BUFFER) ?
                                                    (rx_markspace_status & (rx_addressmatch1 | rx_addressmatch2)) :
        ...
        assign rx_status[UART_RX_STS_ADDR_MATCH] =
                        (FinalAddrMode  == UART_RX_ADDR_MODE_NONE) ? 1'b0 : ((rx_addressmatch1 | rx_addressmatch2));
    end

    assign rx_load_fifo = (rx_state == UART_RX_STATE_CHECK_STOP1);
    assign rts_n = rx_fifofull;

    /* RX CRC outputs impelementation 
    ...
    */   
    ...
    begin
        always @(posedge clock_op) 
        begin
            if(rx_state == UART_RX_STATE_GET_DATA)
            begin
            
                rx_clk_reg <= Use23Polling ? rx_poll_bit0 : rx_bitclk;
                rx_data_reg <= rx;
            end
            else
            begin
    ...
    /* Instantiate the status register and interrupt hook */
    cy_psoc3_statusi #(.cy_force_order(1), .cy_md_select(7'h5F), .cy_int_mask(7'h7F)) RxSts /*5F*/
    (
        /* input          */  .clock(clock_op),
...
endmodule /* B_UART_v1_50 */

`endif /* B_UART_v1_50_V_ALREADY_INCLUDED */
