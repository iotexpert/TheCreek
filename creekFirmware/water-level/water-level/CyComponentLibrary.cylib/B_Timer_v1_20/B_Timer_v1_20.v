/*******************************************************************************
*  FILENAME:  B_Timer_v1_20.v   
*  UM Name:   B_Timer_v1_20
* 
*  DESCRIPTION:
...
`include "cypress.v"
`ifdef B_TIMER_V_v1_20_ALREADY_INCLUDED
`else
`define B_TIMER_V_v1_20_ALREADY_INCLUDED
module B_Timer_v1_20 (
    ...
    ***************************************************************************/
    ...
    assign status_tc = (hwEnable & per_zero) ? 1'b1 : 1'b0;   /* Terminal Count */
    assign tc = status_tc;
...
`endif /* B_TIMER_V_v1_20_ALREADY_INCLUDED */
