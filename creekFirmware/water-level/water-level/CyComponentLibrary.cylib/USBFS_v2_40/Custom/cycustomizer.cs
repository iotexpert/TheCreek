...
//            Debug.Assert(false);
            ...
            CyMidiDescriptorEditingControl midiControl = new CyMidiDescriptorEditingControl(parameters);
            ...
            CyParamExprDelegate ParamCommitted = delegate(ICyParamEditor custEditor, CyCompDevParam param)
                             {
                                 ...
                                 {
                                     ((CyMidiDescriptorPage)(midiControl.DisplayControl)).InitEnableAPICheckBox();
                                     ((CyMidiDescriptorPage)(midiControl.DisplayControl)).InitModeCheckBox();
                                 }
                             };
            ...
            editor.AddCustomPage(Properties.Resources.PAGE_TITLE_MIDIDESC,
                                midiControl, ParamCommitted, PAPAM_TAB_NAME_MIDI);
    ...
    public class CyDeviceDescriptorEditingControl : ICyParamEditingControl
    {
        ...
        public IEnumerable<CyCustErr> GetErrors()
        {
            ...
            m_control.m_parameters.SetCdcVidPid(m_control.m_parameters.m_deviceTree.m_nodes[0], "4B4", "F232");
            ...
            if (!m_control.m_parameters.CheckEPBulkMaxPacketSize(m_control.m_parameters.m_deviceTree.m_nodes[0]))
    ...
    public class CyMidiDescriptorEditingControl : ICyParamEditingControl
    {
        private CyMidiDescriptorPage m_control;

        public CyMidiDescriptorEditingControl(CyUSBFSParameters parameters)
        {
            m_control = new CyMidiDescriptorPage(parameters);
            m_control.Dock = DockStyle.Fill;
        }
        ...
        {
            // Save all changes before closing the customizer
            m_control.m_parameters.SerializedMidiDesc =
                CyDescriptorTree.SerializeDescriptors(m_control.m_parameters.m_midiTree,
                                                      m_control.m_parameters.m_serializer,
                                                      m_control.m_parameters.m_customSerNamespace);

            return CyCustomizer.GetErrors(m_control.m_parameters.m_inst, CyCustomizer.PAPAM_TAB_NAME_MIDI);
        }
