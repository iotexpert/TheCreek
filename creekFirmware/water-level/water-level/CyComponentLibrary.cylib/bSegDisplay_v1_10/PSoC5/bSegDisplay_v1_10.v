...
`include "cypress.v"
`ifdef bSegDisplay_v1_10_V_ALREADY_INCLUDED
`else
`define bSegDisplay_v1_10_V_ALREADY_INCLUDED

module bSegDisplay_v1_10 (
...
`endif /*bSegDisplay_v1_10_ALREADY_INCLUDED*/


`ifdef LCD_t_ff_v1_10_V_ALREADY_INCLUDED
`else
`define LCD_t_ff_v1_10_V_ALREADY_INCLUDED

module LCD_t_ff_v1_10 (
    q,
    d,
    clk,
    reset
...
`endif /*LCD_t_ff_v1_10_V_ALREADY_INCLUDED*/
