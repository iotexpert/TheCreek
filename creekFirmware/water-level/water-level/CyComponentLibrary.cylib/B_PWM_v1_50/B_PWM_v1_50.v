...
`include "cypress.v"
`ifdef B_PWM_V_v1_50_ALREADY_INCLUDED
`else
`define B_PWM_V_v1_50_ALREADY_INCLUDED
module B_PWM_v1_50 (
    ...
    ***************************************************************************/
    ...
    assign pwm = pwm_temp & hwEnable;
    
    assign pwm1 = (PWMMode == PWM_MODE_TWO_OUTPUT) ? (cmp1 & hwEnable) : 1'b0;
    assign pwm2 = (PWMMode == PWM_MODE_TWO_OUTPUT) ? (cmp2 & hwEnable) : 1'b0;
...
`endif /* B_PWM_V_v1_50_ALREADY_INCLUDED */
