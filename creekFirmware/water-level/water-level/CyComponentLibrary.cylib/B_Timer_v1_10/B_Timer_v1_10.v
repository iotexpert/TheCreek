/*******************************************************************************
*  FILENAME:  B_Timer_v1_10.v   
*  UM Name:   B_Timer_v1_10
* 
*  DESCRIPTION:
...
`include "cypress.v"
`ifdef B_TIMER_V_v1_10_ALREADY_INCLUDED
`else
`define B_TIMER_V_v1_10_ALREADY_INCLUDED
module B_Timer_v1_10 (
    ...
    ***************************************************************************/
    ...
    if (CaptureCounterEnabled == 1) begin : sCapCount
	  ...
	  always @(posedge clock or posedge reset) begin
        ...
        assign capt_fifo_load = fifo_load_polarized & !fifo_full & timer_enable;
    end
    endgenerate
    ...
    ***************************************************************************/
    ...
    wire [2:0] cs_addr;
    assign cs_addr = {reset,trig_reg,per_zero};//{reset,timer_enable,per_zero};//
    generate
...
always@ (posedge reset or posedge set) begin
...
`endif /* B_TIMER_V_v1_10_ALREADY_INCLUDED */
