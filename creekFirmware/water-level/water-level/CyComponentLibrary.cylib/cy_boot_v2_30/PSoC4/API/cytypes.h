...
(((uint32)(addr) & 1) ? \
	(CY_GET_REG8((uint32)addr) | \
	(CY_GET_REG8(((uint32)(addr))+1) << 8)) \
	: \
...
(((uint32)(addr) & 3) ? \
	(CY_GET_REG16((uint32)addr) | \
	(CY_GET_REG16(((uint32)(addr))+2) << 16)) \
	: \
...
(((uint32)(addr) & 1) ? \
	(CY_SET_REG8(((uint32)(addr)), (value)), \
	CY_SET_REG8((((uint32)(addr))+1), (value) >> 8)) \
	: \
...
(void)(((uint32)(addr) & 3) ? \
	(CY_SET_REG16(((uint32)(addr)), (value)), \
	CY_SET_REG16((((uint32)(addr))+2), (value) >> 16)) \
	: \
...
(((uint32)(addr) & 1) ? \
	(CY_GET_REG8((uint32)addr) | \
	(CY_GET_REG16(((uint32)(addr))+1) << 8)) \
	: \
	(CY_GET_REG16((uint32)addr) | \
	(CY_GET_REG8(((uint32)(addr))+2) << 16)) \
)

#define CY_SET_REG24(addr, value) \
(((uint32)(addr) & 1) ? \
	(CY_SET_REG8(((uint32)(addr)), (value)), \
	CY_SET_REG16((((uint32)(addr))+1), (value) >> 8)) \
	: \
	(CY_SET_REG16(((uint32)(addr)), (value)), \
	CY_SET_REG8((((uint32)(addr))+2), (value) >> 16)) \
) 
