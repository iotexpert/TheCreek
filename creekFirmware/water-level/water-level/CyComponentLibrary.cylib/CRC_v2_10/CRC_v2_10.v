...
`include "cypress.v"
`ifdef CRC_v2_10_V_ALREADY_INCLUDED
`else
`define CRC_v2_10_V_ALREADY_INCLUDED
...
(
   ...
   localparam PSOC5_ES1 = ((`CYDEV_CHIP_MEMBER_USED   == `CYDEV_CHIP_MEMBER_5A) && 
	...
	generate
        ...
        begin
            always @(posedge clk_ctrl or posedge reset_final)
            begin
				if (reset_final)
					state <= 2'b11;
				else
...
`endif      /* CRC_v2_10_V_ALREADY_INCLUDED */
