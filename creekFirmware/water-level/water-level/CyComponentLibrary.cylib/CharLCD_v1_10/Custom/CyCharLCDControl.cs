...
namespace CharLCD_v1_10
{
    public partial class CyCharLCDControl : UserControl
    {
        ...
        {
            CharLCD_v1_10.CustomCharacter current = (CharLCD_v1_10.CustomCharacter)sender;
            CharLCD_v1_10.Box clickedBox = current.GetBoxByLocation(e.X, e.Y);
            if (clickedBox != null)
            {
        ...
        private void custArray_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                CharLCD_v1_10.CustomCharacter current = (CharLCD_v1_10.CustomCharacter)sender;
                CharLCD_v1_10.Box currentBox = current.GetBoxByLocation(e.X, e.Y);
                if (currentBox != null)
                {
        ...
        {
            CharLCD_v1_10.CustomCharacter selectedCharacter = (CharLCD_v1_10.CustomCharacter)sender;
        ...
        private void HighlightNext()
        {
            ...
            UpdateHighlighted((CharLCD_v1_10.CustomCharacter)userDefinedCharacters[next]);
        }
        ...
        private void HighlightPrevious()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_v1_10.CustomCharacter)userDefinedCharacters[previous]);
        }
        ...
        private void HighlightAbove()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_v1_10.CustomCharacter)userDefinedCharacters[above]);
        }
        private void HighlightBelow()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_v1_10.CustomCharacter)userDefinedCharacters[below]);
        }
        ...
        {
            highlighted.Selected = false;
            foreach (CharLCD_v1_10.CustomCharacter character in this.panel1.Controls)
            {
