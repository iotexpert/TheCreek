...
#if !defined(CY_TIMER_v1_20_`$INSTANCE_NAME`_H)
#define CY_TIMER_v1_20_`$INSTANCE_NAME`_H
...
#define `$INSTANCE_NAME`_RunModeUsed                `$RunMode`
...
#endif  /* CY_TIMER_v1_20_`$INSTANCE_NAME`_H */
