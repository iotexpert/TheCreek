...
*
* Summary:
*  This function Send Message from one of Basic mailboxes. This function loop 
*  through the transmit message mailboxes designated as Basic CAN mailboxes for  
*  first free available and send from it. If it does not find a free Basic
*  mailbox, it will try again up to three times.
*
* Parameters:
*  message: Pointer to the structure that contain all the required data to 
*  send a message.
*
* Return:
*  Indication if a message has been sent.
*
*******************************************************************************/
...
*  mailboxes. Clears the Receive particular Message interrupt flag. Only  
*  generated if one of Receive mailboxes designed as Basic.
*
* Parameters:
...
void `$INSTANCE_NAME`_ReceiveMsg(uint8 rxMailbox) `=ReentrantKeil($INSTANCE_NAME . "_ReceiveMsg")`
{
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 0 Interrupt. Clears the 
    *  Receive Message 0 interrupt flag. Only generated for Receive mailbox 
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 1 Interrupt. Clears the 
    *  Receive Message 1 interrupt flag. Only generated for Receive mailbox  
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 2 Interrupt. Clears the 
    *  Receive Message 2 interrupt flag. Only generated for Receive mailbox 
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 3 Interrupt. Clears the 
    *  Receive Message 3 interrupt flag. Only generated for Receive mailbox
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 4 Interrupt. Clears the 
    *  Receive Message 4 interrupt flag. Only generated for Receive mailbox
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 5 Interrupt. Clears the
    *  Receive Message 5 interrupt flag. Only generated for Receive mailbox
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 6 Interrupt. Clears the
    *  Receive Message 6 interrupt flag. Only generated for Receive mailbox
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 7 Interrupt. Clears the
    *  Receive Message 7 interrupt flag. Only generated for Receive mailbox
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 8 Interrupt. Clears the
    *  Receive Message 8 interrupt flag. Only generated for Receive mailbox
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 9 Interrupt. Clears the
    *  Receive Message 9 interrupt flag. Only generated for Receive mailbox
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 10 Interrupt. Clears the
    *  Receive Message 10 interrupt flag. Only generated for Receive mailbox
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 11 Interrupt. Clears the
    *  Receive Message 11 interrupt flag. Only generated for Receive mailbox
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 12 Interrupt. Clears the
    *  Receive Message 12 interrupt flag. Only generated for Receive mailbox
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 13 Interrupt. Clears the
    *  Receive Message 13 interrupt flag. Only generated for Receive mailbox
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 14 Interrupt. Clears the
    *  Receive Message 14 interrupt flag. Only generated for Receive mailbox
    *  designed as Full.
    *
    * Parameters:
    *  None.
    ...
    *
    * Summary:
    *  This function is entry point to Receive Message 15 Interrupt. Clears the
    *  Receive Message 15 interrupt flag. Only generated for Receive mailbox 
    *  designed as Full.
    *
    * Parameters:
    *  None.
