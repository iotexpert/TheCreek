...
*
* FILENAME:  B_UART_v2_0.v
* COMPONENT NAME:   B_UART_v2_0
...
`include "cypress.v"
`ifdef B_UART_v2_0_V_ALREADY_INCLUDED
`else
`define B_UART_v2_0_V_ALREADY_INCLUDED
module B_UART_v2_0
(
    ...
    output  reg rx_data,        /* Recieve Data: shift out the RX data to a CRC component or other logic */
    output  reg rx_clk          /* Recieve Clock: Provides clock edge used to shift out the RX data */
);
...
/**************************************************************************/
/* Reset signal synchonization for Count7 usage                           */
/**************************************************************************/
reg reset_reg;
...
/**************************************************************************/
wire reset_reg_dp = (PSOC3_ES2 || PSOC5_ES1) ? 1'b0 : reset_reg;
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                rx_clk <= Use23Polling ? rx_poll_bit0 : rx_bitclk;
                rx_data <= rx;
            end
            else
            begin
...
endmodule /* B_UART_v2_0 */

`endif /* B_UART_v2_0_V_ALREADY_INCLUDED */
