...
***************************************/
    ...
    #define `$INSTANCE_NAME`_EXECUTE_DFF_RESET  {(`$INSTANCE_NAME`_CONTROL_REG |= \
        (`$INSTANCE_NAME`_INIT_STATE | `$INSTANCE_NAME`_CTRL_RESET_COMMON | `$INSTANCE_NAME`_CTRL_RISING_EDGE ));\
        `$INSTANCE_NAME`_CONTROL_REG &= ~(`$INSTANCE_NAME`_CTRL_RESET_COMMON | `$INSTANCE_NAME`_CTRL_RISING_EDGE );}
    
    #define `$INSTANCE_NAME`_EXECUTE_DFF_SET     {(`$INSTANCE_NAME`_CONTROL_REG |= \
        (`$INSTANCE_NAME`_CTRL_RESET_COMMON | `$INSTANCE_NAME`_CTRL_RISING_EDGE )); \
        (`$INSTANCE_NAME`_CONTROL_REG &= ~(`$INSTANCE_NAME`_CTRL_RESET_COMMON | `$INSTANCE_NAME`_CTRL_RISING_EDGE));}

    #define `$INSTANCE_NAME`_EXECUTE_STEP       {( `$INSTANCE_NAME`_CONTROL_REG |= \
        (`$INSTANCE_NAME`_CTRL_RISING_EDGE)); ( `$INSTANCE_NAME`_CONTROL_REG &= ~(`$INSTANCE_NAME`_CTRL_RISING_EDGE)); }

#else

    #if (`$INSTANCE_NAME`_RUN_MODE == `$INSTANCE_NAME`__CLOCKED)
        #define `$INSTANCE_NAME`_EXECUTE_DFF_RESET  (`$INSTANCE_NAME`_CONTROL_REG |= (`$INSTANCE_NAME`_INIT_STATE |\
        `$INSTANCE_NAME`_CTRL_RESET_COMMON))
...
#else
    #define `$INSTANCE_NAME`_CONTROL_REG               (*(reg8 *) `$INSTANCE_NAME`_SyncCtrl_ClkSp_CtrlReg__CONTROL_REG )
    #define `$INSTANCE_NAME`_CONTROL_PTR               ( (reg8 *) `$INSTANCE_NAME`_SyncCtrl_ClkSp_CtrlReg__CONTROL_REG )
