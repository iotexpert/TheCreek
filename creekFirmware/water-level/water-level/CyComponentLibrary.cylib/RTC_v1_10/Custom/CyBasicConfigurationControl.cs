...
namespace RTC_v1_10
{
    class CyBasicConfigurationControl: UserControl, ICyParamEditingControl
    {
        ...
        public CyBasicConfigurationControl(CyParameters parameters)
        {
            ...
            PopulateControls(parameters);
        }

        private void PopulateControls(CyParameters parameters)
        {
            foreach (DayOfWeek d in Enum.GetValues(typeof(DayOfWeek)))
            {
                combo_StartDay.Items.Add(d);
            }
            combo_StartDay.SelectedItem = parameters.StartDayOfWeek;

            check_dstEnable.Checked = parameters.DstEnable;
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.check_dstEnable.Size = new System.Drawing.Size(77, 17);
            ...
            this.combo_StartDay.Location = new System.Drawing.Point(100, 55);
            this.combo_StartDay.Name = "combo_StartDay";
            this.combo_StartDay.Size = new System.Drawing.Size(121, 21);
            ...
            this.label_StartOfWeek.Size = new System.Drawing.Size(70, 13);
