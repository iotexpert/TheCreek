...
`include "cypress.v"
`ifdef bI2C_v2_20_V_ALREADY_INCLUDED
`else
`define bI2C_v2_20_V_ALREADY_INCLUDED
...
(
    ...
    reg scl_in_last_reg, scl_in_last2_reg;
    reg sda_in_last_reg, sda_in_last2_reg;
    wire sda_went_low;
    wire sda_went_high;
    wire scl_went_low;
    wire scl_went_high;
    ...
    assign sda_negedge_detect = sda_went_low;
    assign sda_posedge_detect = sda_went_high;
    assign scl_negedge_detect = scl_went_low;
    assign scl_posedge_detect = scl_went_high;
...
endmodule /* bI2C_v2_20 */ 
`endif /* bI2C_v2_20_V_ALREADY_INCLUDED */
