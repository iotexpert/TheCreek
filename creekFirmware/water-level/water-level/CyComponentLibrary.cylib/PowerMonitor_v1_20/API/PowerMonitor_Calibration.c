...
*   `$INSTANCE_NAME`_adcGainCalRawCfg3  = -2048;    Vref measured on +/-1024 mV range.
...
*   `$INSTANCE_NAME`_adcGainCfg2        = 0.03125;  units are 1 mV/count at +/- 64 mV range 0.125; 
*                                                   units are 1 mV/count at +/-256 mV range
    ...
    switch (`$INSTANCE_NAME`_calType)
    {
        ...
        ***************************************************************************/
        ...
        case `$INSTANCE_NAME`_CAL_PGA3Z:
            ...
            *                b) Cfg #1 zero offset
            ***********************************************************************/
            tmpInt  = `$INSTANCE_NAME`_iirFiltAdc(iirInit, `$INSTANCE_NAME`_adcSCCalRawCfg3, 
                                                  &`$INSTANCE_NAME`_filtSCAdjRaw3);
            tmpInt  = -tmpInt;
            tmpInt -= `$INSTANCE_NAME`_adcZeroCfg3;
            `$INSTANCE_NAME`_adcSeAdjCfg3 = tmpInt * `$INSTANCE_NAME`_adcGainCfg3;
            break;        
    }
}
