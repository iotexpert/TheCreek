...
#if (`$INSTANCE_NAME`_NUMBER_OF_CONVERTERS == `$INSTANCE_NAME`_MAX_CONVERTERS)
    #define `$INSTANCE_NAME`_DEFAULT_WARN_MASK           (0xfffffffful)
    #define `$INSTANCE_NAME`_DEFAULT_FAULT_MASK          (0xfffffffful)
#else
    #define `$INSTANCE_NAME`_DEFAULT_WARN_MASK           ((1ul << `$INSTANCE_NAME`_NUMBER_OF_CONVERTERS) - 1)
    #define `$INSTANCE_NAME`_DEFAULT_FAULT_MASK          ((1ul << `$INSTANCE_NAME`_NUMBER_OF_CONVERTERS) - 1)
#endif /* (`$INSTANCE_NAME`_NUMBER_OF_CONVERTERS == `$INSTANCE_NAME`_MAX_CONVERTERS) */
...
#define `$INSTANCE_NAME`_MAX_CHANNELS                    (`$INSTANCE_NAME`_NUMBER_OF_CONVERTERS + \
...
#define `$INSTANCE_NAME`_TOTAL_V_I_MEASUREMENTS          (`$INSTANCE_NAME`_NUMBER_OF_CONVERTERS + \
                                                          `$INSTANCE_NAME`_NUM_CURRENT_SOURCES)
...
#define `$INSTANCE_NAME`_PGOOD_CTRL_MASK                 (0xFFu)
    ...
    #define `$INSTANCE_NAME`_PGOOD_CTRL_25_32_MASK      ((1u <<(`$INSTANCE_NAME`_NUMBER_OF_CONVERTERS - \
...
#elif (`$INSTANCE_NAME`_NUMBER_OF_CONVERTERS > `$INSTANCE_NAME`_CONVERTERS_16)
    #define `$INSTANCE_NAME`_PGOOD_CTRL_25_32_MASK      (0x00u)
    #define `$INSTANCE_NAME`_PGOOD_CTRL_17_24_MASK      ((1u <<(`$INSTANCE_NAME`_NUMBER_OF_CONVERTERS - \
                                                          `$INSTANCE_NAME`_CONVERTERS_16)) - 1)
    #define `$INSTANCE_NAME`_PGOOD_CTRL_9_16_MASK       (0xFFu)
    #define `$INSTANCE_NAME`_PGOOD_CTRL_1_8_MASK        (0xFFu)                                                          
#elif (`$INSTANCE_NAME`_NUMBER_OF_CONVERTERS > `$INSTANCE_NAME`_CONVERTERS_8)
    #define `$INSTANCE_NAME`_PGOOD_CTRL_25_32_MASK      (0x00u)
    #define `$INSTANCE_NAME`_PGOOD_CTRL_17_24_MASK      (0x00u)
    #define `$INSTANCE_NAME`_PGOOD_CTRL_9_16_MASK       ((1u <<(`$INSTANCE_NAME`_NUMBER_OF_CONVERTERS - \
    ...
    #define `$INSTANCE_NAME`_PGOOD_CTRL_1_8_MASK        ((1u <<`$INSTANCE_NAME`_NUMBER_OF_CONVERTERS) - 1)
