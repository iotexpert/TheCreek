    ...
    public partial class CyVoltagesTab : CyEditingWrapperControl
    {
        ...
        public void UpdateTableRowFromUI(int i)
        {
            if (i >= 0 && i < m_dataGridRowCount)
            {
                ...
                m_params.VoltagesTable[i].m_nominalOutputVoltage = CyParameters.ParseNullableDouble(dataGridView1.Rows[i].Cells[
                ...
                m_params.VoltagesTable[i].m_uvFaultTreshold = CyParameters.ParseNullableDouble(dataGridView1.Rows[i].Cells[
                    colUVFaultThreshold.Index].Value);

                m_params.VoltagesTable[i].m_uvWarningTreshold = CyParameters.ParseNullableDouble(dataGridView1.Rows[i].Cells[
                    colUVWarningThreshold.Index].Value);

                m_params.VoltagesTable[i].m_ovFaultTreshold = CyParameters.ParseNullableDouble(dataGridView1.Rows[i].Cells[
                    colOVFaultThreshold.Index].Value);

                m_params.VoltagesTable[i].m_ovWarningTreshold = CyParameters.ParseNullableDouble(dataGridView1.Rows[i].Cells[
                    colOVWarningThreshold.Index].Value);

                m_params.VoltagesTable[i].m_inputScalingFactor = CyParameters.ParseNullableDouble(dataGridView1.Rows[i].Cells[
        ...
        public void UpdateColumnsState()
        {
            ...
            CyParameters.SetColumnReadOnlyState(dataGridView1, colOVWarningThreshold.Index, !m_params.WarningSourcesOV);
            CyParameters.SetColumnReadOnlyState(dataGridView1, colUVFaultThreshold.Index, !m_params.FaultSourcesUV);
            CyParameters.SetColumnReadOnlyState(dataGridView1, colUVWarningThreshold.Index, !m_params.WarningSourcesUV);
        }
        #endregion
