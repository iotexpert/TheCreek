...
namespace PowerMonitor_v1_20
{
    public partial class CyGeneralTab : CyEditingWrapperControl
    {
        ...
        public CyGeneralTab(CyParameters param)
        {
            ...
            m_cbLowVoltageMode.SelectedIndexChanged += cbDiffCurrentRange_SelectedIndexChanged;
            ...
            m_cbLowVoltageMode.Items.AddRange(CyEnumConverter.GetEnumDescList(typeof(CyELowVoltageMode)));
        ...
        public void UpdateUI(bool validateConvertersNumber )
        {
            ...
            m_cbLowVoltageMode.SelectedItem = CyEnumConverter.GetEnumDesc(m_params.LowVoltageMode);
                    ...
                    m_previousNumAuxChannels <= CyParamRanges.NUM_AUX_CHANNELS_MAX)
                {
                    if (value > m_previousNumAuxChannels)
                    {
                        ...
                        if (m_params.AuxTable.Count < value)
                        {
                            for (int i = 0; i < missingItemsCount; i++)
                            {
                                m_params.AuxTable.Add(new CyAuxTableRow());
                            }
                        }
                    }
                }
