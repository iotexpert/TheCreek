...
namespace VDAC8_v1_60
{
    ...
    public class CyCustomizer : ICyParamEditHook_v1, ICyExprEval_v2, ICyDRCProvider_v1
    {
        ...
        VDACControl m_control = null;
        double range_value;
        const string VoltageRangeNote = "System VDDA voltage is set less than the voltage range of VDAC, the actual range of the VDAC will be 0V to VDDA.";
        
        public DialogResult EditParams(ICyInstEdit_v1 edit, ICyTerminalQuery_v1 termQuery, ICyExpressMgr_v1 mgr)
        {
            m_control = new VDACControl(edit);
            m_Component = edit;
        ...
        {
            VDACControl m_control;
            Panel displayControl = new Panel();




            public CyCompEditingControl(ICyInstEdit_v1 inst, ICyTerminalQuery_v1 termquery, VDACControl control)
            {
                m_control = control;
