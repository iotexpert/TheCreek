...
namespace USBFS_v1_30
{
    ...
    public static class CyHIDReportItemTables
    {
        ...
        static CyHIDReportItemTables()
        {
            ...
            ValuesButtonPage = new string[PAGE_LIST_LENGTH * 2];
            ...
            ValuesOrdinalPage = new string[PAGE_LIST_LENGTH * 2];
            ...
            ValuesUnicodePage = new string[PAGE_LIST_LENGTH * 2];
            for (int i = 0; i < PAGE_LIST_LENGTH; i++)
            {
            ...
            ValuesMonitorEnumeratedValuesPage = new string[PAGE_LIST_LENGTH * 2];
            for (int i = 0; i < PAGE_LIST_LENGTH; i++)
            {
        ...
        public static string[] ValuesVRControlPage = {
                                                "Undefined","0",
                                                "Belt","1",
                                                "Body Suit","2",
                                                "Flexor","3",
        ...
        public static string[] ValuesSportControlPage = {
                                                "Undefined","0",
                                                "Baseball Bat","1",
                                                "Golf Club","2",
                                                "Rowing Machine","3",
        ...
        public static string[] ValuesGameControlsPage = {
                                                                  "Undefined", "0",
        ...
        public static string[] ValuesGenericDeviceControlsPage = {
                                                                  "Undefined", "0",
                                                                  "Battery Strength", "20",
                                                                  "Wireless Channel", "21",
                                                                  "Wireless ID", "22",
        ...
        public static string[] ValuesKeyboardPage = {
                                                                  "Undefined", "0",
                                                              };
        public static string[] ValuesLEDPage = {
                                                                  "Undefined", "0",
                                                                  "Num Lock", "1",
                                                                  "Caps Lock", "2",
                                                                  "Scroll Lock", "3",
        ...
        public static string[] ValuesButtonPage;  // Filled in Constructor
        public static string[] ValuesOrdinalPage;  // Filled in Constructor

        public static string[] ValuesTelephonyDevicePage = {
                                                                  "Undefined", "0",
                                                                  "Phone", "01",
        ...
        public static string[] ValuesConsumerPage = {
                                                                  "Unassigned", "00",
                                                                  "Consumer Control", "01",
                                                                  "Numeric Key Pad", "02",
        ...
        public static string[] ValuesDigitizersPage = {
                                                                  "Undefined", "0",
                                                                  "Digitizer", "1",
                                                                  "Pen", "2",
                                                                  "Light Pen", "3",
        ...
        public static string[] ValuesPIDPage = {
                                                                  "Undefined", "0",
        ...
        public static string[] ValuesUnicodePage; // Filled in Constructor
        
        public static string[] ValuesAlphanumericDisplayPage = {
                                                                  "Undefined", "0",
        ...
        public static string[] ValuesMedicalInstrumentPage = {
                                                                  "Undefined", "0",
        ...
        public static string[] ValuesMonitorDevicesPage = {
                                                                  "Monitor Control", "1",
                                                                  "EDID Information", "2",
                                                                  "VDIF Information", "3",
                                                                  "VESA Version", "4"
        ...
        public static string[] ValuesMonitorEnumeratedValuesPage; // Filled in Constructor

        public static string[] ValuesVESAVirtualControlsPage = {
                                                                  "Brightness", "10",
                                                                  "Contrast", "12",
                                                                  "Red Video Gain", "16",
                                                                  "Green Video Gain", "18",
        ...
        public static string[] ValuesPowerDevicePage = {
                                                                  "Undefined", "0",
                                                                  "iName", "1",
                                                                  "PresentStatus", "2",
                                                                  "ChangedStatus", "3",
        ...
        public static string[] ValuesBatterySystemPage = {
