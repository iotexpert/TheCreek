    ...
    public partial class CyPRISMControl : UserControl
    {
        ...
        public void UpdateFromParam()
        {
            try
            {
                ...
                UInt32 loadedResult = m_Parameters.PolyValue;
                if ((loadedResult != CalcPolynomial(m_Parameters.Resolution)) && (loadedResult > 0))
                {
        ...
        private void numUpDownResolution_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                int upDownValue = Convert.ToInt32(numUpDownResolution.Value);
                if (upDownValue != m_Parameters.Resolution) m_SetDefaultSeed = true;
        ...
        private void textBoxResult_TextChanged(object sender, EventArgs e)
        {
            if ((m_Parameters.GlobalEditMode))
            {
                try
                {
                    ...
                    {
                        m_Parameters.PolyValue = 0;
                    }
                    else
                    {
                        m_Parameters.PolyValue = Convert.ToUInt32(textBoxResult.Text, 16);
                    }
                }
                catch
                {
        ...
        private void comboBoxPulse0_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                if (m_Parameters.Density0 != Convert.ToUInt32(comboBoxPulse0.Text))
                {
            ...
            {
                if (m_Parameters.Density1 != Convert.ToUInt32(comboBoxPulse1.Text))
                {
            ...
            {
                if ((byte)m_Parameters.CompareType0 != Convert.ToByte(comboBoxCompare0.SelectedIndex))
                {
            ...
            {
                if ((byte)m_Parameters.CompareType1 != Convert.ToByte(comboBoxCompare1.SelectedIndex))
                {
