 ...
 void `$INSTANCE_NAME`_UpdateSensorBaseline(uint8 sensor)
{
    ...
    #else
        /* No Raw filters */
    #endif  /* End (`$INSTANCE_NAME`_RAW_FILTER_MASK & `$INSTANCE_NAME`_MEDIAN_FILTER) */
...
`$writerCSHLDisWidget`
    ...
    *
    *******************************************************************************/
    uint8 `$INSTANCE_NAME`_CalcCentroid(`$CalcCentroidPrototypeCallReplacementString`uint8 maximum, uint8 offset, uint8 count, uint16 resolution, uint8 noiseThreshold)
    {
    ...
    *
    *******************************************************************************/
    uint16 `$INSTANCE_NAME`_GetCentroidPos(uint8 widget)
    {
        #if (`$INSTANCE_NAME`_IS_DIPLEX_SLIDER)
                    ...
                    else
                    {
                        /* Do filtering */
                            ...
                            if (0u != (posFiltersMask & `$INSTANCE_NAME`_MEDIAN_FILTER))
                            {
                                ...
                                position = `$INSTANCE_NAME`_MedianFilter(position, `$INSTANCE_NAME`_posFiltersData[posIndex], `$INSTANCE_NAME`_posFiltersData[posIndex + 1u]);
                            ...
                            {
                                tempPos = (uint8) position;
                                position = `$INSTANCE_NAME`_AveragingFilter(position, `$INSTANCE_NAME`_posFiltersData[posIndex], `$INSTANCE_NAME`_posFiltersData[posIndex + 1u]);
                                `$INSTANCE_NAME`_posFiltersData[posIndex + 1u] = `$INSTANCE_NAME`_posFiltersData[posIndex];
                                `$INSTANCE_NAME`_posFiltersData[posIndex] = tempPos;
                            }
                        #endif
                            ...
                            {
                                position = `$INSTANCE_NAME`_IIR2Filter(position, `$INSTANCE_NAME`_posFiltersData[posIndex]);
                                `$INSTANCE_NAME`_posFiltersData[posIndex] = (uint8) position;
                            }
                        #endif
                            ...
                            {
                                position = `$INSTANCE_NAME`_IIR4Filter(position, `$INSTANCE_NAME`_posFiltersData[posIndex]);
                                `$INSTANCE_NAME`_posFiltersData[posIndex] = (uint8) position;
                            }                                
                        #endif
                            ...
                            {
                                position = `$INSTANCE_NAME`_JitterFilter(position, `$INSTANCE_NAME`_posFiltersData[posIndex]);
                                `$INSTANCE_NAME`_posFiltersData[posIndex] = (uint8) position;
                            }
                        #endif
                    }
                ...
                if (0u != (posFiltersMask & `$INSTANCE_NAME`_ANY_POS_FILTER))
                {
                    ...
                    else
                    {
                        /* Do filtering */
                            ...
                            {
                                tempPos = (uint8) position;
                                position = `$INSTANCE_NAME`_MedianFilter(position,`$INSTANCE_NAME`_posFiltersData[posIndex], 
                        ...
                        #if (0u != (`$INSTANCE_NAME`_AVERAGING_FILTER & `$INSTANCE_NAME`_RADIAL_SLIDERS_POS_FILTERS_MASK))
                            if (0u != (posFiltersMask & `$INSTANCE_NAME`_AVERAGING_FILTER))
                            {
                                tempPos = (uint8) position;
                                position = `$INSTANCE_NAME`_AveragingFilter(position, `$INSTANCE_NAME`_posFiltersData[posIndex], 
                                  `$INSTANCE_NAME`_posFiltersData[posIndex + 1u]);
                                `$INSTANCE_NAME`_posFiltersData[posIndex + 1u] = `$INSTANCE_NAME`_posFiltersData[posIndex];
                                `$INSTANCE_NAME`_posFiltersData[posIndex] = tempPos;
                            }
                    ...
                    if (0u != (posFiltersMask & `$INSTANCE_NAME`_ANY_POS_FILTER))
                    {
                        ...
                        else
                        {
                            /* Do filtering */
                                ...
                                {
                                    tempPos = posX;
                                    posX = (uint8) `$INSTANCE_NAME`_MedianFilter(posX, `$INSTANCE_NAME`_posFiltersData[posXIndex], 
                                      `$INSTANCE_NAME`_posFiltersData[posXIndex + 1u]);
                                    `$INSTANCE_NAME`_posFiltersData[posXIndex + 1u] = `$INSTANCE_NAME`_posFiltersData[posXIndex];
                                    `$INSTANCE_NAME`_posFiltersData[posXIndex] = tempPos;
                                    
                                    tempPos = posY;
                                    posY = (uint8) `$INSTANCE_NAME`_MedianFilter(posY, `$INSTANCE_NAME`_posFiltersData[posYIndex], 
                                      `$INSTANCE_NAME`_posFiltersData[posYIndex + 1u]);
                                    `$INSTANCE_NAME`_posFiltersData[posYIndex + 1u] = `$INSTANCE_NAME`_posFiltersData[posYIndex];
                                ...
                                {
                                    tempPos = posX;
                                    posX = (uint8) `$INSTANCE_NAME`_AveragingFilter(posX, `$INSTANCE_NAME`_posFiltersData[posXIndex], 
                                      `$INSTANCE_NAME`_posFiltersData[posXIndex + 1u]);
                                    `$INSTANCE_NAME`_posFiltersData[posXIndex + 1u] = `$INSTANCE_NAME`_posFiltersData[posXIndex];
                                    `$INSTANCE_NAME`_posFiltersData[posXIndex] = tempPos;
                                    
                                    tempPos = posY;
                                    posY = (uint8) `$INSTANCE_NAME`_AveragingFilter(posY, `$INSTANCE_NAME`_posFiltersData[posYIndex], 
                                      `$INSTANCE_NAME`_posFiltersData[posYIndex + 1u]);
                                    `$INSTANCE_NAME`_posFiltersData[posYIndex + 1u] = `$INSTANCE_NAME`_posFiltersData[posYIndex];
                                    `$INSTANCE_NAME`_posFiltersData[posYIndex] = tempPos;
                                }
                                ...
                                if (0u != (posFiltersMask & `$INSTANCE_NAME`_IIR2_FILTER))
                                {
                                    posX = (uint8) `$INSTANCE_NAME`_IIR2Filter(posX, `$INSTANCE_NAME`_posFiltersData[posXIndex]);
                                    `$INSTANCE_NAME`_posFiltersData[posXIndex] = posX;
                                    
                                    posY = (uint8) `$INSTANCE_NAME`_IIR2Filter(posY, `$INSTANCE_NAME`_posFiltersData[posYIndex]);
                                    `$INSTANCE_NAME`_posFiltersData[posYIndex] = posY;
                                }
                                ...
                                if (0u != (posFiltersMask & `$INSTANCE_NAME`_IIR4_FILTER))
                                {
                                    posX = (uint8) `$INSTANCE_NAME`_IIR4Filter(posX, `$INSTANCE_NAME`_posFiltersData[posXIndex]);
                                    `$INSTANCE_NAME`_posFiltersData[posXIndex] = posX;
                                    
                                    posY = (uint8) `$INSTANCE_NAME`_IIR4Filter(posY, `$INSTANCE_NAME`_posFiltersData[posYIndex]);
                                    `$INSTANCE_NAME`_posFiltersData[posYIndex] = posY;
                                }
                                ...
                                if (0u != (posFiltersMask & `$INSTANCE_NAME`_JITTER_FILTER))
                                    {
                                        posX = (uint8) `$INSTANCE_NAME`_JitterFilter(posX, `$INSTANCE_NAME`_posFiltersData[posXIndex]);
                                        `$INSTANCE_NAME`_posFiltersData[posXIndex] = posX;
                                        
                                        posY = (uint8) `$INSTANCE_NAME`_JitterFilter(posY, `$INSTANCE_NAME`_posFiltersData[posYIndex]);
                                        `$INSTANCE_NAME`_posFiltersData[posYIndex] = posY;
                                    }
                            #endif
                        }
