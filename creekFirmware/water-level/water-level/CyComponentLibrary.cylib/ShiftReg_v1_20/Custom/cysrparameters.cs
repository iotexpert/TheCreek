...
namespace ShiftReg_v1_20
{
    ...
    public class CySRParameters
    {
        ...
        public void GetParams(ICyInstEdit_v1 inst)
        {
            ...
            CyCBConverter.SetValue(m_GeneralParams.cbFIFOS, inst.GetCommittedParam("FifoSize").Value.ToString());
        ...
        public void SetParams(ICyInstEdit_v1 inst)
        {
            ...
            {                
                ...
                inst.SetParamExpr("FifoSize", CyCBConverter.GetValue(m_GeneralParams.cbFIFOS));
