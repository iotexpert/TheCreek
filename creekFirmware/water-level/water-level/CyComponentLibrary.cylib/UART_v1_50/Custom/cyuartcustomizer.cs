...
namespace UART_v1_50
{
    ...
    public class CyCustomizer : ICyParamEditHook_v1
    {
        ...
        public DialogResult EditParams(ICyInstEdit_v1 edit, ICyTerminalQuery_v1 termQuery, ICyExpressMgr_v1 mgr)
        {
            ...
            editor.AddCustomPage(Properties.Resources.ConfigureTabCaption, editControl, paramChanged, 
                BASIC_TAB_NAME);
            editor.AddCustomPage(Properties.Resources.AdvancedTabCaption, editControlAdv, paramChanged, 
                ADVANCED_TAB_NAME);
