...
namespace UART_v1_50
{
    public partial class CyUartAdvancedControl : UserControl, ICyParamEditingControl
    {
        ...
        public CyUartAdvancedControl(ICyInstEdit_v1 inst, ICyTerminalQuery_v1 termquery, CyUARTParameters parameters)
        {
            ...
            m_numTXBufferSize.Validating += new CancelEventHandler(m_numeric_Validating);
        }
        #endregion
        ...
        void m_numeric_Validating(object sender, CancelEventArgs e)
        {
            if (sender is NumericUpDown)
            {
                ...
                string message = String.Format(Properties.Resources.InvalidValueRangeMsg, minimum, maximum);
        ...
        public void UpdateRXAddressMode()
        {
            ...
            List<string> RXAddressModes = (List<string>)m_instance.GetPossibleEnumValues(CyParamNames.RX_ADDRESS_MODE);
            for (int i = 0; i < RXAddressModes.Count; i++)
            {
        ...
        private void SetFrequencyLabel()
        {
            if (m_rbExternalClock.Checked)
            {
                ...
                if (clkdata[0].IsFrequencyKnown)
                {
                    ...
                    m_lblCalcFrequency.Text = string.Format(Properties.Resources.SourceFreqMsg,
                ...
                else
                {
                    ...
                    m_lblCalcFrequency.Text = Properties.Resources.UnknownSourceFreqMsg;
                }
            }
            else
            {
        ...
        private void SetBufferSize(object sender, string buffSizeName, string interruptName)
        {
            ...
            SetAParameter(buffSizeName, currentNumericUpDown.Value.ToString());
            bool paramValue = currentNumericUpDown.Value < 5 ? false : true;
        ...
        private void m_cbBreakSignal_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string errStr = (iVal > 15) ? Properties.Resources.BreakSignalErrMsg : "";
        ...
        private void m_rbOverSamplingRate_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                errStr = Properties.Resources.OverSamplingRateErrMsg;
            }
        ...
        private void CyUartAdvancedControl_Load(object sender, EventArgs e)
        {
            ...
            m_numeric_Validating(m_numRXBufferSize,  new CancelEventArgs());
            m_numeric_Validating(m_numTXBufferSize, new CancelEventArgs());
        }
        #endregion
    }
}
