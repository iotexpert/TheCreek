...
#define DMAC_CFG                        ((reg32 *) CYDEV_PHUB_CFG)
#define DMAC_ERR                        ((reg32 *) CYDEV_PHUB_ERR)  
#define DMAC_ERR_ADR                    ((reg32 *) CYDEV_PHUB_ERR_ADR)
...
// Belong in device.h or sommething else TBD.
