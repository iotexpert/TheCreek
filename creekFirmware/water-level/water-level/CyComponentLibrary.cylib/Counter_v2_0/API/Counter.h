...
typedef struct `$INSTANCE_NAME`_backupStruct
{
    ...
    uint8 CounterEnableState; 
        ...
        `$RegSizeReplacementString` CounterPeriod; /* Counter Period Value       */
        `$RegSizeReplacementString` CompareValue;  /* Counter Compare Value      */           
 ...
 *************************************/
    ...
    ********************************/
	...
	#define `$INSTANCE_NAME`_ONESHOT 				(0x01u << `$INSTANCE_NAME`_ONESHOT_SHIFT)
    ...
    #define `$INSTANCE_NAME`_CONTROL              (* (reg8 *) `$INSTANCE_NAME`_CounterUDB_sCTRLReg_`$CtlModeReplacementString`_ctrlreg__CONTROL_REG )
    #define `$INSTANCE_NAME`_CONTROL_PTR          (  (reg8 *) `$INSTANCE_NAME`_CounterUDB_sCTRLReg_`$CtlModeReplacementString`_ctrlreg__CONTROL_REG )
