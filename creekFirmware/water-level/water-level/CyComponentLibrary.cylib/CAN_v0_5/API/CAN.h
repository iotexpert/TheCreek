...
#define `$INSTANCE_NAME`_SET_TX_WNPL(i)				`$INSTANCE_NAME`_RX[i].txcmd.byte[0] |= `$INSTANCE_NAME`_TX_WPNL_MASK
#define `$INSTANCE_NAME`_CLEAR_TX_WNPL(i)			`$INSTANCE_NAME`_RX[i].txcmd.byte[0] &= ~`$INSTANCE_NAME`_TX_WPNL_MASK
