...
namespace PRS_v1_20
{
    public class CyPRSParameters
    {
        ...
        public void GetParams(CyCompDevParam param)
        {
            ...
            {
                //m_editMode = false;
                m_Resolution = Convert.ToInt32(SetValue(param, "Resolution", m_Resolution));
                if (m_Resolution > 32)
                {
                ...
                {
                    m_SeedValue = Convert.ToUInt32(SetValue(param, "SeedValueLower", m_SeedValue));
                    m_PolyValue = Convert.ToUInt32(SetValue(param, "PolyValueLower", m_PolyValue));
                }
                m_RunMode = Convert.ToInt32(SetValue(param, "RunMode", m_RunMode));
                //m_editMode = true;
            }
        }
        string SetValue(CyCompDevParam param, string param_name, object obj)
        {
