   ...
   public partial class CyCustomizer
    {
       public void GenerateHFile(ref Dictionary<string, string> paramDict)
       {
           ...
           paramDict.TryGetValue("INSTANCE_NAME", out m_instanceName);
           ...
           if (RunMode > 0)
           {
               #region Step
               writer.WriteLine("/*******************************************************************************");
               writer.WriteLine("* FUNCTION NAME:   " + m_instanceName + "_Step");
               writer.WriteLine("********************************************************************************");
               writer.WriteLine("* ");
               writer.WriteLine("* Summary:");
           ...
           if (PRSSize <= 8)    /* 8bit - PRS */
           {
               #region Read
               writer.WriteLine("/*******************************************************************************");
               writer.WriteLine("* FUNCTION NAME:   " + m_instanceName + "_Read");
               writer.WriteLine("********************************************************************************");
               writer.WriteLine("* ");
               writer.WriteLine("* Summary:");
               ...
               writer.WriteLine("* ");
               writer.WriteLine("* Return:");
               writer.WriteLine("*  Returns current PRS value.");
               writer.WriteLine("* ");
               writer.WriteLine("*******************************************************************************/");
               writer.WriteLine("uint8 " + m_instanceName + "_Read(void)");
               writer.WriteLine("{");
               ...
               writer.WriteLine("* ");
               writer.WriteLine("* Parameters:");
               writer.WriteLine("*  seed:  Seed register start value.");
               writer.WriteLine("* ");
               writer.WriteLine("* Return:");
               writer.WriteLine("*  void");
               writer.WriteLine("* ");
               ...
               writer.WriteLine("* ");
               writer.WriteLine("* Return:");
               writer.WriteLine("*  Returns PRS polynomial value");
               writer.WriteLine("* ");
               writer.WriteLine("*******************************************************************************/");
               writer.WriteLine("uint8 " + m_instanceName + "_ReadPolynomial(void)");
               writer.WriteLine("{");
               ...
               writer.WriteLine("* ");
               writer.WriteLine("* Parameters:");
               writer.WriteLine("*  polynomial: PRS polynomial");
               writer.WriteLine("* ");
               writer.WriteLine("* Return:");
               writer.WriteLine("*  void");
               writer.WriteLine("* ");
           ...
           else  /* 64bit - PRS */
           {
               #region ReadUpper
               writer.WriteLine("/*******************************************************************************");
               writer.WriteLine("* FUNCTION NAME:   " + m_instanceName + "_ReadUpper");
               writer.WriteLine("********************************************************************************");
               writer.WriteLine("* ");
               writer.WriteLine("* Summary:");
               ...
               writer.WriteLine("* ");
               writer.WriteLine("* Return:");
               writer.WriteLine("*  Returns current PRS Upper value");
               writer.WriteLine("* ");
               writer.WriteLine("*******************************************************************************/");
               writer.WriteLine("uint32 " + m_instanceName + "_ReadUpper(void)");
               writer.WriteLine("{");
               ...
               writer.WriteLine("* ");
               writer.WriteLine("* Return:");
               writer.WriteLine("*  Returns current PRS Lower value.");
               writer.WriteLine("* ");
               writer.WriteLine("*******************************************************************************/");
               writer.WriteLine("uint32 " + m_instanceName + "_ReadLower(void)");
               writer.WriteLine("{");
               ...
               writer.WriteLine("/*******************************************************************************");
               writer.WriteLine("* FUNCTION NAME:   " + m_instanceName + "_WriteSeedUpper");
               writer.WriteLine("********************************************************************************");
               writer.WriteLine("* ");
               writer.WriteLine("* Summary:");
               ...
               writer.WriteLine("* ");
               writer.WriteLine("* Parameters:");
               writer.WriteLine("*  seed: Seed Upper register start value");
               writer.WriteLine("* ");
               writer.WriteLine("* Return:");
               writer.WriteLine("*  void");
               writer.WriteLine("* ");
               ...
               else if (PRSSize <= 56)
               {
                   ...
                   writer.WriteLine("    " + m_instanceName + "_SEED_UPPER_C__A1_REG = HI8(seed);");
                   writer.WriteLine("    " + m_instanceName + "_SEED_UPPER_B__A1_REG = HI8(seed);");
               }
               else
               {
               ...
               writer.WriteLine("/*******************************************************************************");
               writer.WriteLine("* FUNCTION NAME:   " + m_instanceName + "_WriteSeedLower");
               writer.WriteLine("********************************************************************************");
               writer.WriteLine("* ");
               writer.WriteLine("* Summary:");
               ...
               writer.WriteLine("* ");
               writer.WriteLine("* Parameters:");
               writer.WriteLine("*  seed: Seed Lower register start value.");
               writer.WriteLine("* ");
               writer.WriteLine("* Return:");
               writer.WriteLine("*  void");
               writer.WriteLine("* ");
               ...
               if (PRSSize <= 40)
               {
                   ...
                   writer.WriteLine("    " + m_instanceName + "_SEED_LOWER_B__A0_REG = HI8(seed);");
               ...
               writer.WriteLine("* ");
               writer.WriteLine("* Return: ");
               writer.WriteLine("*  Returns PRS polynomial Upper value");
               writer.WriteLine("* ");
               writer.WriteLine("*******************************************************************************/");
               writer.WriteLine("uint32 " + m_instanceName + "_ReadPolynomialUpper(void)");
               writer.WriteLine("{");
               ...
               writer.WriteLine("/*******************************************************************************");
               writer.WriteLine("* FUNCTION NAME:   " + m_instanceName + "_ReadPolynomialLower");
               writer.WriteLine("********************************************************************************");
               writer.WriteLine("* ");
               writer.WriteLine("* Summary:");
               ...
               writer.WriteLine("* ");
               writer.WriteLine("* Return:");
               writer.WriteLine("*  Returns PRS polynomial Lower value");
               writer.WriteLine("* ");
               writer.WriteLine("*******************************************************************************/");
               writer.WriteLine("uint32 " + m_instanceName + "_ReadPolynomialLower(void)");
               writer.WriteLine("{");
               ...
               writer.WriteLine("/*******************************************************************************");
               writer.WriteLine("* FUNCTION NAME:   " + m_instanceName + "_WritePolynomialUpper");
               writer.WriteLine("********************************************************************************");
               writer.WriteLine("* ");
               writer.WriteLine("* Summary:");
               ...
               writer.WriteLine("* ");
               writer.WriteLine("* Parameters:");
               writer.WriteLine("*  polynomial: PRS polynomial Upper.");
               writer.WriteLine("* ");
               writer.WriteLine("* Return:");
               writer.WriteLine("*  void");
               writer.WriteLine("* ");
               ...
               else if (PRSSize <= 56)
               {
                   ...
                   writer.WriteLine("    " + m_instanceName + "_POLYNOM_UPPER_C__D1_REG = HI8(polynomial);");
                   writer.WriteLine("    " + m_instanceName + "_POLYNOM_UPPER_B__D1_REG = HI8(polynomial);");
               }
               else
               {
               ...
               writer.WriteLine("/*******************************************************************************");
               writer.WriteLine("* FUNCTION NAME:   " + m_instanceName + "_WritePolynomialLower");
               writer.WriteLine("********************************************************************************");
               writer.WriteLine("* ");
               writer.WriteLine("* Summary:");
               ...
               writer.WriteLine("* ");
               writer.WriteLine("* Parameters:");
               writer.WriteLine("*  polynomial: PRS polynomial Lower.");
               writer.WriteLine("* ");
               writer.WriteLine("* Return:");
               writer.WriteLine("*  void");
               writer.WriteLine("* ");
               ...
               if (PRSSize <= 40)
               {
                   ...
                   writer.WriteLine("    " + m_instanceName + "_POLYNOM_LOWER_B__D0_REG = HI8(polynomial);");
