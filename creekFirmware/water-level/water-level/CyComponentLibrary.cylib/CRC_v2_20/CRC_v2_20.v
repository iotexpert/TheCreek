...
`include "cypress.v"
`ifdef CRC_v2_20_V_ALREADY_INCLUDED
`else
`define CRC_v2_20_V_ALREADY_INCLUDED
...
(
    ...
    generate
        ...
        begin
            assign cs_addr = {reset, 1'b0, 1'b1};
            assign ci = cmsb ^ di;
            assign si = cmsb ^ di;
        end
        else
...
`endif      /* CRC_v2_20_V_ALREADY_INCLUDED */
