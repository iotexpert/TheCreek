...
namespace Counter_v2_10
    ...
    public partial class CyCounterControl : UserControl
    {
        ...
        public CyCounterControl(ICyInstEdit_v1 inst, ICyTerminalQuery_v1 termQuery, 
                                CyCounterControlAdv control_advanced)
        {
            m_component = inst;
        ...
        {        
            ...
            m_lblCalcMaxPeriod.Text = UpdateCalculatedPeriod(Convert.ToInt64(m_rbResolution8.Checked ? 
                                      Counter_v2_10.CounterParameters.CONST_2_8 : (m_rbResolution16.Checked ? 
                                      Counter_v2_10.CounterParameters.CONST_2_16 : (m_rbResolution24.Checked ? 
                                      Counter_v2_10.CounterParameters.CONST_2_24 : CounterParameters.CONST_2_32))),
        ...
        private void SetFixedFunction()
        {
            ...
            CounterParameters.SetAParameter(Counter_v2_10.CounterParameters.INTERRUPT_ON_CAPTURE, 
                                            Counter_v2_10.CounterParameters.FALSE, m_component);
        }
        ...
        private void m_numPeriod_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (!ce.Cancel)
            {
                ...
                if (m_cbClockMode.SelectedIndex == 2 || m_cbClockMode.SelectedIndex == 3)
                    ...
                    m_numCompare1.Maximum = Counter_v2_10.CounterParameters.CONST_2_8;
                else if (m_rbResolution16.Checked)
                    m_numCompare1.Maximum = Counter_v2_10.CounterParameters.CONST_2_16;
                else if (m_rbResolution24.Checked)
                    m_numCompare1.Maximum = Counter_v2_10.CounterParameters.CONST_2_24;
                else
                    m_numCompare1.Maximum= Counter_v2_10.CounterParameters.CONST_2_32;
                m_lblCalcFrequency.Text = UpdateCalculatedPeriod(Convert.ToInt64(m_numPeriod.Value), 
        ...
        private void m_rbResolution8_Click(object sender, MouseEventArgs e)
        {
            if (!m_rbResolution8.Checked)
            {
                ...
                CounterParameters.SetAParameter(Counter_v2_10.CounterParameters.RESOLUTION, 
                                                Counter_v2_10.CounterParameters.EIGHT_BIT, m_component);
            }
        ...
        private void m_rbResolution16_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution16.Checked)
            {
                ...
                m_lblCalcBitResolution.Text = UpdateCalculatedPeriod(Convert.ToInt64(1), 
                                                                     CounterParameters.BIT_RESOLUTION);
                CounterParameters.SetAParameter(Counter_v2_10.CounterParameters.RESOLUTION, 
                                                Counter_v2_10.CounterParameters.SIXTEEN_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        }
        ...
        private void m_rbResolution24_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution24.Checked)
            {
                ...
                m_lblCalcBitResolution.Text = UpdateCalculatedPeriod(Convert.ToInt64(1), 
                                                                     CounterParameters.BIT_RESOLUTION);
                CounterParameters.SetAParameter(Counter_v2_10.CounterParameters.RESOLUTION, 
                                                Counter_v2_10.CounterParameters.TWENTYFOUR_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        }
        ...
        private void m_rbResolution32_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution32.Checked)
            {
                ...
                m_lblCalcBitResolution.Text = UpdateCalculatedPeriod(Convert.ToInt64(1), 
                                                                     CounterParameters.BIT_RESOLUTION);
                CounterParameters.SetAParameter(Counter_v2_10.CounterParameters.RESOLUTION, 
                                                Counter_v2_10.CounterParameters.THIRTYTWO_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        ...
        {            
            if (!m_rbFixedFunction.Checked)
            {
                ...
                SetFixedFunction();
                CounterParameters.SetAParameter(Counter_v2_10.CounterParameters.FIXEDFUNCTION, 
                                                Counter_v2_10.CounterParameters.TRUE, m_component);
                UpdateAdvancedForm();
            }               
        }
        ...
        {
            if (m_rbResolution8.Checked)
                m_numPeriod.Value = Counter_v2_10.CounterParameters.CONST_2_8;
            else if (m_rbResolution16.Checked)
                m_numPeriod.Value = Counter_v2_10.CounterParameters.CONST_2_16;
            else if (m_rbResolution24.Checked)
                m_numPeriod.Value = Counter_v2_10.CounterParameters.CONST_2_24;
            else
                m_numPeriod.Value = Counter_v2_10.CounterParameters.CONST_2_32;
        }
        ...
        private void m_bMaxCompareValue_Click(object sender, EventArgs e)
        {
            ...
            {
                m_numCompare1.Maximum = Counter_v2_10.CounterParameters.CONST_2_8;
                m_numCompare1.Value = Counter_v2_10.CounterParameters.CONST_2_8;
            }
            else if (m_rbResolution16.Checked)
            {
                m_numCompare1.Maximum = Counter_v2_10.CounterParameters.CONST_2_16;
                m_numCompare1.Value = Counter_v2_10.CounterParameters.CONST_2_16;
            }
            else if (m_rbResolution24.Checked)
            {
                m_numCompare1.Maximum = Counter_v2_10.CounterParameters.CONST_2_24;
                m_numCompare1.Value = Counter_v2_10.CounterParameters.CONST_2_24;
            }
            else
            {
                m_numCompare1.Maximum = Counter_v2_10.CounterParameters.CONST_2_32;
                m_numCompare1.Value = Counter_v2_10.CounterParameters.CONST_2_32;
            }
        }
        ...
        private void m_numCompare1_Validating(object sender, CancelEventArgs e)
        {
            ...
            else
            {
                if (m_rbResolution8.Checked && ((m_numCompare1.Value < 0) || 
                   (m_numCompare1.Value > CounterParameters.CONST_2_8)))
                {
                    ...
                    e.Cancel = true;
                        ...
                        (m_numCompare1.Value > CounterParameters.CONST_2_16)))
                {
                    ep_Errors.SetError(m_numCompare1, string.Format("Compare Value must be between 0 and {0}", 
                                      CounterParameters.CONST_2_16));
                    e.Cancel = true;
                        ...
                        (m_numCompare1.Value > CounterParameters.CONST_2_24)))
                {
                    ep_Errors.SetError(m_numCompare1, string.Format("Compare Value must be between 0 and {0}", 
                                       CounterParameters.CONST_2_24));
                    e.Cancel = true;
