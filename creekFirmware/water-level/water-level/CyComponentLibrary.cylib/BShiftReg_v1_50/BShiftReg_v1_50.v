...
********************************************************************************/
`include "cypress.v"
`ifdef BShiftReg_v1_50_V_ALREADY_INCLUDED
`else
`define BShiftReg_v1_50_V_ALREADY_INCLUDED

module BShiftReg_v1_50 (
    ...
    ***************************************************************************/
    ...
    localparam dp8_cfg = {
        ...
        `SC_CMP0_NOCHN, /*SC_REG7 Comment: */
         3'h00, `SC_FIFO_SYNC__ADD, 6'h00,`SC_FIFO_CLK__DP,
         `SC_FIFO_CAP_FX,`SC_FIFO__EDGE,`SC_FIFO__SYNC,
         `SC_EXTCRC_DSBL,`SC_WRK16CAT_DSBL /*SC_REG8 Comment: */
    ...
    BShiftRegDp(
            /* input         */ .clk(clk_fin),                /* Component clock */
            /* input [02:00] */ .cs_addr({ctrl_clk_enable,final_load,reset}), /* Control Store RAM address */
            /* input         */ .route_si(shiftIn),         /* Shift in */
            /* input         */ .route_ci(1'b0),              
            /* input         */ .f0_load(1'b0),               
            /* input         */ .f1_load(store),      /* Load FIFO 1 */
            /* input         */ .d0_load(1'b0),               
            /* input         */ .d1_load(1'b0),               
            /* output        */ .ce0(),                      
            /* output        */ .cl0(),                      
    ...
    cy_psoc3_dp24 #(.cy_dpconfig_a(msb_dp_cfg), .cy_dpconfig_b(middle_dp_cfg), .cy_dpconfig_c(lsb_dp_cfg))
    BShiftRegDp(
            /* input          */ .clk(clk_fin),                           /* Component clock */
            /* input [02:00]  */ .cs_addr({ctrl_clk_enable, final_load, reset}), /* Control Store RAM address */
            /* input          */ .route_si(shiftIn),                    /* Shift in  */
...
`endif      /* BShiftReg_v1_50_V_ALREADY_INCLUDED */
