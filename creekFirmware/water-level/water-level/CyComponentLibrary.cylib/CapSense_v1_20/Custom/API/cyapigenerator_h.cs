...
namespace CapSense_v1_20.API
{
    public partial class CyAPIGenerator
    {
        ...
        public const string pa_DefineRegs = "DefineRegs";
        public const string pa_DefineTotal = "DefineTotal";
            ...
            CyGeneralParams packParams, ref Dictionary<string, string> paramDict)
        {
            ...
            foreach (CyAmuxBParams sbItem in packParams.m_localParams.m_listCsHalfs)
                if (packParams.m_localParams.IsAmuxBusEnable(sbItem))
                {
                    ...
                    {
                        writer.WriteLine("#include \"" + m_instanceName + "_" + Symbol + "_" + m_csIdac + ".h\"");
                    }
                    ...
                    writer.WriteLine("#define " + m_instanceName + "_TOTAL_GENERIC_SCANSLOT_COUNT" +
                        sSideUp + "\t" +
                        packParams.m_cyWidgetsList.GetWidgetsCount(E_SENSOR_TYPE.Generic, side));
                    ...
                    writer.WriteLine("#define " + m_instanceName + "_ISR_NUMBER" + sSideUp + "    " + m_instanceName + "_" + Symbol + "_" + m_csISR + "__INTC_NUMBER");
                    writer.WriteLine("#define " + m_instanceName + "_ISR_PRIORITY" + sSideUp + "    " + m_instanceName + "_" + Symbol + "_" + m_csISR + "__INTC_PRIOR_NUM");
                    writer.WriteLine("");
            ...
            if (packParams.Configuration != E_MAIN_CONFIG.emSerial)
            {
                ...
                writer.WriteLine("#define " + m_instanceName + "_TOTAL_GENERIC_SCANSLOT_COUNT" + "\t" + packParams.m_cyWidgetsList.GetWidgetsCount(E_SENSOR_TYPE.Generic));
            }
            ...
            writer.WriteLine("#define " + m_instanceName + "_CSHL_NUMBER_OF_DOUBLE_STRUCTS\t" + packParams.m_cyWidgetsList.GetDoubleFullWidgetsCount());
