    ...
    public partial class CyAPIGenerator
    {
        ...
        public void ApiCollectCVariables(ref CyMyStringWriter writer, CyGeneralParams packParams, CyAmuxBParams sbItem)
        {
            ...
            else
            {
                ...
                {
                    string str = m_instanceName + "_" + Symbol + "_" + m_csPort + "__" + packParams.m_cyWidgetsList.GetListTerminals(side)[i].ToString();
            ...
            if (sbItem.IsRbAvailible())
            {
                ...
                {
                    writer.Write("    (reg8 *) " + m_instanceName + "_" + Symbol + "_cRb" + i + "__" + packParams.GetAliasRbByIndex(sbItem, i) + "__PC");
        ...
        public void ApiCollectCFunctionForParallelMode(ref TextWriter writer, CyGeneralParams packParams)
        {
            //if (packParams.localParams.isParallel())
            {
                ...
                writer.WriteLine("*  Initializes registers for each module and starts the component. This ");
                writer.WriteLine("*  function calls functions automatically depending on modules selected ");
                writer.WriteLine("*  in the customizer. This function should be called prior to calling any ");
                writer.WriteLine("*  other component functions.");
                writer.WriteLine("* ");
                ...
                if (packParams.m_localParams.IsParallelFull())
                {
                    ...
                    writer.WriteLine("* ");
                    writer.WriteLine("* Summary:");
                    writer.WriteLine("*  Calls the function " + m_instanceName + "_" + MethodL + "_ScanSlot and");
                    writer.WriteLine("*  scans defined scan slot from Left side.");
                    writer.WriteLine("* ");
                    writer.WriteLine("* Parameters:");
                    ...
                    writer.WriteLine("* ");
                    writer.WriteLine("* Summary:");
                    writer.WriteLine("*  Calls the function " + m_instanceName + "_" + MethodR + "_ScanSlot and");
                    writer.WriteLine("*  scans defined scan slot from Right side.");
                    writer.WriteLine("* ");
                    writer.WriteLine("* Parameters:");
                    writer.WriteLine("*  slot:  Scan slot number");
                    writer.WriteLine("* ");
                ...
                else
                {
                    ...
                    foreach (CyAmuxBParams sbItem in packParams.m_localParams.m_listCsHalfs)
                        if (packParams.m_localParams.IsAmuxBusEnable(sbItem))
                        {
                            ...
                            writer.WriteLine("* ");
                            writer.WriteLine("* Summary:");
                            writer.WriteLine("*  Calls the function " + m_instanceName + "_" + Method + "_ScanSlot and");
                            writer.WriteLine("*  scans defined scan slot.");
                            writer.WriteLine("* ");
                            writer.WriteLine("* Parameters:");
                            writer.WriteLine("*  slot:  Scan slot number");
                            writer.WriteLine("* ");
                ...
                if (packParams.m_localParams.IsParallelFull())
                {
                    ...
                    foreach (CyAmuxBParams sbItem in packParams.m_localParams.m_listCsHalfs)
                    {
                        ...
                        if (sbItem.IsIdacAvailible() && (sbItem.m_Method == E_CAPSENSE_MODE.CSD))
                        {
                            ...
                            writer.WriteLine("/*******************************************************************************");
                            writer.WriteLine("* Function Name:   " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_SetValue" + sSide);
                            writer.WriteLine("********************************************************************************");
                            writer.WriteLine("* ");
                            writer.WriteLine("* Summary:");
                    ...
                    if (packParams.Configuration == E_MAIN_CONFIG.emParallelAsynchron)
                    {
                        ...
                        if (packParams.m_localParams.m_listCsHalfs[0].m_Method == E_CAPSENSE_MODE.CSD)
                        {
                            ...
                            if (packParams.m_localParams.m_listCsHalfs[0].m_csdSubMethod == E_CSD_SUB_METHODS.IDACSinking)
                            {
                                ...
                                writer.WriteLine("            " + m_instanceName + "_lb" + MethodL + "_" + m_csAmux + "_Connect(" + m_instanceName + "_IDAC_CHANNEL_LEFT);");
                                writer.WriteLine("            ");
                            }
                        ...
                        else
                        {
                            ...
                            writer.WriteLine("            " + m_instanceName + "_lb" + MethodL + "_" + m_csRawCnt + "_WriteCounter(0x0000u);");
                            writer.WriteLine("            ");
                            ...
                            writer.WriteLine("          " + m_instanceName + "_lb" + MethodL + "_" + m_csAmux + "_Disconnect(l);");
                            //writer.WriteLine("          " + m_instanceName + "_" + Symbol + "_" + m_csAmux + "_Disconnect(" + m_instanceName + "_IDAC_CHANNEL);");
                            writer.WriteLine("          " + m_instanceName + "_lb" + MethodL + "_" + m_csIdac + "_Stop();");
                            writer.WriteLine("          ");
                            ...
                            writer.WriteLine("            " + m_instanceName + "_statusLeft |= " + m_instanceName + "_START_CAPSENSING;");
                            writer.WriteLine("            ");
                            writer.WriteLine("            " + m_instanceName + "_lb" + MethodL + "_" + m_csIdac + "_SetRange(" + m_instanceName + "_IDAC_RANGE_32uA);");
                            writer.WriteLine("            " + m_instanceName + "_lb" + MethodL + "_" + m_csIdac + "_SetValue(idacSettings);");
                            writer.WriteLine("            ");
                            writer.WriteLine("            ");
                            //writer.WriteLine("          " + m_instanceName + "_" + Symbol + "_" + m_csAmux + "_Connect(" + m_instanceName + "_IDAC_CHANNEL);");
                            writer.WriteLine("          " + m_instanceName + "_lb" + MethodL + "_" + m_csIdac + "_Start();");
                            writer.WriteLine("            ");
                        ...
                        {
                            writer.WriteLine("            /* Set counter to zero */");
                            writer.WriteLine("            " + m_instanceName + "_rb" + MethodR + "_" + m_csRawCnt + "_WriteCounter(0x0000u);");
                            writer.WriteLine("            ");
                            ...
                            writer.WriteLine("          ");
                            writer.WriteLine("          /* Disconnect Idac and Sensor from AMUX */");
                            writer.WriteLine("          " + m_instanceName + "_rb" + MethodR + "_" + m_csAmux + "_Disconnect(r);");
                            //writer.WriteLine("          " + m_instanceName + "_rb" + MethodR + m_csAmux + "_Disconnect(" + m_instanceName + "_IDAC_CHANNEL);");
                            writer.WriteLine("          " + m_instanceName + "_rb" + MethodR + "_" + m_csIdac + "_Stop();");
                            writer.WriteLine("          ");
                            writer.WriteLine("            /* Disable Sensors */");
                            ...
                            writer.WriteLine("            " + m_instanceName + "_statusRight |= " + m_instanceName + "_START_CAPSENSING;");
                            writer.WriteLine("            ");
                            writer.WriteLine("            " + m_instanceName + "_rb" + MethodR + "_" + m_csIdac + "_SetRange(" + m_instanceName + "_IDAC_RANGE_32uA);");
                            writer.WriteLine("            " + m_instanceName + "_rb" + MethodR + "_" + m_csIdac + "_SetValue(idacSettings);");
                            writer.WriteLine("            ");
                            //writer.WriteLine("          " + m_instanceName + "_" + Symbol + "_" + m_csAmux + "_Connect(" + m_instanceName + "_IDAC_CHANNEL);");
                            writer.WriteLine("          " + m_instanceName + "_rb" + MethodR + "_" + m_csIdac + "_Start();");
                            writer.WriteLine("            ");
                            writer.WriteLine("            /* Start Counter */");
                            writer.WriteLine("            " + m_instanceName + "_CONTROL_RIGHT |= " + m_instanceName + "_START_CAPSENSING;");
                        }
                        ...
                        if (packParams.m_localParams.m_listCsHalfs[0].m_Method == E_CAPSENSE_MODE.CSD)
                        {
                            ...
                            if (packParams.m_localParams.m_listCsHalfs[0].IsIdacAvailible())
                            {
                                ...
                                writer.WriteLine("            " + m_instanceName + "_lb" + MethodL + "_" + m_csIdac + "_SetValueLeft(" + m_instanceName + "_TURN_OFF_IDAC);");
                                writer.WriteLine("            ");
                            }
                            if (packParams.m_localParams.m_listCsHalfs[0].m_csdSubMethod == E_CSD_SUB_METHODS.IDACSinking)
                            {
                        ...
                        else // CSA LEFT Scan Complete
                        {
                            ...
                            writer.WriteLine("            " + m_instanceName + "_SlotResult[rawIndex] = " + m_instanceName + "_lb" + MethodL + "_" + m_csRawCnt + "_ReadCapture();");
                            writer.WriteLine("            status = " + m_instanceName + "_lb" + MethodL + "_" + m_csRawCnt + "_ReadStatusRegister();");
                            writer.WriteLine("            ");
                            writer.WriteLine("            if ( status & " + m_instanceName + "_lb" + MethodL + "_" + m_csRawCnt + "_STATUS_UNDERFLOW)");
                            writer.WriteLine("            {");
                        ...
                        if (packParams.m_localParams.m_listCsHalfs[1].m_Method == E_CAPSENSE_MODE.CSD)
                        {
                            ...
                            {
                                writer.WriteLine("            /* Turn off IDAC */");
                                writer.WriteLine("            " + m_instanceName + "_rb" + MethodR + "_" + m_csIdac + "_SetValueRight(" + m_instanceName + "_TURN_OFF_IDAC);");
                                writer.WriteLine("            ");
                            }
                            if (packParams.m_localParams.m_listCsHalfs[1].m_csdSubMethod == E_CSD_SUB_METHODS.IDACSinking)
                            {
                        ...
                        else // CSA RIGHT Scan Complete
                        {
                            ...
                            writer.WriteLine("            ");
                            writer.WriteLine("            /* Read SlotResult from RawCnt */");
                            writer.WriteLine("            " + m_instanceName + "_SlotResult[rawIndex] = " + m_instanceName + "_rb" + MethodR + "_" + m_csRawCnt + "_ReadCapture();");
                            writer.WriteLine("            status = " + m_instanceName + "_rb" + MethodR + "_" + m_csRawCnt + "_ReadStatusRegister();");
                            writer.WriteLine("            ");
                            writer.WriteLine("            if ( status &" + m_instanceName + "_rb" + MethodR + "_" + m_csRawCnt + "_STATUS_UNDERFLOW)");
                            writer.WriteLine("            {");
                ...
                else
                {
                    ...
                    writer.WriteLine("* ");
                    writer.WriteLine("* Summary:");
                    writer.WriteLine("*  Scans all slots by calling " + m_instanceName + "_" + Method + "_ScanAllSlots");
                    writer.WriteLine("*   function for method selected in customizer.");
                    writer.WriteLine("* ");
                    writer.WriteLine("* Parameters:");
                    writer.WriteLine("*  void");
                    writer.WriteLine("* ");
        ...
        public void ApiCollectCFunctionForSide(ref TextWriter writer, CyGeneralParams packParams, CyAmuxBParams sbItem)
        {
            ...
            if (sbItem.IsIdacAvailible() && (sbItem.m_Method == E_CAPSENSE_MODE.CSD))
            {
                ...
                #region Trim
                writer.WriteLine("/*******************************************************************************");
                writer.WriteLine("* Function Name:   " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_DacTrim" + sSide);
                writer.WriteLine("********************************************************************************");
                writer.WriteLine("* ");
                writer.WriteLine("* Summary:");
                ...
                #region Idac_Start
                writer.WriteLine("/*******************************************************************************");
                writer.WriteLine("* Function Name:   " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_Start" + sSide);
                writer.WriteLine("********************************************************************************");
                writer.WriteLine("* ");
                writer.WriteLine("* Summary:");
                ...
                writer.WriteLine("        ");
                writer.WriteLine("        " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_SetValue" + sSide + "(" + m_instanceName + "_TURN_OFF_IDAC);");
                writer.WriteLine("        ");
                ...
                #region Idac_Stop
                writer.WriteLine("/*******************************************************************************");
                writer.WriteLine("* Function Name:   " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_Stop" + sSide);
                writer.WriteLine("********************************************************************************");
                writer.WriteLine("* ");
                writer.WriteLine("* Summary:");
                ...
                writer.WriteLine("/*******************************************************************************");
                writer.WriteLine("* Function Name:   " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_SetRange" + sSide);
                writer.WriteLine("********************************************************************************");
                writer.WriteLine("* ");
                writer.WriteLine("* Summary:");
            ...
            if (sbItem.IsRbAvailible())
            {
                #region InitRb
                writer.WriteLine("/******************************************************************************* ");
                writer.WriteLine("* Function Name:   " + m_instanceName + "_" + Method + "_InitRb" + sSide);
                writer.WriteLine("******************************************************************************** ");
                writer.WriteLine("* ");
                writer.WriteLine("* Summary:");
                ...
                writer.WriteLine("* ");
                writer.WriteLine("* Summary:");
                writer.WriteLine("*  Sets the pin to use for the bleed resistor (Rb) connection. The ");
                writer.WriteLine("*  function overwrites the component parameter setting. This ");
                writer.WriteLine("*  function is available only if Rb configuration is defined by the ");
                writer.WriteLine("*  CapSense customizer.");
                writer.WriteLine("* ");
                writer.WriteLine("* Parameters:");
                writer.WriteLine("*  rbleed: Ordering number for bleed resistor terminal defined ");
                writer.WriteLine("*  in CapSense customizer.");
                writer.WriteLine("* ");
                writer.WriteLine("* Return:");
                writer.WriteLine("*  void");
                writer.WriteLine("* ");
            ...
            {
                writer.WriteLine("/*******************************************************************************");
                writer.WriteLine("* Function Name:   " + m_instanceName + "_" + Method + "_Shield_Init" + sSide);
                writer.WriteLine("********************************************************************************");
                writer.WriteLine("* ");
                writer.WriteLine("* Summary:");
            ...
            if (sbItem.m_Method == E_CAPSENSE_MODE.CSA)
            {
                ...
                writer.WriteLine("    " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_SetRange(idacRange);");
                writer.WriteLine("    ");
                ...
                writer.WriteLine("        " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_SetValue(tempIdacSettings);");
                writer.WriteLine("        ");
                writer.WriteLine("        /* Disable csBuf */");
                ...
                writer.WriteLine("        if (" + m_instanceName + "_" + Symbol + "_" + m_csComp + "_WRK & " + m_instanceName + "_" + Symbol + "_" + m_csComp + "_CMP_OUT_MASK)");
                writer.WriteLine("        {");
            ...
            else /* CSA */
            {
                ...
                writer.WriteLine("    /* Setup " + Symbol + "_csRawCnt */");
                writer.WriteLine("    " + m_instanceName + "_" + Symbol + "_" + m_csRawCnt + "_Start();");
                writer.WriteLine("    " + m_instanceName + "_" + Symbol + "_" + m_csRawCnt + "_ReadStatusRegister();");
                writer.WriteLine("    ");
                writer.WriteLine("    /* Enable Comparator */");
                writer.WriteLine("    " + m_instanceName + "_" + Symbol + "_" + m_csComp + "_Start();");
                writer.WriteLine("    ");
                ...
                writer.WriteLine("    ");
                writer.WriteLine("    /* Start Idac */");
                writer.WriteLine("    " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_Start();");
                writer.WriteLine("    ");
                writer.WriteLine("    /* Connect Cmod, Cmp, Idac */");
                writer.WriteLine("    " + m_instanceName + "_" + Symbol + "_" + m_csAmux + "_Connect(" + m_instanceName + "_CMOD_CHANNEL" + sSideUp + ");");
                writer.WriteLine("    " + m_instanceName + "_" + Symbol + "_" + m_csAmux + "_Connect(" + m_instanceName + "_CMP_VP_CHANNEL" + sSideUp + ");");
            ...
            else
            {
                ...
                writer.WriteLine("    " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_Stop();");
                writer.WriteLine("    ");
                writer.WriteLine("    /* Disable csBuf */");
                writer.WriteLine("    " + m_instanceName + "_CAPS_CFG0" + sSideUp + " &= ~" + m_instanceName + "_CSBUF_ENABLE;");
                writer.WriteLine("    " + m_instanceName + "_CSBUF_PWRMGR" + sSideUp + " &= ~" + m_instanceName + "_CSBUF_PWR_ENABLE" + sSideUp + ";");
            ...
            writer.WriteLine("* ");
            writer.WriteLine("* Summary:");
            writer.WriteLine("*  Sets scan settings and scans the selected scan slot. Each ");
            writer.WriteLine("*  scan slot has a unique number within the slot array. This");
            writer.WriteLine("*  number is assigned by the CapSense customizer in sequence.");
            writer.WriteLine("* ");
            writer.WriteLine("* Parameters:");
            writer.WriteLine("*  slot:  Scan slot number");
            writer.WriteLine("* ");
            ...
            else  //CSA
            {
                ...
                writer.WriteLine("        ");
                writer.WriteLine("        /* Set counter to zero */");
                writer.WriteLine("        " + m_instanceName + "_" + Symbol + "_" + m_csRawCnt + "_WriteCounter(0x0000u);");
                writer.WriteLine("        ");
                ...
                writer.WriteLine("      ");
                writer.WriteLine("      /* Disconnect Idac and Sensor from AMUX */");
                writer.WriteLine("      " + m_instanceName + "_" + Symbol + "_" + m_csAmux + "_Disconnect(slot);");
                //writer.WriteLine("      " + m_instanceName + "_" + Symbol + "_" + m_csAmux + "_Disconnect(" + m_instanceName + "_IDAC_CHANNEL);");
                writer.WriteLine("      " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_Stop();");
                writer.WriteLine("      ");
                writer.WriteLine("        /* Disable Sensors */");
                ...
                writer.WriteLine("        " + m_instanceName + "_status" + sSide + " |= " + m_instanceName + "_START_CAPSENSING;");
                writer.WriteLine("        ");
                writer.WriteLine("        " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_SetRange(" + m_instanceName + "_IDAC_RANGE_32uA);");
                writer.WriteLine("        " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_SetValue(idacSettings);");
                writer.WriteLine("        ");
                writer.WriteLine("        ");
                //writer.WriteLine("      " + m_instanceName + "_" + Symbol + "_" + m_csAmux + "_Connect(" + m_instanceName + "_IDAC_CHANNEL);");
                writer.WriteLine("      " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_Start();");
                ...
                writer.WriteLine("        ");
                writer.WriteLine("        /* Read SlotResult from RawCnt */");
                writer.WriteLine("        " + m_instanceName + "_SlotResult[rawIndex] = " + m_instanceName + "_" + Symbol + "_" + m_csRawCnt + "_ReadCapture();");
                writer.WriteLine("        status = " + m_instanceName + "_" + Symbol + "_" + m_csRawCnt + "_ReadStatusRegister();");
                writer.WriteLine("        ");
                writer.WriteLine("        if ( status &" + m_instanceName + "_" + Symbol + "_" + m_csRawCnt + "_STATUS_UNDERFLOW)");
                writer.WriteLine("        {            ");
            ...
            writer.WriteLine("* ");
            writer.WriteLine("* Summary:");
            writer.WriteLine("*  Scans all scan slots by calling" + m_instanceName + "_" + Method + "_ScanSlot" + sSide);
            writer.WriteLine("*  for each slot index.");
            writer.WriteLine("* ");
            writer.WriteLine("* Parameters:");
            writer.WriteLine("*  void");
            writer.WriteLine("* ");
            ...
            writer.WriteLine("* ");
            writer.WriteLine("* Summary:");
            writer.WriteLine("*  Sets the scan settings of selected scan slot.. Each setting has");
            writer.WriteLine("*  a unique number within the settings array and is connected to ");
            writer.WriteLine("*  corresponding scan slot. This number is assigned by the ");
            ...
            if (sbItem.m_Method == E_CAPSENSE_MODE.CSD)
            {
                ...
                writer.WriteLine("    uint16 resolution = ((uint16) " + m_instanceName + "_SettingsTable" + sSide + "[slot].Resolution << " + m_instanceName + "_PWM_WINDOW_SHIFT) | " + m_instanceName + "_PWM_RESOLUTION_16_BITS;");
            ...
            {
                writer.WriteLine("    " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_SetRange(idacRange);");
                writer.WriteLine("    " + m_instanceName + "_" + Symbol + "_" + m_csIdac + "_SetValue(idacCode);");
            }
            ...
            writer.WriteLine("* ");
            writer.WriteLine("* Summary:");
            writer.WriteLine("*  Clears all slots to the non-sampling state by sequentially ");
            writer.WriteLine("*  disconnecting all slots from Analog MUX Bus, disable pin ");
            writer.WriteLine("*  global control and connecting them to GND or Shield electrode.");
            writer.WriteLine("* ");
            writer.WriteLine("* Parameters:");
            writer.WriteLine("*  void");
            writer.WriteLine("* ");
            ...
            writer.WriteLine("* ");
            writer.WriteLine("* Summary:");
            writer.WriteLine("*  Returns scan slot raw data from the SlotResult[] array. Each ");
            writer.WriteLine("*  scan slot has a unique number within the slot array. This ");
            writer.WriteLine("*  number is assigned by the CapSense customizer in sequence.");
            writer.WriteLine("* ");
            writer.WriteLine("* Parameters:");
            ...
            writer.WriteLine("* ");
            writer.WriteLine("* Summary:");
            writer.WriteLine("*  Configures the selected sensor to measure during the next ");
            writer.WriteLine("*  measurement cycle. The corresponding pins are set to Analog ");
            writer.WriteLine("*  High-Z mode and connected to the Analog Mux Bus. This ");
            writer.WriteLine("*  also enables the comparator function.");
            writer.WriteLine("* ");
            writer.WriteLine("* Parameters:");
            ...
            writer.WriteLine("* ");
            writer.WriteLine("* Summary:");
            writer.WriteLine("*  Disables the selected sensor. The corresponding pin is ");
            writer.WriteLine("*  disconnected from the Analog Mux Bus and connected to GND,");
            writer.WriteLine("*  High_Z or Shield electrode.");
            writer.WriteLine("* ");
            writer.WriteLine("* Parameters:");
            writer.WriteLine("*  sensor:  Sensor number");
