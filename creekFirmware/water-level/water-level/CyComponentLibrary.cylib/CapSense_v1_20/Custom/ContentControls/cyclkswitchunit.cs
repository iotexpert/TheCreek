                ...
                if (m_currentCSHalf != null)
                {
                    ...
                    if (busClk != null)
                    {
                        if (m_currentCSHalf.m_currectClk.m_ActualFreq > busClk.m_ActualFreq)
                        {
                            ...
                            CyCBConverter.CySetValue(cbCPS_CLK, busClk.ToString());
                ...
                switch (m_currentCSHalf.m_Prescaler)
                {
                    case E_PRESCALER.UDB:
                        pbGraph.Image = ((System.Drawing.Image)(
                            global:: CapSense_v1_20.Properties.Resources.ResourceManager.GetObject(strStart + "prescalerudb"
                            + strMethodPrefix)));
                        break;
                    case E_PRESCALER.HW:
                        pbGraph.Image = ((System.Drawing.Image)(
                            global:: CapSense_v1_20.Properties.Resources.ResourceManager.GetObject(strStart + "prescalerhw"
                        + strMethodPrefix)));
                        break;
                    case E_PRESCALER.None:
                        pbGraph.Image = ((System.Drawing.Image)(
                            global:: CapSense_v1_20.Properties.Resources.ResourceManager.GetObject(strStart + "prescalernone"
                        + strMethodPrefix)));
                        break;
                    default:
                        break;
