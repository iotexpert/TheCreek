        ...
        public uint GetFilterMask()
        {
            ...
            foreach (object obj in m_listObjects)
                if (typeof(CyHAFilterPropertiesRwDt) == obj.GetType())
                {
                    ...
                    {
                        case E_FO_FILTER.Prev0_5: Cybit_operat.AddBit(ref FilterConf, 2);
                            break;
                        case E_FO_FILTER.Prev0_75: Cybit_operat.AddBit(ref FilterConf, 3);
                            break;
                        default:
                            break;
                    }
                ...
                else if (typeof(CyHAFilterPropertiesPos) == obj.GetType())
                {
                    ...
                    if (filtObj.AveragingFilterPos == E_ENE_DIS.Enabled)
                        Cybit_operat.AddBit(ref FilterConf, 6);
                    switch (filtObj.FirstOrderIIRFilterPos)
                    {
                        case E_FO_FILTER.Prev0_5: Cybit_operat.AddBit(ref FilterConf, 7);
                            break;
                        case E_FO_FILTER.Prev0_75: Cybit_operat.AddBit(ref FilterConf, 8);
                            break;
                        default:
                            break;
                    }                        
                    if (filtObj.JitterFilterPos == E_ENE_DIS.Enabled)
                        Cybit_operat.AddBit(ref FilterConf, 9);
                }
