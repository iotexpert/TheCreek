...
*
* Summary: 
*  Starts the Boost component and puts the Boost into Active Mode. By default 
...
*
* Summary: 
*  Disables the Boost component and disables interrupts. Turns off power 
*  to the Boost logic.
*   
* Parameters:
*  None.
...
*  For standby mode, automatic thump mode is enabled. For Active mode automatic
*  thump mode is disabled.   
*
* Parameters:
