...
#define `$INSTANCE_NAME`_LO_DRIVE_TIME         `$LowDriveDutyCycleTime`
...
#define `$INSTANCE_NAME`_CNT_PERIOD                (* (reg8 *) `$INSTANCE_NAME`_bLCDDSD_dpCounter_2_u0__D0_REG)
...
#define `$INSTANCE_NAME`_EN_HI_ACT_VAL             (0xFFU - `$HiDriveTime`)

/* Defines compare value for DacDisable signal */
#define `$INSTANCE_NAME`_CNT_PERIOD_VAL            0x5FU	
#define `$INSTANCE_NAME`_CNT_DELAY_VAL             `$DacDisInitTime`
