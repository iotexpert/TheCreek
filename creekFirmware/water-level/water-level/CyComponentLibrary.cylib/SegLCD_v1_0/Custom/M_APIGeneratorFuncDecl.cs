...
namespace SegLCD_v1_0
{
    partial class M_APIGenerator
    {
        ...
        {
            //writer_h.WriteLine("#ifndef " + instanceName + "_7SEG");
            writer_h.WriteLine("#define " + instanceName + "_7SEG");
            writer_h.WriteLine("void " + instanceName + "_Write7SegDigit_" + index + "(uint8 Digit, uint8 Position);");

            writer.WriteLine("/*******************************************************************************");
            writer.WriteLine("* Function Name: " + instanceName + "_Write7SegDigit_" + index + "");
            writer.WriteLine("********************************************************************************");
            ...
            writer.WriteLine("void " + instanceName + "_Write7SegDigit_" + index + "(uint8 Digit, uint8 Position)");
            writer.WriteLine("{");
            ...
            writer.WriteLine("");
			writer.WriteLine("\tPosition = Position % " + instanceName + "_DigitNum_" + index + ";");
			writer.WriteLine("\tPosition = " + instanceName + "_DigitNum_" + index + " - Position - 1;");
            writer.WriteLine("\tfor (i = 0; i < 8; i++)");
            writer.WriteLine("\t{");
            writer.WriteLine("\t\tVal = ((" + instanceName + "_7SegDigits[Digit] >> i) & 0x01); ");
            writer.WriteLine("\t\t" + instanceName + "_WRITE_PIXEL(" + instanceName + "_Disp" + index + "[Position][i], Val);");
            writer.WriteLine("\t}");
            writer.WriteLine("}");
        }
        ...
        {
            writer_h.WriteLine("void " + instanceName + "_Write7SegNumber_" + index + "(uint16 Value, uint8 Position, uint8 Mode);");
            //writer_h.WriteLine("#endif /* " + instanceName + "_7SEG */");

            writer.WriteLine("/*******************************************************************************");
            writer.WriteLine("* Function Name: " + instanceName + "_Write7SegNumber_" + index + "");
            writer.WriteLine("********************************************************************************");
            writer.WriteLine("* Summary:");
            ...
            writer.WriteLine("*");
            writer.WriteLine("*******************************************************************************/");
            writer.WriteLine("void " + instanceName + "_Write7SegNumber_" + index + "(uint16 Value, uint8 Position, uint8 Mode)");
            writer.WriteLine("{ ");
            ...
            writer.WriteLine("\t{");
            writer.WriteLine("\t\tif (Mode == 0) " + instanceName + "_Write7SegDigit_" + index + "(0, Position);");
            writer.WriteLine("\t\telse");
            writer.WriteLine("\t\t{");
            writer.WriteLine("\t\t\tfor (i = (Position-1); i >= 0; i--) " + instanceName + "_Write7SegDigit_" + index + "(0,i); 	     ");
            writer.WriteLine("\t\t}");
            writer.WriteLine("\t}");
            writer.WriteLine("\telse");
            writer.WriteLine("\t{");
            writer.WriteLine("\t\tfor (i = Position; i < " + instanceName + "_DigitNum_" + index + "; i++)");
            writer.WriteLine("\t\t{");
            writer.WriteLine("\t\t\tNum = Value % 10;");
            writer.WriteLine("\t\t\t" + instanceName + "_Write7SegDigit_" + index + "(Num, i);");
        ...
        {
            //writer_h.WriteLine("#ifndef " + instanceName + "_14SEG");
            writer_h.WriteLine("#define " + instanceName + "_14SEG");
            writer_h.WriteLine("#define ALPHANUMERIC");
            writer_h.WriteLine("void " + instanceName + "_PutChar14Seg_" + index + "(uint8 Character, uint8 Position);");

            writer.WriteLine("/*******************************************************************************");
            writer.WriteLine("* Function Name: " + instanceName + "_PutChar14Seg_" + index + "");
            writer.WriteLine("********************************************************************************");
            writer.WriteLine("* Summary:");
            ...
            writer.WriteLine("*");
            writer.WriteLine("*******************************************************************************/");
            writer.WriteLine("void " + instanceName + "_PutChar14Seg_" + index + "(uint8 Character, uint8 Position)");
            writer.WriteLine("{");
            writer.WriteLine("\tuint8 i, Val;");
            writer.WriteLine("");
            writer.WriteLine("\tfor (i = 0; i < 14; i++)");
            writer.WriteLine("\t{");
            writer.WriteLine("\t\tVal = ((uint8)(" + instanceName + "_14SegChars[Character] >> i) & 0x01); ");
            writer.WriteLine("\t\t" + instanceName + "_WRITE_PIXEL(" + instanceName + "_Disp" + index + "[Position][i], Val);	 ");
            writer.WriteLine("\t}   ");
            writer.WriteLine("}");
        }
        ...
        {
            writer_h.WriteLine("void " + instanceName + "_WriteString14Seg_" + index + "(uint8* Character, uint8 Position);");
            //writer_h.WriteLine("#endif /* " + instanceName + "_14SEG */");

            writer.WriteLine("/*******************************************************************************");
            writer.WriteLine("* Function Name: " + instanceName + "_WriteString14Seg_" + index + "");
            writer.WriteLine("********************************************************************************");
            writer.WriteLine("* Summary:");
            ...
            writer.WriteLine("*");
            writer.WriteLine("*******************************************************************************/");
            writer.WriteLine("void " + instanceName + "_WriteString14Seg_" + index + "(uint8* Character, uint8 Position)");
            writer.WriteLine("{");
            writer.WriteLine("\tuint8 c, i;");
            writer.WriteLine("\ti = 0;");
            writer.WriteLine("");
            writer.WriteLine("\twhile ((Character[i] != 0) && ((Position + i) != " + instanceName + "_DigitNum_" + index + "))");
            writer.WriteLine("\t{");
            writer.WriteLine("\t\tc = Character[i];");
            writer.WriteLine("\t\t" + instanceName + "_PutChar14Seg_" + index + "(c, Position+i);");
            writer.WriteLine("\t\ti++;");
            writer.WriteLine("\t}");
            writer.WriteLine("}");
        }
        ...
        {
            //writer_h.WriteLine("#ifndef " + instanceName + "_16SEG");
            writer_h.WriteLine("#define " + instanceName + "_16SEG");
            writer_h.WriteLine("#define ALPHANUMERIC");
            writer_h.WriteLine("void " + instanceName + "_PutChar16Seg_" + index + "(uint8 Character, uint8 Position);");

            writer.WriteLine("/*******************************************************************************");
            writer.WriteLine("* Function Name: " + instanceName + "_PutChar16Seg_" + index + "");
            writer.WriteLine("********************************************************************************");
            writer.WriteLine("* Summary:");
            writer.WriteLine("*   This function displays an 8-bit char on an array of");
            writer.WriteLine("*   alphanumeric character displays. The user must have defined what");
            ...
            writer.WriteLine("*");
            writer.WriteLine("*******************************************************************************/");
            writer.WriteLine("void " + instanceName + "_PutChar16Seg_" + index + "(uint8 Character, uint8 Position)");
            writer.WriteLine("{");
            writer.WriteLine("\tuint8 i, Val;");
            writer.WriteLine("");
            writer.WriteLine("\tfor (i = 0; i < 16; i++)");
            writer.WriteLine("\t{");
            writer.WriteLine("\t\tVal = ((uint8)(" + instanceName + "_16SegChars[Character] >> i) & 0x01); ");
            writer.WriteLine("\t\t" + instanceName + "_WRITE_PIXEL(" + instanceName + "_Disp" + index + "[Position][i], Val); ");
            writer.WriteLine("\t}");
            writer.WriteLine("}");
        }
        ...
        {
            writer_h.WriteLine("void " + instanceName + "_WriteString16Seg_" + index + "(uint8* Character, uint8 Position);");
            //writer_h.WriteLine("#endif /* " + instanceName + "_16SEG */");

            writer.WriteLine("/*******************************************************************************");
            writer.WriteLine("* Function Name: " + instanceName + "_WriteString16Seg_" + index + "");
            writer.WriteLine("********************************************************************************");
            writer.WriteLine("* Summary:");
            writer.WriteLine("*   This function displays an 8-bit null terminated");
            writer.WriteLine("*   character string on an array of alphanumeric character displays.");
            ...
            writer.WriteLine("*");
            writer.WriteLine("*******************************************************************************/");
            writer.WriteLine("void " + instanceName + "_WriteString16Seg_" + index + "(uint8* Character, uint8 Position)");
            writer.WriteLine("{");
            writer.WriteLine("\tuint8 c, i;");
            writer.WriteLine("\ti = 0;");
            writer.WriteLine("");
            ...
            writer.WriteLine("\t{");
            writer.WriteLine("\t\tc = Character[i];");
            writer.WriteLine("\t\t" + instanceName + "_PutChar16Seg_" + index + "(c, Position+i);");
            writer.WriteLine("\t\ti++;");
            writer.WriteLine("\t}");
            writer.WriteLine("}");
        ...
        {
            //writer_h.WriteLine("#ifndef " + instanceName + "_DOT_MATRIX");
            writer_h.WriteLine("#define " + instanceName + "_DOT_MATRIX");
            writer_h.WriteLine("#define ALPHANUMERIC");
            writer_h.WriteLine("void " + instanceName + "_PutCharDotMatrix_" + index + "(uint8 Character, uint8 Position);");

            writer.WriteLine("/*******************************************************************************");
            writer.WriteLine("* Function Name: " + instanceName + "_PutCharDotMatrix_" + index + "");
            writer.WriteLine("********************************************************************************");
            writer.WriteLine("* Summary:");
            writer.WriteLine("*   This function displays an 8-bit char on an array of");
            writer.WriteLine("*   alphanumeric character displays. The user must have defined what");
            ...
            writer.WriteLine("*");
            writer.WriteLine("*******************************************************************************/");
            writer.WriteLine("void " + instanceName + "_PutCharDotMatrix_" + index + "(uint8 Character, uint8 Position)");
            writer.WriteLine("{");
            ...
            writer.WriteLine("\tfor (i = 0; i < 8; i++)");
            writer.WriteLine("\t{");
            writer.WriteLine("\t\tVal = ((" + instanceName + "_CharDotMatrix[Character][j] >> i) & 0x01); ");
            writer.WriteLine("\t\t" + instanceName + "_WRITE_PIXEL(" + instanceName + "_Disp" + index + "[Position][j+i*5], Val);");
            writer.WriteLine("\t}");
            writer.WriteLine("}");
        }
        void WriteStringDotMatrix_n(ref TextWriter writer, ref TextWriter writer_h, int index)
        {
            ...
            writer_h.WriteLine("void " + instanceName + "_WriteStringDotMatrix_" + index + "(uint8* Character, uint8 Position);");
            //writer_h.WriteLine("#endif /* " + instanceName + "_DOT_MATRIX */");

            writer.WriteLine("/* Function Name: " + instanceName + "_WriteStringDotMatrix_" + index + "");
            writer.WriteLine("********************************************************************************");
            writer.WriteLine("* Summary:");
            writer.WriteLine("*   This function displays an 8-bit null terminated");
            writer.WriteLine("*   character string on an array of alphanumeric character displays.");
            ...
            writer.WriteLine("*");
            writer.WriteLine("*******************************************************************************/");
            writer.WriteLine("void " + instanceName + "_WriteStringDotMatrix_" + index + "(uint8* Character, uint8 Position)");
            writer.WriteLine("{");
            ...
            writer.WriteLine("\t{");
            writer.WriteLine("\t\tc = Character[i];");
            writer.WriteLine("\t\t" + instanceName + "_PutCharDotMatrix_" + index + "(c, Position+i);");
            writer.WriteLine("\t\ti++;");
            writer.WriteLine("\t}");
            writer.WriteLine("}");
        }
        ...
        {
            writer_h.WriteLine("void " + instanceName + "_WriteBargraph_" + index + "(uint16 Location, uint8 Mode);");
            writer.WriteLine("");
            writer.WriteLine("");
            writer.WriteLine("/*******************************************************************************");
            writer.WriteLine("* Function Name: " + instanceName + "_WriteBargraph_" + index + "");
            writer.WriteLine("********************************************************************************");
            writer.WriteLine("* Summary:");
            ...
            writer.WriteLine("*");
            writer.WriteLine("*******************************************************************************/");
            writer.WriteLine("void " + instanceName + "_WriteBargraph_" + index + "(uint16 Location, uint8 Mode)");
            writer.WriteLine("{");
            ...
            writer.WriteLine("\t\t\t{");
            writer.WriteLine("\t\t\t" + instanceName + "_WRITE_PIXEL(" + instanceName + "_Disp" + index + "[i][0], 1);");
            writer.WriteLine("\t\t\t}");
            writer.WriteLine("\t\t\tbreak;");
            writer.WriteLine("\t\t\tcase 0:");
            writer.WriteLine("\t\t\t" + instanceName + "_WRITE_PIXEL(" + instanceName + "_Disp" + index + "[Location][0], 1);");
            writer.WriteLine("\t\t\tbreak;");
            writer.WriteLine("\t\t\tcase 1:");
            writer.WriteLine("\t\t\tfor (i = Location; i >= 0; i--) ");
            writer.WriteLine("\t\t\t{");
            writer.WriteLine("\t\t\t\t" + instanceName + "_WRITE_PIXEL(" + instanceName + "_Disp" + index + "[i][0], 1);");
            writer.WriteLine("\t\t\t}");
            writer.WriteLine("\t\t\tbreak;");
            ...
            writer.WriteLine("\t\t\tif (Location + 16 < MaxValue) ");
            writer.WriteLine("\t\t\t{");
            writer.WriteLine("\t\t\t\tMaxValue = Location + 16;");
            writer.WriteLine("\t\t\t}");
            writer.WriteLine("\t\t\tfor (i = Location; i < MaxValue; i++) ");
            writer.WriteLine("\t\t\t{");
            writer.WriteLine("\t\t\t\t" + instanceName + "_WRITE_PIXEL(" + instanceName + "_Disp" + index + "[i][0], 1);");
            ...
            writer.WriteLine("\t\t\tif (Location + 32 < MaxValue) ");
            writer.WriteLine("\t\t\t{");
            writer.WriteLine("\t\t\t\tMaxValue = Location + 32;");
            writer.WriteLine("\t\t\t}");
            writer.WriteLine("\t\t\tfor (i = Location; i < MaxValue; i++) ");
            writer.WriteLine("\t\t\t{");
            writer.WriteLine("\t\t\t\t" + instanceName + "_WRITE_PIXEL(" + instanceName + "_Disp" + index + "[i][0], 1);");
            ...
            writer.WriteLine("\t\t\tif (Location + 64 < MaxValue) ");
            writer.WriteLine("\t\t\t{");
            writer.WriteLine("\t\t\t\tMaxValue = Location + 64;");
            writer.WriteLine("\t\t\t}");
            writer.WriteLine("\t\t\tfor(i = Location;i < MaxValue; i++) ");
            writer.WriteLine("\t\t\t{");
            writer.WriteLine("\t\t\t\t" + instanceName + "_WRITE_PIXEL(" + instanceName + "_Disp" + index + "[i][0], 1);");
            ...
            writer.WriteLine("\t\t\tif (Location + 128 < MaxValue) ");
            writer.WriteLine("\t\t\t{");
            writer.WriteLine("\t\t\t\tMaxValue = Location + 128;");
            writer.WriteLine("\t\t\t}");
            writer.WriteLine("\t\t\tfor (i = Location; i < MaxValue; i++) ");
            writer.WriteLine("\t\t\t{");
            writer.WriteLine("\t\t\t\t" + instanceName + "_WRITE_PIXEL(" + instanceName + "_Disp" + index + "[i][0], 1);");
            ...
            writer.WriteLine("\t\t\tif (Location + 196 < MaxValue) ");
            writer.WriteLine("\t\t\t{");
            writer.WriteLine("\t\t\t\tMaxValue = Location + 196;");
            writer.WriteLine("\t\t\t}");
            writer.WriteLine("\t\t\tfor (i = Location; i < MaxValue; i++) ");
            writer.WriteLine("\t\t\t{");
            writer.WriteLine("\t\t\t\t" + instanceName + "_WRITE_PIXEL(" + instanceName + "_Disp" + index + "[i][0], 1);");
            ...
            writer.WriteLine("\t\t}");
            writer.WriteLine("\telse ");
            writer.WriteLine("\t\tfor (i = 0; i <= 255; i++) ");
            writer.WriteLine("\t\t{");
            writer.WriteLine("\t\t\t" + instanceName + "_WRITE_PIXEL(" + instanceName + "_Disp" + index + "[i][0], 0);");
            writer.WriteLine("\t\t}");
            writer.WriteLine("}");
        }
