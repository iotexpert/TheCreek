...
namespace Timer_v1_50
{
    class CyTimerParameters
    {
        ...
        public const string S_PIN_MESSAGE1 = "Please make sure that the 'enable' pin is not tied to logic high while enabling the Timer.";
		...
		static CyCustErr GetEnumParamValues(ICyInstQuery_v1 query, string paramName, out int value, out string displayName,
			out string idName)
		{
