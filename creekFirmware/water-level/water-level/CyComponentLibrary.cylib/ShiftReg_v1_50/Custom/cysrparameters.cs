...
namespace ShiftReg_v1_50
{
    ...
    public class CySRParameters
    {
        ...
        const string P_FIFO_SIZE = "FifoSize";
        ...
        public void GetParams(ICyInstEdit_v1 inst, CyCompDevParam param)
        {
            ...
            if (inst != null)
            {
                ...
                GetInt32(inst, P_FIFO_SIZE, param, ref m_FifoSize);
        ...
        public void SetParams(ICyInstEdit_v1 inst)
        {
            if (inst != null)
            {
                ...
                inst.SetParamExpr(P_FIFO_SIZE, m_FifoSize.ToString());
        ...
        public static void AssigneEventHandler(Control control, EventHandler handler)
        {
            for (int i = 0; i < control.Controls.Count; i++)
            {
                ...
                if ((cnt.GetType() == typeof(Panel)) || (cnt.GetType() == typeof(GroupBox)))
                    AssigneEventHandler(cnt, handler);
