...
namespace USBFS_v1_50
{
    ...
    public class CyACMixerUnitDescriptor : CyUSBDescriptor
    {
        ...
        public override void UpdateLength()
        {
            bLength = bLength = (byte)(10 + m_bmControls.Count + m_baSourceID.Count);  // 10 + p + n
        }
    ...
    public class CyACSelectorUnitDescriptor : CyUSBDescriptor
    {
        ...
        public override void UpdateLength()
        {
            bLength = bLength = bLength = (byte)(6 + m_baSourceID.Count);  // 6 + p
        }
    ...
    public class CyACFeatureUnitDescriptor : CyUSBDescriptor
    {
        ...
        private byte m_bUnitID;
        private byte m_bSourceID;
        private byte m_bControlSize;
        private List<byte> m_bmaControls;
        ...
        [Category(CyUSBOtherTypes.CATEGORY_SPECIFIC)]
        public List<byte> bmaControls
        {
            get { return m_bmaControls; }
            set
            {
                m_bmaControls = value;
                UpdateLength();
        ...
        public override void UpdateLength()
        {
            bLength = bLength = bLength = (byte)(7 + m_bControlSize * bmaControls.Count); // 7 + p*n
        }
    ...
    internal class CyInterfaceClassConverter : TypeConverter
    {
                                         ...
                                         Type destinationType)
        {
            ...
            {
                return ((byte)value == CyUSBFSParameters.CLASS_AUDIO) ? "AUDIO" : value.ToString();
            }
