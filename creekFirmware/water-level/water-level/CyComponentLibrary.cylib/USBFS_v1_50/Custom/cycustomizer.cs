...
namespace USBFS_v1_50
{
    ...
    {
        public const string PAPAM_TAB_NAME = "Basic";
        ...
        {  
            ...
            editor.AddCustomPage(Properties.Resources.PAGE_TITLE_DEVDESC,
                                 new CyDeviceDescriptorEditingControl(parameters), ParamCommitted, PAPAM_TAB_NAME);
            editor.AddCustomPage(Properties.Resources.PAGE_TITLE_STRDESC,
                                 new CyStringDescriptorEditingControl(parameters), ParamCommitted, PAPAM_TAB_NAME);
            editor.AddCustomPage(Properties.Resources.PAGE_TITLE_HIDDESC, new CyHIDDescriptorEditingControl(parameters),
                                 ParamCommitted, PAPAM_TAB_NAME);
            editor.AddCustomPage(Properties.Resources.PAGE_TITLE_AUDIODESC,
                                 new CyAudioDescriptorEditingControl(parameters), ParamCommitted, PAPAM_TAB_NAME);
            editor.AddCustomPage(Properties.Resources.PAGE_TITLE_ADV, new CyAdvancedEditingControl(parameters),
                                 ParamCommitted, PAPAM_TAB_NAME);
    ...
    public class CyDeviceDescriptorEditingControl : ICyParamEditingControl
    {
        ...
        public IEnumerable<CyCustErr> GetErrors()
        {
            ...
            errorList.AddRange(CyCustomizer.GetErrors(m_control.m_parameters.m_inst, CyCustomizer.PAPAM_TAB_NAME));
    ...
    public class CyStringDescriptorEditingControl : ICyParamEditingControl
    {
        ...
        public IEnumerable<CyCustErr> GetErrors()
        {
            ...
            return CyCustomizer.GetErrors(m_control.m_parameters.m_inst, CyCustomizer.PAPAM_TAB_NAME);
        }
