/*******************************************************************************
* File Name: bVoltageSequencer_v3_0.v
...
`include "cypress.v"
`ifdef bVoltageSequencer_v3_0_V_ALREADY_INCLUDED
`else
`define bVoltageSequencer_v3_0_V_ALREADY_INCLUDED

module bVoltageSequencer_v3_0 (
    ...
    ***************************************************************************/
    wire cflt_int;
    wire [6:1] ctl_in = ctl[6:1] ^ CtlPolarity[5:0];
    ...
    ***************************************************************************/
    wire ctlf = (NumCtlInputs > 3'd0) ? cflt_int : 1'b0;
