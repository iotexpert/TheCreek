...
namespace Counter_v2_20
    ...
    public partial class CyCounterControl : UserControl
    {
        ...
        private void SetFixedFunction()
        {
            ...
            string clockMode = m_component.GetCommittedParam(CounterParameters.CLOCKMODE).Value;
            ...
            string interruptOnCapture = m_component.GetCommittedParam(CounterParameters.INTERRUPT_ON_CAPTURE).Value;
            if (interruptOnCapture != CounterParameters.FALSE)
            {
                CounterParameters.SetAParameter(Counter_v2_20.CounterParameters.INTERRUPT_ON_CAPTURE,
                                                Counter_v2_20.CounterParameters.FALSE, m_component);
            }
        }
        ...
        private void m_numPeriod_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (!ce.Cancel)
            {
                ...
                if (m_cbClockMode.SelectedIndex == 2 || m_cbClockMode.SelectedIndex == 3)
                    ...
                    m_numCompare1.Maximum = Counter_v2_20.CounterParameters.CONST_2_8;
                else if (m_rbResolution16.Checked)
                    m_numCompare1.Maximum = Counter_v2_20.CounterParameters.CONST_2_16;
                else if (m_rbResolution24.Checked)
                    m_numCompare1.Maximum = Counter_v2_20.CounterParameters.CONST_2_24;
                else
                    m_numCompare1.Maximum= Counter_v2_20.CounterParameters.CONST_2_32;
            }
        }
        ...
        private void m_rbResolution8_Click(object sender, MouseEventArgs e)
        {
            if (!m_rbResolution8.Checked)
            {
                ...
                CounterParameters.SetAParameter(Counter_v2_20.CounterParameters.RESOLUTION, 
                                                Counter_v2_20.CounterParameters.EIGHT_BIT, m_component);
            }
        ...
        private void m_rbResolution16_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution16.Checked)
            {
                ...
                m_rbResolution32.Checked = false;
                CounterParameters.SetAParameter(Counter_v2_20.CounterParameters.RESOLUTION, 
                                                Counter_v2_20.CounterParameters.SIXTEEN_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        }
        ...
        private void m_rbResolution24_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution24.Checked)
            {
                ...
                m_rbResolution32.Checked = false;
                CounterParameters.SetAParameter(Counter_v2_20.CounterParameters.RESOLUTION, 
                                                Counter_v2_20.CounterParameters.TWENTYFOUR_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        }
        ...
        private void m_rbResolution32_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution32.Checked)
            {
                ...
                CounterParameters.SetAParameter(Counter_v2_20.CounterParameters.RESOLUTION, 
                                                Counter_v2_20.CounterParameters.THIRTYTWO_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        ...
        {            
            if (!m_rbFixedFunction.Checked)
            {
                ...
                SetFixedFunction();
                CounterParameters.SetAParameter(Counter_v2_20.CounterParameters.FIXEDFUNCTION, 
                                                Counter_v2_20.CounterParameters.TRUE, m_component);
                UpdateAdvancedForm();
            }               
        }
        ...
        {
            if (m_rbResolution8.Checked)
                m_numPeriod.Value = Counter_v2_20.CounterParameters.CONST_2_8;
            else if (m_rbResolution16.Checked)
                m_numPeriod.Value = Counter_v2_20.CounterParameters.CONST_2_16;
            else if (m_rbResolution24.Checked)
                m_numPeriod.Value = Counter_v2_20.CounterParameters.CONST_2_24;
            else
                m_numPeriod.Value = Counter_v2_20.CounterParameters.CONST_2_32;
        }
        ...
        private void m_bMaxCompareValue_Click(object sender, EventArgs e)
        {
            ...
            {
                m_numCompare1.Maximum = Counter_v2_20.CounterParameters.CONST_2_8;
                m_numCompare1.Value = Counter_v2_20.CounterParameters.CONST_2_8;
            }
            else if (m_rbResolution16.Checked)
            {
                m_numCompare1.Maximum = Counter_v2_20.CounterParameters.CONST_2_16;
                m_numCompare1.Value = Counter_v2_20.CounterParameters.CONST_2_16;
            }
            else if (m_rbResolution24.Checked)
            {
                m_numCompare1.Maximum = Counter_v2_20.CounterParameters.CONST_2_24;
                m_numCompare1.Value = Counter_v2_20.CounterParameters.CONST_2_24;
            }
            else
            {
                m_numCompare1.Maximum = Counter_v2_20.CounterParameters.CONST_2_32;
                m_numCompare1.Value = Counter_v2_20.CounterParameters.CONST_2_32;
            }
        }
