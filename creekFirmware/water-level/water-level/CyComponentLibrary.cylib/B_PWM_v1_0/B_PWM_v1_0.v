...
`include "cypress.v"
`ifdef B_PWM_V_v1_0_ALREADY_INCLUDED
`else
`define B_PWM_V_v1_0_ALREADY_INCLUDED
module B_PWM_v1_0 (
    ...
    if(UseStatus) begin : sSTSReg                                           
    	...
    	assign status[PWM_STS_CMP1] = cmp1;
    	assign status[PWM_STS_CMP2]	 = cmp2;
...
`endif /* B_PWM_V_v1_0_ALREADY_INCLUDED */
