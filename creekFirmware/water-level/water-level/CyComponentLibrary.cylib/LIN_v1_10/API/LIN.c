...
void    `$INSTANCE_NAME`_EndFrame(l_u8) `=ReentrantKeil($INSTANCE_NAME . "_EndFrame")`;
void    `$INSTANCE_NAME`_ProcessStatusFlags(l_u8) `=ReentrantKeil($INSTANCE_NAME . "_ProcessStatusFlags")`;
void    `$INSTANCE_NAME`_SetAssociatedFlags(l_u8) `=ReentrantKeil($INSTANCE_NAME . "_SetAssociatedFlags")`;
l_bool  `$INSTANCE_NAME`_GetEtFlagValue(l_u8) `=ReentrantKeil($INSTANCE_NAME . "_GetEtFlagValue")`;
void    `$INSTANCE_NAME`_ClearEtFlagValue(l_u8) `=ReentrantKeil($INSTANCE_NAME . "_ClearEtFlagValue")`;

#if(1u == `$INSTANCE_NAME`_TL_ENABLED)

    void    `$INSTANCE_NAME`_ProcessMrf(volatile l_u8*) `=ReentrantKeil($INSTANCE_NAME . "_ProcessMrf")`;

    #if(1u == `$INSTANCE_NAME`_CS_ENABLED)

        l_bool `$INSTANCE_NAME`_LinProductId(volatile l_u8*) `=ReentrantKeil($INSTANCE_NAME . "_LinProductId")`;

        #if(1u == `$INSTANCE_NAME`_LIN_2_0)

            l_u8 `$INSTANCE_NAME`_MessageId(volatile l_u8*) `=ReentrantKeil($INSTANCE_NAME . "_MessageId")`;
...
*
*******************************************************************************/
l_bool l_ifc_init(l_ifc_handle iii) `=ReentrantKeil("l_sys_init")`
{
    l_bool returnValue;
...
*
*******************************************************************************/
l_u16 l_ifc_ioctl(l_ifc_handle iii, l_ioctl_op op, void* pv) `=ReentrantKeil("l_ifc_ioctl")`
{
    l_u16 returnValue;
                            ...
                            if(`$INSTANCE_NAME`_FRAME_PID_MRF_J2602 == `$INSTANCE_NAME`_framePid)
                            {
                                ...
                                if(0u == (`$INSTANCE_NAME`_fsmFlags & `$INSTANCE_NAME`_FSM_FRAMING_ERROR_FLAG))
                                {
                                    ...
                                    `$INSTANCE_NAME`_ifcStatus =
                                        ((`$INSTANCE_NAME`_ifcStatus & ~`$INSTANCE_NAME`_IFC_STS_PID_MASK) |
...
*
*******************************************************************************/
void l_ifc_rx(l_ifc_handle iii) `=ReentrantKeil("l_ifc_rx")`
{
    switch(iii)
    {
        case `$INSTANCE_NAME`_IFC_HANDLE:
...
*
*******************************************************************************/
void l_ifc_tx(l_ifc_handle iii) `=ReentrantKeil("l_ifc_tx")`
{
    switch(iii)
    {
        case `$INSTANCE_NAME`_IFC_HANDLE:
...
*
*******************************************************************************/
void l_ifc_aux(l_ifc_handle iii) `=ReentrantKeil("l_ifc_aux")`
{
    switch(iii)
    {
        case `$INSTANCE_NAME`_IFC_HANDLE:
...
*
*******************************************************************************/
l_u16 l_ifc_read_status(l_ifc_handle iii) `=ReentrantKeil("l_ifc_read_status")`
{
    l_u16 returnValue;
...
*
*******************************************************************************/
void `$INSTANCE_NAME`_EndFrame(l_u8 status) `=ReentrantKeil($INSTANCE_NAME . "_EndFrame")`
{
...
`$clearEtFlagValue`
    ...
    *
    *******************************************************************************/
    void ld_init(l_ifc_handle iii) `=ReentrantKeil("ld_init")`
    {
        l_u8 interruptState;
    ...
    *
    *******************************************************************************/
    l_u8 ld_read_configuration(l_ifc_handle iii, l_u8* pData, l_u8* length) `=ReentrantKeil("ld_read_configuration")`
    {
        l_u8 i;
    ...
    *
    *******************************************************************************/
    l_u8 ld_set_configuration(l_ifc_handle iii, l_u8* pData, l_u16 length) `=ReentrantKeil("ld_set_configuration")`
    {
        l_u8 i;
        ...
        *******************************************************************************/
                        ...
                        `=ReentrantKeil($INSTANCE_NAME . "_LinProductId")`
        {
            ...
            *
            *******************************************************************************/
            l_u8 `$INSTANCE_NAME`_MessageId(volatile l_u8* frameData) `=ReentrantKeil($INSTANCE_NAME . "_MessageId")`
            {
                l_u8 i = 0u;
            ...
            *******************************************************************************/
            l_u8 ld_read_by_id_callout(l_ifc_handle iii, l_u8 id, volatile l_u8* frameData)
                                                        `=ReentrantKeil("ld_read_by_id_callout")`
            {
    ...
    *
    *******************************************************************************/
    void `$INSTANCE_NAME`_ProcessMrf(volatile l_u8* frame) `=ReentrantKeil($INSTANCE_NAME . "_ProcessMrf")`
    {
        l_u8 i;
        l_u8 tempStatus = 0u;
        ...
        *
        *******************************************************************************/
        uint8 ld_tx_status(l_ifc_handle iii) `=ReentrantKeil("ld_tx_status")`
        {
            /* To remove unreferenced local variable warning */
            iii = iii;
        ...
        *
        *******************************************************************************/
        l_u8 ld_rx_status(l_ifc_handle iii) `=ReentrantKeil("ld_rx_status")`
        {
            /* To remove unreferenced local variable warning */
            iii = iii;
        ...
        *
        *******************************************************************************/
        void ld_put_raw(l_ifc_handle iii, const l_u8* const ld_data) `=ReentrantKeil("ld_put_raw")`
        {
            l_u8 interruptState;
            l_u8 i;
        ...
        *
        *******************************************************************************/
        void ld_get_raw(l_ifc_handle iii, l_u8* const ld_data) `=ReentrantKeil("ld_get_raw")`
        {
            l_u8 interruptState;
            l_u8 i;
        ...
        *
        *******************************************************************************/
        l_u8 ld_raw_tx_status(l_ifc_handle iii) `=ReentrantKeil("ld_raw_tx_status")`
        {
            /* To remove unreferenced local variable warning */
            iii = iii;
        ...
        *
        *******************************************************************************/
        l_u8 ld_raw_rx_status(l_ifc_handle iii) `=ReentrantKeil("ld_raw_rx_status")`
        {
            /* To remove unreferenced local variable warning */
            iii = iii;
