...
#if(CY_PSOC5LP)
    #define `$INSTANCE_NAME`_WAKEUP_ISR_NUMBER         (`$INSTANCE_NAME`_Wakeup__INTC_NUMBER)
    #define `$INSTANCE_NAME`_WAKEUP_ISR_PRIORITY       (`$INSTANCE_NAME`_Wakeup__INTC_PRIOR_NUM)
#endif /* CY_PSOC5LP */
