...
namespace QuadDec_v1_10
{
    ...
    {    
        ...
        private void SetCheckboxes(byte bit)
        {
            switch(bit)
            {
                case (8):
                    {
                        bit8RB.Checked = true;
                        bit16RB.Checked = false;
                        bit32RB.Checked = false;
                        break;
                    }
                case(16):
                    {
                        bit8RB.Checked = false;
                        bit16RB.Checked = true;
                        bit32RB.Checked = false;
                        break;
                    }
                case(32):
