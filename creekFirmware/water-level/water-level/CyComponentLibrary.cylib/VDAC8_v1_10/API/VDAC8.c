...
// 	uint8 trimValue;
//	
//	if(range == `$INSTANCE_NAME`_RANGE_1V)
//	{
//		trimValue = CY_GET_XTND_REG8(`$INSTANCE_NAME`_DAC_TRIM_BASE + `$INSTANCE_NAME`_TRIM_M7_1V_RNG_OFFSET);
//	}
//	else
//	{
//		trimValue = CY_GET_XTND_REG8(`$INSTANCE_NAME`_DAC_TRIM_BASE + `$INSTANCE_NAME`_TRIM_M8_4V_RNG_OFFSET);
//	}
//   `$INSTANCE_NAME`_TR = trimValue;
//   
    uint8 mode;
