...
#define `$INSTANCE_NAME`_StopBits                       `$StopBitsCount`


/* Use Any Enumerated Types */
`#cy_declare_enum B_UART__AddressModes`

`#cy_declare_enum B_UART__Parity Type`
...
#define `$INSTANCE_NAME`_NUMBER_OF_STOP_BITS            `$StopBitsCount`
...
******     Registers                            *****
****************************************************/
#define `$INSTANCE_NAME`_CONTROL                        (* (reg8 *) `$INSTANCE_NAME`_BUART_ctrl__CONTROL_REG )
#if(`$INSTANCE_NAME`_TX_Enabled)
    ...
    #define `$INSTANCE_NAME`_TXBITCTR_PERIOD            (* (reg8 *) `$INSTANCE_NAME`_BUART_sTX_TXBitCounter__PERIOD_REG )
    #define `$INSTANCE_NAME`_TXBITCTR_PERIOD_PTR        ((reg8 *) `$INSTANCE_NAME`_BUART_sTX_TXBitCounter__PERIOD_REG )    
    #define `$INSTANCE_NAME`_TXBITCTR_CONTROL           (* (reg8 *) `$INSTANCE_NAME`_BUART_sTX_TXBitCounter__CONTROL_AUX_CTL_REG )
    #define `$INSTANCE_NAME`_TXBITCTR_CONTROL_PTR       ((reg8 *) `$INSTANCE_NAME`_BUART_sTX_TXBitCounter__CONTROL_AUX_CTL_REG )
    #define `$INSTANCE_NAME`_TXBITCTR_COUNTER           (* (reg8 *) `$INSTANCE_NAME`_BUART_sTX_TXBitCounter__COUNT_REG )
    #define `$INSTANCE_NAME`_TXBITCTR_COUNTER_PTR       ((reg8 *) `$INSTANCE_NAME`_BUART_sTX_TXBitCounter__COUNT_REG )
