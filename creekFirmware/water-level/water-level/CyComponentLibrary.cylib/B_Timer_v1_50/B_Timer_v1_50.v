/*******************************************************************************
*  FILENAME:  B_Timer_v1_50.v   
*  UM Name:   B_Timer_v1_50
* 
*  DESCRIPTION:
...
`include "cypress.v"
`ifdef B_TIMER_V_v1_50_ALREADY_INCLUDED
`else
`define B_TIMER_V_v1_50_ALREADY_INCLUDED
module B_Timer_v1_50 (
    ...
    ***************************************************************************/
    ...
    generate 
    if(EnableMode != TIMER_ENMODE_HWONLY || CaptureMode == TIMER_CAP_MODE_SW || TriggerMode == TIMER_TRIG_MODE_SW) begin: sCTRLReg
    ...
    ***************************************************************************/
    ...
    if(RunMode == TIMER_RUNMODE_CONTINUOUS) begin
        ...
        always @(posedge clock) begin
            ...
            else if(runmode_enable & trigger_enable & tc) begin
                runmode_enable = 1'b0;
                trig_disable = 1'b1;
            end
     ...
     reg     runmode_enable;
        ...
        always @(posedge clock) begin
            ...
            else if(runmode_enable & trigger_enable & (tc | interrupt)) begin
                runmode_enable = 1'b0;
                trig_disable = 1'b1;
            end
            else if(trigger_enable & !trig_disable & hwEnable)
    ...
    ***************************************************************************/
    generate 
        if(TriggerMode != TIMER_TRIG_MODE_NONE) begin : sTMEN
            ...
            assign trigger_polarized =  (ctrl_tmode == TIMER_TRIG_MODE_NONE) ? 1'b0 : 
...
`endif /* B_TIMER_V_v1_50_ALREADY_INCLUDED */
