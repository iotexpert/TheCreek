...
namespace USBFS_v2_10
{
    public partial class CyUSBFSParameters
    {
        ...
        public void DeserializeDescriptors()
        {
            ...
            if (!string.IsNullOrEmpty(m_serializedDeviceDesc))
            {
                ...
                catch
                {
                    ...
                    InitDescriptors(true, false, false, false, false);
                }
            }
            else
            {
            ...
            if (!string.IsNullOrEmpty(m_serializedStringDesc))
            {
                ...
                catch
                {
                    MessageBox.Show(String.Format(Properties.Resources.MSG_WRONG_PARAMETER, PARAM_STRINGDESCRIPTORS),
                                    MSG_TITLE_ERROR, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    InitDescriptors(false, true, false, false, false);
                }
            }
            else
            {
            ...
            if (!string.IsNullOrEmpty(m_serializedHIDReportDesc))
            {
                ...
                catch
                {
                    MessageBox.Show(String.Format(Properties.Resources.MSG_WRONG_PARAMETER, PARAM_HIDREPORTDESCRIPTORS),
                                    MSG_TITLE_ERROR, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    InitDescriptors(false, false, true, false, false);
                }
            }
            else
            {
            ...
            if (!string.IsNullOrEmpty(m_serializedAudioDesc))
            {
                ...
                catch
                {
                    MessageBox.Show(String.Format(Properties.Resources.MSG_WRONG_PARAMETER, PARAM_AUDIODESCRIPTORS),
                                    MSG_TITLE_ERROR, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    InitDescriptors(false, false, false, true, false);
                }
            }
            else
            {
            ...
            if (!string.IsNullOrEmpty(m_serializedCDCDesc))
            {
                ...
                catch
                {
                    MessageBox.Show(String.Format(Properties.Resources.MSG_WRONG_PARAMETER, PARAM_CDCDESCRIPTORS),
                                    MSG_TITLE_ERROR, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    InitDescriptors(false, false, false, false, true);
                }
            }
            else
            {
            ...
            // Check if Device tree has audio or cdc interfaces and if so, merge them with audio or cdc interfaces to 
            // make one object
        ...
        public void InitDescriptors(bool device, bool str, bool hidReport, bool audio, bool cdc)
        {
            if (device)
            {
                if (m_deviceTree.m_nodes.Count > 0)
        ...
        {
            const int PSOC3_ES3 = 2;
            const int PSOC5_ES2 = 2;
            bool res = true;
            bool supportDMA = false;
            if (deviceQuery.IsPSoC3 && deviceQuery.SiliconRevision >= PSOC3_ES3)
                supportDMA = true;
            if (deviceQuery.IsPSoC5 && deviceQuery.SiliconRevision >= PSOC5_ES2)
                supportDMA = true;
        ...
        {
            // "USBFS_v2_10" should be replaced with other version after upgrade 
            DirectoryInfo di = new DirectoryInfo(
                    "..\\psoc\\content\\cycomponentlibrary\\CyComponentLibrary.cylib\\USBFS_v2_10\\Custom\\template");
            return di.FullName;
        }
