        ...
        switch (CY_GET_REG8(`$INSTANCE_NAME`_bRequest))
        {
            ...
            case `$INSTANCE_NAME`_HID_SET_IDLE:
                ...
                {    
                    ...
                    /* With regards to HID spec: "7.2.4 Set_Idle Request" Latency.
                    ...
                    */
                    ...
                    /* If the new request is received within 4 milliseconds(1 count) of the end of the current 
                    *  period, then the new request will have no effect until after the report.
                    */
                    else if(`$INSTANCE_NAME`_hidIdleTimer[interfaceNumber] <= 1u)
                    {
                        /* Do nothing. 
                        * Let the UpdateHIDTimer() API continue to work and return IDLE_TIMER_EXPIRED status
                        */
                    }
                    else
                    {   /* Reload the timer*/
