    ...
    partial class CyCustomizer : ICyAPICustomize_v1
    {
            ...
            IEnumerable<CyAPICustomizer> apis)
        {
            ...
            string conversionRoutinePrototypes =
                ...
                "void " + instanceName + "_PrintInt8(uint8 value);      " + Environment.NewLine +
                "void " + instanceName + "_PrintInt16(uint16 value);    " + Environment.NewLine +
                "void " + instanceName + "_PrintNumber(uint16 value);   " + Environment.NewLine;
...
/*******************************************************************************
*  Function Name: " + instanceName + @"_PrintInt8
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void " + instanceName + @"_PrintInt8(uint8 value)
{
...
/*******************************************************************************
*  Function Name: " + instanceName + @"_PrintInt16
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void " + instanceName + @"_PrintInt16(uint16 value)
{
    " + instanceName + @"_PrintInt8(value >> 8);
    " + instanceName + @"_PrintInt8(value & 0xFF);
}


/*******************************************************************************
*  Function Name: " + instanceName + @"_PrintNumber
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void " + instanceName + @"_PrintNumber(uint16 value)
{
