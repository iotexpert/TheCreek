...
using CyCustomizer.CharLCD_v0_2;
using CyCustomCharacterArray;
...
namespace CyCustomizer.CharLCD_v0_2
{
    public partial class CyCharLCDControl : UserControl
    {
        ...
        {
            CyCustomCharacterArray.CustomCharacter current = (CyCustomCharacterArray.CustomCharacter)sender;
            CyCustomCharacterArray.Box clickedBox = current.GetBoxByLocation(e.X, e.Y);
            if (clickedBox != null)
            {
        ...
        private void custArray_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                CyCustomCharacterArray.CustomCharacter current = (CyCustomCharacterArray.CustomCharacter)sender;
                CyCustomCharacterArray.Box currentBox = current.GetBoxByLocation(e.X, e.Y);
                if (currentBox != null)
                {
        ...
        {
            CyCustomCharacterArray.CustomCharacter selectedCharacter = (CyCustomCharacterArray.CustomCharacter)sender;
        ...
        public void CYStringToCharacter(CustomCharacter customCharacter, string cyCharacterString)
        {
            ...
            CyCustomCharacterArray.Box[,] boxes = customCharacter.GetBoxArray();
        ...
        public string CharacterToCYString(CustomCharacter customCharacter)
        {
            ...
            CyCustomCharacterArray.Box[,] pixelArray = customCharacter.GetBoxArray();
        ...
        CyCustomCharacterArray.CustomCharacter highlighted;
        ...
        private void HighlightNext()
        {
            ...
            UpdateHighlighted((CyCustomCharacterArray.CustomCharacter)userDefinedCharacters[next]);
        }
        ...
        private void HighlightPrevious()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CyCustomCharacterArray.CustomCharacter)userDefinedCharacters[previous]);
        }
        ...
        private void HighlightAbove()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CyCustomCharacterArray.CustomCharacter)userDefinedCharacters[above]);
        }
        private void HighlightBelow()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CyCustomCharacterArray.CustomCharacter)userDefinedCharacters[below]);
        }

        private void UpdateHighlighted(CyCustomCharacterArray.CustomCharacter selectedCharacter)
        {
        ...
        {
            highlighted.Selected = false;
            foreach (CyCustomCharacterArray.CustomCharacter character in this.panel1.Controls)
            {
