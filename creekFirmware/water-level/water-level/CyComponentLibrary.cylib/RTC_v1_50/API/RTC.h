...
#if (1u == `$INSTANCE_NAME`_DST_FUNC_ENABLE)
    extern uint8                    `$INSTANCE_NAME`_dstModeType;
    extern `$INSTANCE_NAME`_DSTIME  `$INSTANCE_NAME`_dstTimeDateStart;
    extern `$INSTANCE_NAME`_DSTIME  `$INSTANCE_NAME`_dstTimeDateStop;
    extern uint8                    `$INSTANCE_NAME`_dstOffsetMin;
    extern uint8                    `$INSTANCE_NAME`_dstStartStatus;
    extern uint8                    `$INSTANCE_NAME`_dstStopStatus;
#endif /* 1u == `$INSTANCE_NAME`_DST_FUNC_ENABLE */

extern uint8            `$INSTANCE_NAME`_alarmCfgMask;
extern uint8            `$INSTANCE_NAME`_alarmCurStatus;
extern uint8            `$INSTANCE_NAME`_intervalCfgMask;
extern uint8            `$INSTANCE_NAME`_statusDateTime;
