...
#define `$INSTANCE_NAME`_ANALOG_BUS             (`$AnalogBus`u)

#define `$INSTANCE_NAME`_ENABLE_OV_DETECT   ((`$INSTANCE_NAME`_CompareType == `$INSTANCE_NAME`_OV_UV) || \
                                             (`$INSTANCE_NAME`_CompareType == `$INSTANCE_NAME`_OV_ONLY))
#define `$INSTANCE_NAME`_ENABLE_UV_DETECT   ((`$INSTANCE_NAME`_CompareType == `$INSTANCE_NAME`_OV_UV) || \
                                             (`$INSTANCE_NAME`_CompareType == `$INSTANCE_NAME`_UV_ONLY))

/* Analog routing constraints for comparator inputs */
`#declare_enum AnalogBusType`
/* AMUX DMA Control Enable */
#define `$INSTANCE_NAME`_ENABLE_AMUX_DMA    ((`$INSTANCE_NAME`_NUMBER_OF_VOLTAGES > 1u) && \
                                             (`$INSTANCE_NAME`_ANALOG_BUS != `$INSTANCE_NAME`__UNCONSTRAINED))
#if(`$INSTANCE_NAME`_ENABLE_AMUX_DMA)
    /* DMA control of AMux channel connections */
    #define `$INSTANCE_NAME`_AMUX_NUM_TDS       (5u)
    #include "`$INSTANCE_NAME`_AMUX_CTRL_dma.h" 
    #include "`$INSTANCE_NAME`_AMUX_CH_PREV_dma.h"
    #include "`$INSTANCE_NAME`_AMUX_CH_NEXT_dma.h"
    #include "`$INSTANCE_NAME`_AMUX_CH_MASK_dma.h"    
...
/* This define is obsolete and should not be used. 
Presented for backward compatibility only 
*/
...
#else 
    void `$INSTANCE_NAME`_GetUVFaultStatus(uint32 * uvStatus)  `=ReentrantKeil($INSTANCE_NAME . "_GetUVFaultStatus")`;
...
#if((`$INSTANCE_NAME`_NUMBER_OF_VOLTAGES> 8u) && (`$INSTANCE_NAME`_NUMBER_OF_VOLTAGES<= 16u))
    #define `$INSTANCE_NAME`_PG_STS8_STATUS_REG     (* (reg8 *)`$INSTANCE_NAME`_bVFD_`$StsReplacementString`_PGStsReg8__STATUS_REG)
    #define `$INSTANCE_NAME`_PG_STS8_STATUS_PTR     (  (reg8 *)`$INSTANCE_NAME`_bVFD_`$StsReplacementString`_PGStsReg8__STATUS_REG)
...
#if((`$INSTANCE_NAME`_NUMBER_OF_VOLTAGES> 16u) && (`$INSTANCE_NAME`_NUMBER_OF_VOLTAGES<= 24u))
    #define `$INSTANCE_NAME`_PG_STS8_STATUS_REG     (* (reg8 *)`$INSTANCE_NAME`_bVFD_`$StsReplacementString`_PGStsReg8__STATUS_REG)
    #define `$INSTANCE_NAME`_PG_STS8_STATUS_PTR     (  (reg8 *)`$INSTANCE_NAME`_bVFD_`$StsReplacementString`_PGStsReg8__STATUS_REG)
    #define `$INSTANCE_NAME`_PG_STS16_STATUS_REG    (* (reg8 *)`$INSTANCE_NAME`_bVFD_`$StsReplacementString`_PGStsReg16__STATUS_REG)
    #define `$INSTANCE_NAME`_PG_STS16_STATUS_PTR    (  (reg8 *)`$INSTANCE_NAME`_bVFD_`$StsReplacementString`_PGStsReg16__STATUS_REG)
...
#if((`$INSTANCE_NAME`_NUMBER_OF_VOLTAGES> 24u) && (`$INSTANCE_NAME`_NUMBER_OF_VOLTAGES<= 32u))
    #define `$INSTANCE_NAME`_PG_STS8_STATUS_REG     (* (reg8 *)`$INSTANCE_NAME`_bVFD_`$StsReplacementString`_PGStsReg8__STATUS_REG)
    #define `$INSTANCE_NAME`_PG_STS8_STATUS_PTR     (  (reg8 *)`$INSTANCE_NAME`_bVFD_`$StsReplacementString`_PGStsReg8__STATUS_REG)
    #define `$INSTANCE_NAME`_PG_STS16_STATUS_REG    (* (reg8 *)`$INSTANCE_NAME`_bVFD_`$StsReplacementString`_PGStsReg16__STATUS_REG)
    #define `$INSTANCE_NAME`_PG_STS16_STATUS_PTR    (  (reg8 *)`$INSTANCE_NAME`_bVFD_`$StsReplacementString`_PGStsReg16__STATUS_REG)
...
#endif /* `$INSTANCE_NAME`_NUMBER_OF_VOLTAGES<= 32u */
