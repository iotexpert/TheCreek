...
`include "cypress.v"
`ifdef bI2C_v3_1_V_ALREADY_INCLUDED
`else
`define bI2C_v3_1_V_ALREADY_INCLUDED
        ...
        begin
            ...
            /* Output data only on the negative edge or if the clock is low */
                ...
                begin
                    ...
                    else if (s_state == I2C_SLAVE_RX_STALL || 
                             s_state == I2C_SLAVE_RX_ACK)     s_sda_out_reg <= 1'b0;
...
`endif /* bI2C_v3_1_V_ALREADY_INCLUDED */
