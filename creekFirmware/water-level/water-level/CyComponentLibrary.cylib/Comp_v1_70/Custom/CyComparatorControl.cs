    ...
    public partial class CyComparatorControl : UserControl
    {
            ...
            if (m_rbHysteresis_Enable.Checked)
            {
                ...
                if (m_rbPolarity_NonInve.Checked)
                {
                    if (m_rbPower_Off.Checked)
                    {
                        ...
                        wfg.DrawLine(orangepen, 181, 100, 198, 140);
                        wfg.DrawLine(orangepen, 189, 100, 206, 140);
                        wfg.DrawLine(orangepen, 198, 140, 268, 140);
                        wfg.DrawLine(orangepen, 268, 140, 286, 100);
                        wfg.DrawLine(orangepen, 286, 100, 370, 100);
                        wfg.DrawLine(orangepen, 362, 100, 379, 140);
                        wfg.DrawLine(orangepen, 370, 100, 387, 140);
                        wfg.DrawLine(orangepen, 379, 140, 405, 140);
                    }
                    else if (m_rbPower_Fast.Checked)
                    {
                        ...
                        wfg.DrawLine(orangepen, 175, 100, 175, 140);
                        wfg.DrawLine(orangepen, 183, 100, 183, 140);
                        wfg.DrawLine(orangepen, 175, 140, 257, 140);
                        wfg.DrawLine(orangepen, 257, 140, 257, 100);
                        wfg.DrawLine(orangepen, 257, 100, 364, 100);
                        wfg.DrawLine(orangepen, 356, 100, 356, 140);
                        wfg.DrawLine(orangepen, 364, 100, 364, 140);
                        wfg.DrawLine(orangepen, 356, 140, 400, 140);
                    }
                    else //if (m_rbPower_Slow.Checked)
                    {
                        wfg.DrawLine(orangepen, 40, 140, 80, 140);
                        wfg.DrawLine(orangepen, 80, 140, 91, 100);
                        wfg.DrawLine(orangepen, 91, 100, 183, 100);
                        wfg.DrawLine(orangepen, 183, 100, 194, 140);
                        wfg.DrawLine(orangepen, 175, 100, 186, 140);
                        wfg.DrawLine(orangepen, 186, 140, 260, 140);
                        wfg.DrawLine(orangepen, 260, 140, 271, 100);
                        wfg.DrawLine(orangepen, 271, 100, 363, 100);
                        wfg.DrawLine(orangepen, 363, 100, 375, 140);
                        wfg.DrawLine(orangepen, 355, 100, 367, 140);
                        wfg.DrawLine(orangepen, 367, 140, 405, 140);
                    }
                }
                ...
                if (m_rbPolarity_Inve.Checked)
                {
                    if (m_rbPower_Off.Checked)
                    {
                        ...
                        wfg.DrawLine(orangepen, 181, 140, 198, 100);
                        wfg.DrawLine(orangepen, 189, 140, 206, 100);
                        wfg.DrawLine(orangepen, 198, 100, 268, 100);
                        wfg.DrawLine(orangepen, 268, 100, 286, 140);
                        wfg.DrawLine(orangepen, 286, 140, 370, 140);
                        wfg.DrawLine(orangepen, 362, 140, 379, 100);
                        wfg.DrawLine(orangepen, 370, 140, 387, 100);
                        wfg.DrawLine(orangepen, 379, 100, 405, 100);
                    }
                    else if (m_rbPower_Fast.Checked)
                    {
                        ...
                        wfg.DrawLine(orangepen, 175, 140, 175, 100);
                        wfg.DrawLine(orangepen, 183, 140, 183, 100);
                        wfg.DrawLine(orangepen, 175, 100, 257, 100);
                        wfg.DrawLine(orangepen, 257, 100, 257, 140);
                        wfg.DrawLine(orangepen, 257, 140, 364, 140);
                        wfg.DrawLine(orangepen, 356, 140, 356, 100);
                        wfg.DrawLine(orangepen, 364, 140, 364, 100);
                        wfg.DrawLine(orangepen, 356, 100, 400, 100);
                    }
                    else  //if (m_rbPower_Slow.Checked)
                    {
                        wfg.DrawLine(orangepen, 40, 100, 80, 100);
                        wfg.DrawLine(orangepen, 80, 100, 91, 140);
                        wfg.DrawLine(orangepen, 91, 140, 183, 140);
                        wfg.DrawLine(orangepen, 183, 140, 194, 100);
                        wfg.DrawLine(orangepen, 175, 140, 186, 100);
                        wfg.DrawLine(orangepen, 186, 100, 260, 100);
                        wfg.DrawLine(orangepen, 260, 100, 271, 140);
                        wfg.DrawLine(orangepen, 271, 140, 363, 140);
                        wfg.DrawLine(orangepen, 363, 140, 375, 100);
                        wfg.DrawLine(orangepen, 355, 140, 367, 100);
                        wfg.DrawLine(orangepen, 367, 100, 405, 100);
                    }
                }
            }
            ...
            if (m_rbHysteresis_Disable.Checked)
            {
                if (m_rbPolarity_NonInve.Checked)
                {
                    ...
                    else //if (m_rbPower_Slow.Checked)
                    {
                        ...
                        wfg.DrawLine(orangepen, 70, 140, 86, 100);
                        wfg.DrawLine(orangepen, 86, 100, 173, 100);
                        wfg.DrawLine(orangepen, 173, 100, 189, 140);
                        wfg.DrawLine(orangepen, 189, 140, 251, 140);
                        wfg.DrawLine(orangepen, 251, 140, 264, 100);
                        wfg.DrawLine(orangepen, 264, 100, 357, 100);
                        wfg.DrawLine(orangepen, 357, 100, 372, 140);
                ...
                if (m_rbPolarity_Inve.Checked)
                {
                    ...
                    else //if (m_rbPower_Slow.Checked)
                    {
                        ...
                        wfg.DrawLine(orangepen, 176, 140, 190, 100);
                        wfg.DrawLine(orangepen, 190, 100, 251, 100);
                        wfg.DrawLine(orangepen, 251, 100, 264, 140);
        ...
        private void m_rbHysteresis_Enable_CheckedChanged(object sender, EventArgs e)
        {
            if (m_rbHysteresis_Enable.Checked)
            {
                ...
                if (m_rbPolarity_NonInve.Checked && m_rbSync_Norm.Checked)
                    pictureBox2.Image = Comp_v1_70.Properties.Resources.hy_ninv_sync;
                if (m_rbHysteresis_Enable.Checked && m_rbPolarity_NonInve.Checked && m_rbSync_Bypass.Checked)
                    pictureBox2.Image = Comp_v1_70.Properties.Resources.hysteresis;
                if (m_rbPolarity_Inve.Checked && m_rbSync_Norm.Checked)
                    pictureBox2.Image = Comp_v1_70.Properties.Resources.hy_inv_syn;
                if (m_rbPolarity_Inve.Checked && m_rbSync_Bypass.Checked)
                    pictureBox2.Image = Comp_v1_70.Properties.Resources.hy_inv;
                UpdateDrawing(prms);
             }
        }
        ...
        private void m_rbHysteresis_Disable_CheckedChanged(object sender, EventArgs e)
        {
            if (m_rbHysteresis_Disable.Checked)
            {
                ...
                if (m_rbPolarity_NonInve.Checked && m_rbSync_Norm.Checked)
                    pictureBox2.Image = Comp_v1_70.Properties.Resources.sync;
                if (m_rbPolarity_NonInve.Checked && m_rbSync_Bypass.Checked)
                    pictureBox2.Image = Comp_v1_70.Properties.Resources.comp;
                if (m_rbPolarity_Inve.Checked && m_rbSync_Norm.Checked)
                    pictureBox2.Image = Comp_v1_70.Properties.Resources.inv_sync;
                if (m_rbPolarity_Inve.Checked && m_rbSync_Bypass.Checked)
                    pictureBox2.Image = Comp_v1_70.Properties.Resources.inverting;
                UpdateDrawing(prms);
            }
        }
