...
namespace PGA_v1_60
{
    ...
    public class CyCustomizer : ICyParamEditHook_v1, ICyExprEval_v2
    {
        ...
        CyPgaControl m_control = null;

        public DialogResult EditParams(ICyInstEdit_v1 edit, ICyTerminalQuery_v1 termQuery,ICyExpressMgr_v1 mgr)
        {
            m_control = new CyPgaControl(edit);
            m_Component = edit;
        ...
        {
            CyPgaControl m_control;
            Panel displayControl = new Panel();

            public CyCompEditingControl(ICyInstEdit_v1 inst, ICyTerminalQuery_v1 termquery, CyPgaControl control)
            {
                m_control = control;
