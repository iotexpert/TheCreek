    ...
    public partial class CyCounterControl : UserControl
    {
        ...
        {		
            ...
            m_lblCalcMaxPeriod.Text = UpdateCalculatedPeriod(Convert.ToInt64(m_rbResolution8.Checked ? 
                                      Counter_v1_50.CounterParameters.CONST_2_8 : (m_rbResolution16.Checked ? 
                                      Counter_v1_50.CounterParameters.CONST_2_16 : (m_rbResolution24.Checked ? 
                                      Counter_v1_50.CounterParameters.CONST_2_24 : CounterParameters.CONST_2_32))),
        ...
        private void SetFixedFunction()
        {
            ...
            CounterParameters.SetAParameter(Counter_v1_50.CounterParameters.INTERRUPT_ON_CAPTURE, 
                                            Counter_v1_50.CounterParameters.FALSE, m_component);
        }
        ...
        private void m_rbResolution8_Click(object sender, MouseEventArgs e)
        {
            if (!m_rbResolution8.Checked)
            {
                ...
                CounterParameters.SetAParameter(Counter_v1_50.CounterParameters.RESOLUTION, 
                                                Counter_v1_50.CounterParameters.EIGHT_BIT, m_component);
            }
        ...
        private void m_rbResolution16_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution16.Checked)
            {
                ...
                m_lblCalcBitResolution.Text = UpdateCalculatedPeriod(Convert.ToInt64(1), 
                                                                     CounterParameters.BIT_RESOLUTION);
                CounterParameters.SetAParameter(Counter_v1_50.CounterParameters.RESOLUTION, 
                                                Counter_v1_50.CounterParameters.SIXTEEN_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        }
        ...
        private void m_rbResolution24_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution24.Checked)
            {
                ...
                m_lblCalcBitResolution.Text = UpdateCalculatedPeriod(Convert.ToInt64(1), 
                                                                     CounterParameters.BIT_RESOLUTION);
                CounterParameters.SetAParameter(Counter_v1_50.CounterParameters.RESOLUTION, 
                                                Counter_v1_50.CounterParameters.TWENTYFOUR_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        }
        ...
        private void m_rbResolution32_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution32.Checked)
            {
                ...
                m_lblCalcBitResolution.Text = UpdateCalculatedPeriod(Convert.ToInt64(1), 
                                                                     CounterParameters.BIT_RESOLUTION);
                CounterParameters.SetAParameter(Counter_v1_50.CounterParameters.RESOLUTION, 
                                                Counter_v1_50.CounterParameters.THIRTYTWO_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        ...
        {		    
            if (!m_rbFixedFunction.Checked)
            {
                ...
                SetFixedFunction();
                CounterParameters.SetAParameter(Counter_v1_50.CounterParameters.FIXEDFUNCTION, 
                                                Counter_v1_50.CounterParameters.TRUE, m_component);
                UpdateAdvancedForm();
            }               
        }
        ...
        {
            if (m_rbResolution8.Checked)
                m_numPeriod.Value = Counter_v1_50.CounterParameters.CONST_2_8;
            else if (m_rbResolution16.Checked)
                m_numPeriod.Value = Counter_v1_50.CounterParameters.CONST_2_16;
            else if (m_rbResolution24.Checked)
                m_numPeriod.Value = Counter_v1_50.CounterParameters.CONST_2_24;
            else
                m_numPeriod.Value = Counter_v1_50.CounterParameters.CONST_2_32;
        }
