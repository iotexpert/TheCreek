...
namespace PRS_v1_30
{
    public partial class CyCustomizer : ICyAPICustomize_v1
    {
        ...
        private const string m_CS_CFILE_NAME = "PRS.c";
        private const string m_CS_HFILE_NAME = "PRS.h";
        public const string m_INSTANCE_NAME_PARAM = "INSTANCE_NAME";
                                                          ...
                                                          IEnumerable<CyAPICustomizer> apis)
        {
            ...
            foreach (CyAPICustomizer api in customizers)
            {
                ...
                if (api.OriginalName.EndsWith(m_CS_CFILE_NAME))
                {
                    ...
                    paramDict.TryGetValue(m_INSTANCE_NAME_PARAM, out m_instanceName);
                }
