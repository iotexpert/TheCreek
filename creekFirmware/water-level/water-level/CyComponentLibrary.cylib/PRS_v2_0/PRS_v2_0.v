...
`include "cypress.v"
`ifdef PRS_v2_0_V_ALREADY_INCLUDED
`else
`define PRS_v2_0_V_ALREADY_INCLUDED
...
(
   ...
   localparam PSOC5_ES1 = ((`CYDEV_CHIP_MEMBER_USED   == `CYDEV_CHIP_MEMBER_5A) && 
    ...
    generate
        ...
        begin
            if ((PSOC3_ES2 || PSOC5_ES1)&&(RunMode == PRS_RUNMODE_CLOCKED))
            begin
    ...
    /* Signals is used for recover PRS stete after Sleep in ES2*/
    generate
         /* Time Multiplexing Logic */
        if (TimeMultiplexing == PRS_CFG_TDM_ENABLE)
        begin
...
`endif      /* PRS_v2_0_V_ALREADY_INCLUDED */
