...
* You) may u)se this file only in accordance with the license, terms, conditions,
...
#define `$INSTANCE_NAME`_TUNNING_METHOD             (`$TuningMethod`u)
...
/* Method of tunning */
#define `$INSTANCE_NAME`_NO_TUNNING                 (0u)
#define `$INSTANCE_NAME`_MANUAL_TUNNING             (1u)
#define `$INSTANCE_NAME`_AUTO_TUNNING               (2u)
...
/* PWM Resolution */
#define `$INSTANCE_NAME`_PWM_WINDOW_APPEND          (0xFE)
...
/* Two Channels mode */
#define `$INSTANCE_NAME`_SW_STS_SCAN_DONE__CH0      (0x02u)
#define `$INSTANCE_NAME`_SW_STS_SCANS_CMPLT__CH0    (0x04u)
#define `$INSTANCE_NAME`_SW_STS_SCAN_DONE__CH1      (0x08u)
#define `$INSTANCE_NAME`_SW_STS_SCANS_CMPLT__CH1    (0x10u)
...
/* Init Idac current */
    ...
    #define `$INSTANCE_NAME`_TURN_OFF_IDAC              (0xFFu)
#else
    #define `$INSTANCE_NAME`_TURN_OFF_IDAC              (0x00u)
#endif  /* End (`$INSTANCE_NAME`_VREF_OPTIONS == `$INSTANCE_NAME`_VREF_VDAC) */
...
/* Control REG */
#define `$INSTANCE_NAME`_CONTROL_REG                    (*(reg8 *) `$INSTANCE_NAME`_ClockGen_`$CtlModeReplacementString`_CtrlReg__CONTROL_REG )
#define `$INSTANCE_NAME`_CONTROL_PTR                    ( (reg8 *) `$INSTANCE_NAME`_ClockGen_`$CtlModeReplacementString`_CtrlReg__CONTROL_REG )
...
/* Measure REGs  definitions */
    ...
    #define `$INSTANCE_NAME`_PWM_CH0_AUX_CONTROL_REG    (*(reg8 *) `$INSTANCE_NAME`_MeasureCH0_UDB_Window_u0__DP_AUX_CTL_REG )
    #define `$INSTANCE_NAME`_PWM_CH0_AUX_CONTROL_PTR    ( (reg8 *) `$INSTANCE_NAME`_MeasureCH0_UDB_Window_u0__DP_AUX_CTL_REG )
    ...
    #define `$INSTANCE_NAME`_RAW_CH0_AUX_CONTROL_REG    (*(reg8 *) `$INSTANCE_NAME`_MeasureCH0_UDB_Counter_u0__DP_AUX_CTL_REG )
    #define `$INSTANCE_NAME`_RAW_CH0_AUX_CONTROL_PTR    ( (reg8 *) `$INSTANCE_NAME`_MeasureCH0_UDB_Counter_u0__DP_AUX_CTL_REG )
        ...
        #define `$INSTANCE_NAME`_PWM_CH1_AUX_CONTROL_REG    (*(reg8 *) `$INSTANCE_NAME`_MeasureCH1_UDB_Window_u0__DP_AUX_CTL_REG )
        #define `$INSTANCE_NAME`_PWM_CH1_AUX_CONTROL_PTR    ( (reg8 *) `$INSTANCE_NAME`_MeasureCH1_UDB_Window_u0__DP_AUX_CTL_REG )
        ...
        #define `$INSTANCE_NAME`_RAW_CH1_AUX_CONTROL_REG    (*(reg8 *) `$INSTANCE_NAME`_MeasureCH1_UDB_Counter_u0__DP_AUX_CTL_REG )
        #define `$INSTANCE_NAME`_RAW_CH1_AUX_CONTROL_PTR    ( (reg8 *) `$INSTANCE_NAME`_MeasureCH1_UDB_Counter_u0__DP_AUX_CTL_REG )
