...
namespace Timer_v2_20
{
    ...
    public class CyCustomizer : ICyParamEditHook_v1, ICyDRCProvider_v1
    {
        ...
        CyCustErr VerifyRunMode(ICyDRCProviderArgs_v1 drcQuery, string fixedFunction, string runMode, string hardwareEnable)
        {
            ...
            if ((drcQuery.DeviceQueryV1.SiliconRevision < PSOC5_ES2 && drcQuery.DeviceQueryV1.IsPSoC5 == true) &&
