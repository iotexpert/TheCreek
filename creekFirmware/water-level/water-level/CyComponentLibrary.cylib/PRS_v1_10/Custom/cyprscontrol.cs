...
namespace CyCustomizer.PRS_v1_10
{
    public partial class CyPRSControl : UserControl
    {
        ...
        private int[,] StandartPolynomials = new int[63, 4] { 
        { 2, 1, 0, 0 }, 
        { 3, 2, 0, 0 }, 
        { 4, 3, 0, 0}, 
        { 5, 4, 3, 2},
        ...
        void FillTextBoxWithStandartPolynom()
        {
            ...
            {
                textBoxLFSR.Text = StandartPolynomials[Resolution - 2, 0].ToString() + ", " +
                                   StandartPolynomials[Resolution - 2, 1];
            }
