...
uint8  `$INSTANCE_NAME`_DmaConfigure(void) CYREENTRANT;
void   `$INSTANCE_NAME`_DmaDispose(void) CYREENTRANT;
...
*
*******************************************************************************/
uint8 `$INSTANCE_NAME`_Start() `=ReentrantKeil($INSTANCE_NAME . "_Start")`
{
    uint8 status = CYRET_LOCKED;
...
*
*******************************************************************************/
void `$INSTANCE_NAME`_ClearDisplay() `=ReentrantKeil($INSTANCE_NAME . "_ClearDisplay")`
{
    uint16 i;
...
*
*******************************************************************************/
uint8 `$INSTANCE_NAME`_WritePixel(uint8 pixelNumber, uint8 pixelState) `=ReentrantKeil($INSTANCE_NAME . "_WritePixel")`
{
    uint8 byteAddr;
    uint8 bitAddr;
    uint8 row;
