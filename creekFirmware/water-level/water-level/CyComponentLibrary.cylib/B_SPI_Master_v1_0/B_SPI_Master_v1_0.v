/*******************************************************************************
 *
 * FILENAME:  B_SPI_Master_v1_0.v
 * MODULE NAME: B_SPI_Master_v1_0
 * COMPONENT NAME:   B_SPI_Master_v1_0
 * @Version@
 *
 * DESCRIPTION:
...
`include "cypress.v"
`ifdef B_SPIM_V_v1_0_ALREADY_INCLUDED
`else
`define B_SPIM_V_v1_0_ALREADY_INCLUDED
module B_SPI_Master_v1_0(
...
/******************************************************************************/
    ...
    spim_ctrl_v1_0 #(.NumberOfDataBits(NumberOfDataBits), .ModeCPHA(ModeCPHA),
...
module spim_ctrl_v1_0 (
    ...
    ***************************************************************************/
    ...
    localparam SPIM_STATE_FOUR           =   3'd4;
    localparam SPIM_STATE_FIVE           =   3'd5;
	...
	assign byte_complete = (state == SPIM_STATE_FIVE);
	assign spi_done = (state != SPIM_STATE_IDLE);
...
`endif /* B_SPIM_V_v1_0_ALREADY_INCLUDED */
