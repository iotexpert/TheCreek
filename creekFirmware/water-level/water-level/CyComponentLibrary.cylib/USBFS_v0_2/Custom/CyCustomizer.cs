...
namespace USBFS_v0_2
{
    ...
    public partial class CyCustomizer : ICyParamEditHook_v1
    {
        ...
        public DialogResult EditParams(ICyInstEdit_v1 edit, ICyTerminalQuery_v1 termQuery, ICyExpressMgr_v1 mgr)
        {
            ...
            Parameters = new USBFSParameters(edit);
            ...
            editor.AddCustomPage("Device Descriptor", new CyDeviceDescriptorEditingControl(Parameters), ParamCommitted, "Device Descriptor");
            editor.AddCustomPage("String Descriptor", new CyStringDescriptorEditingControl(Parameters), ParamCommitted, "String Descriptor");
            editor.AddCustomPage("HID Descriptor", new CyHIDDescriptorEditingControl(Parameters), ParamCommitted, "HID Descriptor");
    ...
    {
        CyDeviceDescriptor m_control;

        public CyDeviceDescriptorEditingControl(USBFSParameters parameters)
        {
        ...
        public IEnumerable<CyCustErr> GetErrors()
        {
            ...
            m_control.Parameters.SerializedDeviceDesc = DescriptorTree.SerializeDescriptors(m_control.Parameters.DeviceTree);

            //If there are empty fields
            if (m_control.Parameters.EmptyFields.Count > 0)
                errorList.Add(new CyCustErr("Undefined HID Report for the HID Class Descriptor.\r\n To fix this problem you can:"+
    ...
    {
        CyStringDescriptor m_control;

        public CyStringDescriptorEditingControl(USBFSParameters parameters)
        {
        ...
        public IEnumerable<CyCustErr> GetErrors()
        {
            m_control.Parameters.SerializedStringDesc = DescriptorTree.SerializeDescriptors(m_control.Parameters.StringTree);
    ...
    {
        CyHIDDescriptor m_control;

        public CyHIDDescriptorEditingControl(USBFSParameters parameters)
        {
        ...
        public IEnumerable<CyCustErr> GetErrors()
        {
            m_control.Parameters.SerializedHIDReportDesc = DescriptorTree.SerializeDescriptors(m_control.Parameters.HIDReportTree);
