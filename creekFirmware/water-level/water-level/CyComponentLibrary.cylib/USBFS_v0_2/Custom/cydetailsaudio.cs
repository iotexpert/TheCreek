...
namespace USBFS_v0_2
{
    public partial class CyDetailsAudio : UserControl
    {
        ...
        const int TOTAL_EDITS = 32;

        public CyDetailsAudio(AudioDescriptor descriptor, USBFSParameters parameters)
        {
            InitializeComponent();
        ...
        private void FillSybtypes()
        {
            ...
            switch (Descriptor.bAudioDescriptorSubClass)
            {
                ...
                case 0xFF:
                    comboBoxSybtype.Items.Add("Undefined");
                    comboBoxSybtype.Items.Add("Header Functional Descriptor, which marks the beginning of the concatenated set of functional descriptors for the interface.");
                    ...
                    comboBoxSybtype.Items.Add("Telephone Call and Line State Reporting Capabilities Functional Descriptor.");
        ...
        private void CyDetailsAudio_SizeChanged(object sender, EventArgs e)
        {
