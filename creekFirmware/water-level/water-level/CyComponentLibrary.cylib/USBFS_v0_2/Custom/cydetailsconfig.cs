...
namespace USBFS_v0_2
{
    public partial class CyDetailsConfig : UserControl
    {
        ...
        public CyDetailsConfig(ConfigDescriptor descriptor, USBFSParameters parameters)
        {
            InitializeComponent();
        ...
        private void buttonApply_Click(object sender, EventArgs e)
        {
            ...
            //Configuration string
            Descriptor.iwConfiguration = USBFSParameters.SaveStringDescriptor(comboBoxConfigString, Parameters);
        }
