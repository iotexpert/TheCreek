...
namespace USBFS_v0_2
{
    public partial class CyDetailsHID : UserControl
    {
        ...
        public CyDetailsHID(HIDDescriptor descriptor, USBFSParameters parameters)
        {
            InitializeComponent();
        ...
        private void InitFields()
        {
            ...
            for (int i = 0; i < USBFSParameters.CountryCodes.Length; i++)
            {
                comboBoxCountryCode.Items.Add(USBFSParameters.CountryCodes[i]);
            }
        ...
        {
            Descriptor.wReportIndex = USBFSParameters.SaveReportDescriptor(comboBoxReport, Parameters);
            if (!InternalChanges)
                Parameters.ParamsChanged = true;
        }
