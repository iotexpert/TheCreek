...
namespace USBFS_v0_2
{
    public class USBFSParameters
    {
        ...
        public USBFSParameters(ICyInstEdit_v1 inst)
        {
            DeviceTree = new DescriptorTree();
            StringTree = new DescriptorTree();
            HIDReportTree = new DescriptorTree();
        ...
        public static uint SaveStringDescriptor(ComboBox comboBox, USBFSParameters parameters)
        {
        ...
        public static uint SaveReportDescriptor(ComboBox comboBox, USBFSParameters parameters)
        {
        ...
        public static byte SaveSpecialStringDescriptor(ComboBox comboBox, string type, USBFSParameters parameters)
        {
            ...
            foreach (DescriptorNode node_child in node.Nodes)
            {
                switch (node_child.Value.bDescriptorType)
                {
                    ...
                    case USBDescriptorType.HID_REPORT:
                        ...
                        {
                            rptSize += (ushort)(((HIDReportItemDescriptor)node_in_report.Value).Item.Size + 1); // +1 - prefix
                        }
                ...
                else
                {
                    switch (parentNode.Value.bDescriptorType)
                    {
                        case USBDescriptorType.DEVICE:
                            ...
                            break;
                        case USBDescriptorType.CONFIGURATION:
                            newNode = new DescriptorNode(new InterfaceDescriptor());
                            parentNode.Nodes.Add(newNode);
                            AddNode(newNode.Key);
                            break;
                        case USBDescriptorType.INTERFACE:
                ...
                switch (parentNode.Value.bDescriptorType)
                {
                    case USBDescriptorType.INTERFACE:
                        ...
                        else if (type == USBDescriptorType.AUDIO)
                        {
                            ...
                            if (((InterfaceDescriptor)parentNode.Value).bInterfaceClass == USBFSParameters.CLASS_AUDIO)
                            {
            ...
            if (Kind == HIDReportItemKind.List)
            {
                ...
                switch (Name)
                {
                    case "USAGE":
                        ...
                        {
                            ValuesList.Add(Convert.ToByte(CyHIDDescriptor.ValuesGenericDesktopPage[i * 2 + 1], 16), CyHIDDescriptor.ValuesGenericDesktopPage[i * 2]);
                        }
                        break;
                    case "USAGE_LIST":
                        for (int i = 0; i < CyHIDDescriptor.ValuesUsagePage.Length / 2; i++)
                        {
                            ValuesList.Add(Convert.ToByte(CyHIDDescriptor.ValuesUsagePage[i * 2 + 1], 16), CyHIDDescriptor.ValuesUsagePage[i * 2]);
                        }
                        break;
                    case "COLLECTION":
                        for (int i = 0; i < CyHIDDescriptor.ValuesCollection.Length / 2; i++)
                        {
                            ValuesList.Add(Convert.ToByte(CyHIDDescriptor.ValuesCollection[i * 2 + 1], 16), CyHIDDescriptor.ValuesCollection[i * 2]);
                        }
                        break;
                    case "INPUT":
                        for (int i = 0; i < CyHIDDescriptor.ValuesInput.Length / 2; i++)
                        {
                            ValuesList.Add(Convert.ToByte(CyHIDDescriptor.ValuesInput[i * 2 + 1], 16), CyHIDDescriptor.ValuesInput[i * 2]);
                        }
                        break;
                    case "OUTPUT":
                        for (int i = 0; i < CyHIDDescriptor.ValuesInput.Length / 2; i++)
                    ...
                    case "UNIT_EXPONENT":
                        ...
                        {
                            ValuesList.Add(Convert.ToByte(CyHIDDescriptor.ValuesUnitExponent[i * 2 + 1], 16), CyHIDDescriptor.ValuesUnitExponent[i * 2]);
                        }
                        break;
                    case "DELIMITER":
                        for (int i = 0; i < CyHIDDescriptor.ValuesDelimiter.Length / 2; i++)
                        {
                            ValuesList.Add(Convert.ToByte(CyHIDDescriptor.ValuesDelimiter[i * 2 + 1], 16), CyHIDDescriptor. ValuesDelimiter[i * 2]);
                        }
                        break;
                }
