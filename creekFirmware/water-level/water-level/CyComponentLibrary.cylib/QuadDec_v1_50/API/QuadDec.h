...
*/
#define `$INSTANCE_NAME`_Count32SoftPart            `$INSTANCE_NAME`_count32SoftPart
#define `$INSTANCE_NAME`_SwStatus                   `$INSTANCE_NAME`_swStatus
#define `$INSTANCE_NAME`_STATUS                     `$INSTANCE_NAME`_STATUS_REG
