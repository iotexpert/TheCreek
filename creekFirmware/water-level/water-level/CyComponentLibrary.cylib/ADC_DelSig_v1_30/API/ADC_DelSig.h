...
#include "cytypes.h"
#include "cyfitter.h"
#include "cydevice_trm.h"  /* This required until DSM power register control is moved. */
...
#define `$INSTANCE_NAME`_PWRMGR_DSM (* (reg8 *) CYDEV_PM_AVAIL_CR5 )  /* Modulator Power manager */
...
#define `$INSTANCE_NAME`_DFLT_COUNTS_PER_VOLT `$DFLT_COUNTS_PER_VOLT`
