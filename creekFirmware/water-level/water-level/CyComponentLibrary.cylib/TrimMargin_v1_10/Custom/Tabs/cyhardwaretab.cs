...
namespace TrimMargin_v1_10
{
    public partial class CyHardwareTab : CyEditingWrapperControl
    {
        ...
        public void UpdateUIFromTable(int index)
        {
            ...
            dgvHardware[colResolution.Index, index].Value = m_params.HardwareTable[index].m_calculatedResolution;
        ...
        public void UpdateTableFromUI()
        {
            for (int i = 0; i < m_dataGridRowCount; i++)
            {
                ...
                m_params.HardwareTable[i].m_calculatedResolution = CyParameters.ParseNullableDouble(
