 ...
 ******************************** */
   ...
   #define `$INSTANCE_NAME`_AUX_CONTROLDP0      (*(`$RegDefReplacementString` *) `$INSTANCE_NAME`_PWMUDB_`$VerilogSectionReplacementString`_pwmdp_u0__DP_AUX_CTL_REG)
   #define `$INSTANCE_NAME`_AUX_CONTROLDP0_PTR  ((`$RegDefReplacementString` *) `$INSTANCE_NAME`_PWMUDB_`$VerilogSectionReplacementString`_pwmdp_u0__DP_AUX_CTL_REG)
   #if (`$INSTANCE_NAME`_Resolution == 16)
       #define `$INSTANCE_NAME`_AUX_CONTROLDP1    (*(`$RegDefReplacementString` *) `$INSTANCE_NAME`_PWMUDB_`$VerilogSectionReplacementString`_pwmdp_u1__DP_AUX_CTL_REG)
       #define `$INSTANCE_NAME`_AUX_CONTROLDP1_PTR  ((`$RegDefReplacementString` *) `$INSTANCE_NAME`_PWMUDB_`$VerilogSectionReplacementString`_pwmdp_u1__DP_AUX_CTL_REG)
   #endif
#endif
