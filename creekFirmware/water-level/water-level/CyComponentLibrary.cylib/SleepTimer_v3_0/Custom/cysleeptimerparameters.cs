...
namespace SleepTimer_v3_0
{
    ...
    public class CySleepTimerParameters
    {
        ...
        public bool IsIntervalAllowedForPSoC5()
        {
            return CySleepTimerParameters.IsIntervalAllowedForPSoC5(this.Interval);
        }

        public static bool IsIntervalAllowedForPSoC5(string interval)
        {
            int? index = null;
