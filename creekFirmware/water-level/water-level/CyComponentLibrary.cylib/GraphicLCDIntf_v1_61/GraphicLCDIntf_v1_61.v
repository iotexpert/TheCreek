/*******************************************************************************
* File Name: GraphicLCDIntf_v1_61.v
...
`include "cypress.v"
`ifdef GraphicLCDIntf_V_v1_61_ALREADY_INCLUDED
`else
`define GraphicLCDIntf_V_v1_61_ALREADY_INCLUDED

module GraphicLCDIntf_v1_61 (
    ...
    */
    ...
    /* The state mapped to state 8 uses the same datapath address as state 0,
    *  so the lower 3 bits of the state machine can be used to directly drive 
    *  the cs_addr bits. 
    */
    reg [3:0] state;
...
`endif /* GraphicLCDIntf_V_v1_61_ALREADY_INCLUDED */
