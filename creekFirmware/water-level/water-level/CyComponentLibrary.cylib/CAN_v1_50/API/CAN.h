...
*/
#define CAN_reg32      `$INSTANCE_NAME`_REG_32
#define CANTXMsg       `$INSTANCE_NAME`_TX_MSG
#define CANRXcfg       `$INSTANCE_NAME`_RX_CFG
#define CANTXcfg       `$INSTANCE_NAME`_TX_CFG
#define CANRXstruct    `$INSTANCE_NAME`_RX_STRUCT
#define CANTXstruct    `$INSTANCE_NAME`_TX_STRUCT
#define DATA_BYTES     `$INSTANCE_NAME`_DATA_BYTES
#define DATA_BYTES_MSG `$INSTANCE_NAME`_DATA_BYTES_MSG
...
*  Please do not use it in new projects
*/
#define FAIL                                        `$INSTANCE_NAME`_FAIL
#define OUT_OF_RANGE                                `$INSTANCE_NAME`_OUT_OF_RANGE
...
*  Please do not use it in new projects 
*/
#define `$INSTANCE_NAME`_INT_SR `$INSTANCE_NAME`_INT_SR_REG
#define `$INSTANCE_NAME`_INT_EN `$INSTANCE_NAME`_INT_EN_REG
#define `$INSTANCE_NAME`_BUF_SR `$INSTANCE_NAME`_BUF_SR_REG
#define `$INSTANCE_NAME`_ERR_SR `$INSTANCE_NAME`_ERR_SR_REG
#define `$INSTANCE_NAME`_PWRMGR `$INSTANCE_NAME`_PM_ACT_CFG_REG
#define `$INSTANCE_NAME`_CMD `$INSTANCE_NAME`_CMD_REG
#define `$INSTANCE_NAME`_CFG `$INSTANCE_NAME`_CFG_REG
...
#define `$INSTANCE_NAME`_SET_RX_BUF_ENABLE(i)     `$INSTANCE_NAME`_RX[i].rxcmd.byte[0u] |= \
                                                    `$INSTANCE_NAME`_RX_BUF_ENABLE_MASK
#define `$INSTANCE_NAME`_CLEAR_RX_BUF_DISABLE(i)  `$INSTANCE_NAME`_RX[i].rxcmd.byte[0u] &= \
                                                    ~`$INSTANCE_NAME`_RX_BUF_ENABLE_MASK
