...
/* PSoC3 ES2 or early */
#define `$INSTANCE_NAME`_PSOC3_ES2  (CY_PSOC3_ES2)
                     
/* PSoC5 ES1 or early */
#define `$INSTANCE_NAME`_PSOC5_ES1  (CY_PSOC5_ES1)

/* PSoC3 ES3 or later */
#define `$INSTANCE_NAME`_PSOC3_ES3  (CY_PSOC3_ES3)
                     
/* PSoC5 ES2 or later */
#define `$INSTANCE_NAME`_PSOC5_ES2  (CY_PSOC5_ES2)

/* Vdd Voltage in MV */
#if (`$INSTANCE_NAME`_PSOC3_ES3 || `$INSTANCE_NAME`_PSOC5_ES2)
    #define `$INSTANCE_NAME`_VDDD       (CYDEV_VDDD_MV)
    #define `$INSTANCE_NAME`_VDD_LOW    (1700u)
...
#define `$INSTANCE_NAME`_WAIT_STATE         (0x01u)
