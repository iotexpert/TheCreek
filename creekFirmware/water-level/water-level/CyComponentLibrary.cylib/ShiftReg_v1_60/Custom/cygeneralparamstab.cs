...
namespace ShiftReg_v1_60
{
    public partial class CyGeneralParamsTab : UserControl, ICyParamEditingControl
    {
        ...
        static string[] m_strFifoSize = new string[2] { "1", "4" };
        ...
        public CyGeneralParamsTab()
        {
            ...
            CySRParameters.AssigneEventHandler(this,new EventHandler(SetParameters));
        }
        ...
        public void GetParameters(CySRParameters inst)
        {
            ...
            CyCBConverter.SetValue(cbFIFOS, m_inst.m_FifoSize.ToString());
        ...
        void SetParameters(object sender, EventArgs e)
        {
            if (CySRParameters.GLOBAL_EDIT_MODE)
                if (m_inst != null)
                {
                    ...
                    m_inst.m_FifoSize = Convert.ToInt32(CyCBConverter.GetValue(cbFIFOS));
