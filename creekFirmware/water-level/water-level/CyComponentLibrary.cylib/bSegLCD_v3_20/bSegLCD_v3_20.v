...
`include "cypress.v"
`ifdef bSegLCD_v3_20_ALREADY_INCLUDED
`else
`define bSegLCD_v3_20_ALREADY_INCLUDED

module bSegLCD_v3_20 (
...
`endif /* bSegLCD_v3_20_ALREADY_INCLUDED */
