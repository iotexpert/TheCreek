...
void SMS_LIB_V3_SetAnalogSwitchesSrc_PRS(void) `=ReentrantKeil("SMS_LIB_V3_SetAnalogSwitchesSrc_PRS")`
{
	`$INSTANCE_NAME`_SetAnalogSwitchesSource(`$INSTANCE_NAME`_ANALOG_SWITCHES_SRC_PRS);
}

void SMS_LIB_V3_SetAnalogSwitchesSrc_Prescaler(void) `=ReentrantKeil("SMS_LIB_V3_SetAnalogSwitchesSrc_Prescaler")`
{
