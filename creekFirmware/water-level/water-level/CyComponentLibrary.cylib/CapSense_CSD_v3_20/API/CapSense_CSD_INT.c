...
extern void `$INSTANCE_NAME`_PreScan(uint8 sensor) `=ReentrantKeil($INSTANCE_NAME . "_PreScan")`;
    ...
    extern void `$INSTANCE_NAME`_PostScan(uint8 sensor) `=ReentrantKeil($INSTANCE_NAME . "_PostScan")`;
#else
    extern void `$INSTANCE_NAME`_PostScanCh0(uint8 sensor) `=ReentrantKeil($INSTANCE_NAME . "_PostScanCh0")`;
    extern void `$INSTANCE_NAME`_PostScanCh1(uint8 sensor) `=ReentrantKeil($INSTANCE_NAME . "_PostScanCh1")`;
