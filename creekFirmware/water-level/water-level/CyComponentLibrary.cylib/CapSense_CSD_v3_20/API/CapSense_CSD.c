...
#else
    void `$INSTANCE_NAME`_PostScanCh0(uint8 sensor) `=ReentrantKeil($INSTANCE_NAME . "_PostScanCh0")`;
    void `$INSTANCE_NAME`_PostScanCh1(uint8 sensor) `=ReentrantKeil($INSTANCE_NAME . "_PostScanCh1")`;
#endif  /* End `$INSTANCE_NAME`_DESIGN_TYPE */
...
void `$INSTANCE_NAME`_PreScan(uint8 sensor) `=ReentrantKeil($INSTANCE_NAME . "_PreScan")`
{
    ...
    *
    *******************************************************************************/
    void `$INSTANCE_NAME`_PostScan(uint8 sensor) `=ReentrantKeil($INSTANCE_NAME . "_PostScan")`
    {
