...
#endif /* !defined(`$INSTANCE_NAME`_PWMUDB_sSTSReg_stsreg__REMOVED) */
...
#endif /* !defined(`$INSTANCE_NAME`_PWMUDB_sCTRLReg_ctrlreg__REMOVED) */
...
#define `$INSTANCE_NAME`_INIT_INTERRUPTS_MODE     ((`$IntOnTC`u << `$INSTANCE_NAME`_STATUS_TC_INT_EN_MASK_SHIFT) | \
                                                  (`$IntOnCMP2` << `$INSTANCE_NAME`_STATUS_CMP2_INT_EN_MASK_SHIFT) | \
                                                  (`$IntOnCMP1` << `$INSTANCE_NAME`_STATUS_CMP1_INT_EN_MASK_SHIFT ) | \
                                                  (`$IntOnKill` << `$INSTANCE_NAME`_STATUS_KILL_INT_EN_MASK_SHIFT ))
#define `$INSTANCE_NAME`_DEFAULT_COMPARE2_MODE    (`$CompareType2`u << `$INSTANCE_NAME`_CTRL_CMPMODE2_SHIFT)
#define `$INSTANCE_NAME`_DEFAULT_COMPARE1_MODE    (`$CompareType1`u << `$INSTANCE_NAME`_CTRL_CMPMODE1_SHIFT)
...
******************************** */
   ...
   #endif /* (`$INSTANCE_NAME`_Resolution == 16) */
#endif /* (`$INSTANCE_NAME`_UsingFixedFunction) */
