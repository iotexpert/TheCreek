...
namespace Counter_v1_20
{
    public partial class CyCounterControlAdv : UserControl
    {
        ...
        public void UpdateFormFromParams(ICyInstEdit_v1 inst)
        {
            ...
            m_FF = (prms.FixedFunction.Value == "true") ? true : false;
            ...
            if (m_FF)
                ...
                m_chbxIntSrcTC.Checked = (prms.InterruptOnOverUnderFlow.Value == "true") ? true : false;
        }
        ...
        private void m_chbxIntSrcTC_Changed(object sender, EventArgs e)
        {
            ...
            UpdateCheckBoxParameter("InterruptOnTC", bOnTc, cb.Visible);
            UpdateCheckBoxParameter("InterruptOnOverUnderFlow", bOnOverTc, cb.Visible);
        }
