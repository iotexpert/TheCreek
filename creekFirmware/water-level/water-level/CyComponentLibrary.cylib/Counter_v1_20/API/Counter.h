 ...
 *************************************/
	...
	#define `$INSTANCE_NAME`_AUX_CONTROLDP0        (*(reg8 *) `$INSTANCE_NAME`_CounterUDB_`$VerilogSectionReplacementString`_counterdp_u0__DP_AUX_CTL_REG)
    #define `$INSTANCE_NAME`_AUX_CONTROLDP0_PTR    ( (reg8 *) `$INSTANCE_NAME`_CounterUDB_`$VerilogSectionReplacementString`_counterdp_u0__DP_AUX_CTL_REG)
    #if (`$INSTANCE_NAME`_Resolution == 16 || `$INSTANCE_NAME`_Resolution == 24 || `$INSTANCE_NAME`_Resolution == 32)
       #define `$INSTANCE_NAME`_AUX_CONTROLDP1     (*(reg8 *) `$INSTANCE_NAME`_CounterUDB_`$VerilogSectionReplacementString`_counterdp_u1__DP_AUX_CTL_REG)
       #define `$INSTANCE_NAME`_AUX_CONTROLDP1_PTR ( (reg8 *) `$INSTANCE_NAME`_CounterUDB_`$VerilogSectionReplacementString`_counterdp_u1__DP_AUX_CTL_REG)
    #endif
    #if (`$INSTANCE_NAME`_Resolution == 24 || `$INSTANCE_NAME`_Resolution == 32)
       #define `$INSTANCE_NAME`_AUX_CONTROLDP2     (*(reg8 *) `$INSTANCE_NAME`_CounterUDB_`$VerilogSectionReplacementString`_counterdp_u2__DP_AUX_CTL_REG)
       #define `$INSTANCE_NAME`_AUX_CONTROLDP2_PTR ( (reg8 *) `$INSTANCE_NAME`_CounterUDB_`$VerilogSectionReplacementString`_counterdp_u2__DP_AUX_CTL_REG)
    #endif
    #if (`$INSTANCE_NAME`_Resolution == 32)
       #define `$INSTANCE_NAME`_AUX_CONTROLDP3     (*(reg8 *) `$INSTANCE_NAME`_CounterUDB_`$VerilogSectionReplacementString`_counterdp_u3__DP_AUX_CTL_REG)
       #define `$INSTANCE_NAME`_AUX_CONTROLDP3_PTR ( (reg8 *) `$INSTANCE_NAME`_CounterUDB_`$VerilogSectionReplacementString`_counterdp_u3__DP_AUX_CTL_REG)
    #endif
#endif
