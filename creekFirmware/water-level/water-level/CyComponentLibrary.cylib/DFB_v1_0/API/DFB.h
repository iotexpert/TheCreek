...
***************************************/
    ...
    extern const uint32 CYCODE `$INSTANCE_NAME`_cstoreA[];
    extern const uint32 CYCODE `$INSTANCE_NAME`_cstoreB[];
#else
    extern CYCODE const uint32 `$INSTANCE_NAME`_control[];
#endif /* `$INSTANCE_NAME`_OPTIMIZE_ASSEMBLY */

extern const uint32 CYCODE `$INSTANCE_NAME`_data_a[];
extern const uint32 CYCODE `$INSTANCE_NAME`_data_b[];
extern const uint32 CYCODE `$INSTANCE_NAME`_cfsm[];
extern const uint32 CYCODE `$INSTANCE_NAME`_acu[];
...
uint8  `$INSTANCE_NAME`_LoadDataRAMA(int32 * ptr, uint32 * addr, uint8 size)
        `=ReentrantKeil($INSTANCE_NAME . "_LoadDataRAMA")`;
uint8  `$INSTANCE_NAME`_LoadDataRAMB(int32 * ptr, uint32 * addr, uint8 size)
...
#define `$INSTANCE_NAME`_ClearInterruptSource(event) \
   do {`$INSTANCE_NAME`_SR_REG = ((event) & `$INSTANCE_NAME`_EVENT_MASK) << `$INSTANCE_NAME`_SR_EVENT_SHIFT;} while (0u)
...
#define `$INSTANCE_NAME`_STGA_KEY_LOW     (0x00u << `$INSTANCE_NAME`_STGA_KEY_SHIFT)
#define `$INSTANCE_NAME`_STGA_KEY_MID     (0x01u << `$INSTANCE_NAME`_STGA_KEY_SHIFT)
#define `$INSTANCE_NAME`_STGA_KEY_HIGH    (0x02u << `$INSTANCE_NAME`_STGA_KEY_SHIFT)
#define `$INSTANCE_NAME`_STGB_KEY_LOW     (0x00u << `$INSTANCE_NAME`_STGB_KEY_SHIFT)
#define `$INSTANCE_NAME`_STGB_KEY_MID     (0x01u << `$INSTANCE_NAME`_STGB_KEY_SHIFT)
#define `$INSTANCE_NAME`_STGB_KEY_HIGH    (0x02u << `$INSTANCE_NAME`_STGB_KEY_SHIFT)
#define `$INSTANCE_NAME`_HOLDA_KEY_LOW    (0x00u << `$INSTANCE_NAME`_HOLDA_KEY_SHIFT)
#define `$INSTANCE_NAME`_HOLDA_KEY_MID    (0x01u << `$INSTANCE_NAME`_HOLDA_KEY_SHIFT)
#define `$INSTANCE_NAME`_HOLDA_KEY_HIGH   (0x02u << `$INSTANCE_NAME`_HOLDA_KEY_SHIFT)
#define `$INSTANCE_NAME`_HOLDB_KEY_LOW    (0x00u << `$INSTANCE_NAME`_HOLDB_KEY_SHIFT)
#define `$INSTANCE_NAME`_HOLDB_KEY_MID    (0x01u << `$INSTANCE_NAME`_HOLDB_KEY_SHIFT)
#define `$INSTANCE_NAME`_HOLDB_KEY_HIGH   (0x02u << `$INSTANCE_NAME`_HOLDB_KEY_SHIFT)
...
#define `$INSTANCE_NAME`_STGA_DALIGN_LOW      (0x00u << `$INSTANCE_NAME`_STGA_DALIGN_SHIFT)
#define `$INSTANCE_NAME`_STGA_DALIGN_HIGH     (0x01u << `$INSTANCE_NAME`_STGA_DALIGN_SHIFT)
#define `$INSTANCE_NAME`_STGB_DALIGN_LOW      (0x00u << `$INSTANCE_NAME`_STGB_DALIGN_SHIFT)
#define `$INSTANCE_NAME`_STGB_DALIGN_HIGH     (0x01u << `$INSTANCE_NAME`_STGB_DALIGN_SHIFT)
#define `$INSTANCE_NAME`_HOLDA_DALIGN_LOW     (0x00u << `$INSTANCE_NAME`_HOLDA_DALIGN_SHIFT)
#define `$INSTANCE_NAME`_HOLDA_DALIGN_HIGH    (0x01u << `$INSTANCE_NAME`_HOLDA_DALIGN_SHIFT)
#define `$INSTANCE_NAME`_HOLDB_DALIGN_LOW     (0x00u << `$INSTANCE_NAME`_HOLDB_DALIGN_SHIFT)
#define `$INSTANCE_NAME`_HOLDB_DALIGN_HIGH    (0x01u << `$INSTANCE_NAME`_HOLDB_DALIGN_SHIFT)
...
#define `$INSTANCE_NAME`_HOLDA                (0x01u << `$INSTANCE_NAME`_HOLDA_SHIFT)
#define `$INSTANCE_NAME`_HOLDB                (0x01u << `$INSTANCE_NAME`_HOLDB_SHIFT)
#define `$INSTANCE_NAME`_SEMA0                (0x01u << `$INSTANCE_NAME`_SEMA0_SHIFT)
#define `$INSTANCE_NAME`_SEMA1                (0x01u << `$INSTANCE_NAME`_SEMA1_SHIFT)
#define `$INSTANCE_NAME`_SEMA2                (0x01u << `$INSTANCE_NAME`_SEMA2_SHIFT)
