...
*
*******************************************************************************/
void `$INSTANCE_NAME`_SetInterruptMode(uint8 events)
{
    events &= `$INSTANCE_NAME`_EVENT_MASK;
    `$INSTANCE_NAME`_INT_CTRL = events;
}
...
*
*******************************************************************************/
void `$INSTANCE_NAME`_SetDMAMode(uint8 events)
{
    events &= `$INSTANCE_NAME`_DMA_CTRL_MASK;
    `$INSTANCE_NAME`_DMA_CTRL = events;
}
