...
using CapSense_CSD_AMux_v2_0.LogicGateCustomizer;
using System.Diagnostics;
using System.Drawing;
using CyDesigner.Extensions.Gde;

namespace CyCustomizer.CapSense_CSD_AMux_v2_0
{
    public partial class CyCustomizer : ICyShapeCustomize_v1
    {
        ...
        private List<string> GetTermNames(ICyInstQuery_v1 instQuery, ICyTerminalQuery_v1 termQuery, ref uint numTerminals)
        {
            // Get parameters
