...
#define i2c_I2C_MODE_MULTI_MASTER_MASK  (0x04u)
    ...
    #define i2c_I2C_BTLDR_COMM_ENABLED ((CYDEV_BOOTLOADER_IO_COMP == CyBtldr_i2c) || \
    ...
    #define i2c_I2C_BTLDR_COMM_ENABLED     (i2c_I2C_SLAVE_CONST && \
...
#define i2c_I2C_ACK_DATA           (0u)    /* Send ACK */
#define i2c_I2C_NAK_DATA           (1u)    /* Send NAK */
...
#define i2c_I2C_MSTR_ERR_ARB_LOST      (0x01u)  /* Master lost arb: INTR_MASTER_I2C_ARB_LOST             */
...
#define i2c_I2C_MSTR_ERR_BUS_ERR       (0x100u) /* Bus eror has: INTR_MASTER_I2C_BUS_ERROR               */
...
#define i2c_I2C_SSTAT_RD_OVFL          (0x04u)    /* Read overflow: master reads above buf size   */
...
#define i2c_I2C_SSTAT_WR_OVFL          (0x40u)    /* Write overflow: master writes above buf size  */
...
#define i2c_I2C_FIFO_SIZE              (8u)    /* Max FIFO entries for I2C */
...
/* Return TRUE if sourceMask is set in i2c_I2C_MASTER_CMD_REG: used to check if Start was generated */
#define i2c_CHECK_I2C_MASTER_CMD(sourceMask)   (0u != (i2c_I2C_MASTER_CMD_REG & (sourceMask)))

/* Return TRUE if i2c_MODE_NO_STOP is set in i2c_mstrControl: used to detect NoStop cond */
#define i2c_CHECK_I2C_MODE_NO_STOP(mode)   (0u != (i2c_I2C_MODE_NO_STOP & (mode)))

/* Return TRUE if i2c_MODE_REPEAT_START is set: used to detect when generate ReStart condition */
#define i2c_CHECK_I2C_MODE_RESTART(mode)   (0u != (i2c_I2C_MODE_REPEAT_START  & (mode)))

/* Return TRUE if i2c_state is in one of master states */
...
***************************************/
    ...
    #define i2c_I2C_DEFAULT_CTRL \
                                (i2c_GET_CTRL_ADDR_ACCEPT(i2c_I2C_ACCEPT_ADDRESS) | \
                                 i2c_GET_CTRL_EC_AM_MODE (i2c_I2C_WAKE_ENABLE))

    #define i2c_I2C_DEFAULT_I2C_CTRL \
                                (i2c_GET_I2C_CTRL_HIGH_PHASE_OVS(i2c_I2C_OVS_FACTOR_HIGH) | \
                                 i2c_GET_I2C_CTRL_LOW_PHASE_OVS (i2c_I2C_OVS_FACTOR_LOW)  | \
                                 i2c_GET_I2C_CTRL_SL_MSTR_MODE  (i2c_I2C_MODE)            | \
                                 i2c_I2C_CTRL)
    ...
    #define i2c_I2C_DEFAULT_RX_CTRL \
                                (i2c_GET_RX_CTRL_MEDIAN(i2c_I2C_MEDIAN_FILTER_ENABLE) | \
                                 i2c_I2C_RX_CTRL)
