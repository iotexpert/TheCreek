...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\arh\Desktop\CreekFirmware\p4arduino-creek.cydsn\p4arduino-creek.svd" rem "C:\Users\arh\Desktop\CreekFirmware\p4arduino-creek.cydsn\p4arduino-creek.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
