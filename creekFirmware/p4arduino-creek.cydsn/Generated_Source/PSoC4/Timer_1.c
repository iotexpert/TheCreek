...
*
* Summary:
*  Initialize the Timer_1 with default customizer
...
*  Timer_1 operates in continuous mode.
*
* Parameters:
*  oneShotEnable
*   Values:
...
*   Values:
*     - Timer_1_CMD_CAPTURE    - Trigger Capture command
*     - Timer_1_CMD_RELOAD     - Trigger Reload command
*     - Timer_1_CMD_STOP       - Trigger Stop command
*     - Timer_1_CMD_START      - Trigger Start command
*
* Return:
*  None
*
