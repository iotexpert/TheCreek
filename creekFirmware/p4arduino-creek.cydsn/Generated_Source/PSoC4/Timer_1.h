...
/* Interrupt Mask */
#define Timer_1_TC_INTERRUPT_MASK              (0lu)
...
#define Timer_1_PWM_COMPARE_VALUE              (32768lu)
...
/* Trigger modes */
#define Timer_1_TRIG_RISING                    (Timer_1__TRIG_RISING)
#define Timer_1_TRIG_FALLING                   (Timer_1__TRIG_FALLING)
#define Timer_1_TRIG_BOTH                      (Timer_1__TRIG_BOTH)
#define Timer_1_TRIG_LEVEL                     (Timer_1__TRIG_LEVEL)

/* Interrupt mask */
#define Timer_1_INTR_MASK_TC                   (Timer_1__INTR_MASK_TC)
#define Timer_1_INTR_MASK_CC_MATCH             (Timer_1__INTR_MASK_CC_MATCH)
...
#define Timer_1_PWM_MODE_CENTER                (Timer_1_CC_MATCH_INVERT       |   \
                                                         Timer_1_OVERLOW_NO_CHANGE     |   \
                                                         Timer_1_UNDERFLOW_CLEAR)
#define Timer_1_PWM_MODE_ASYM                  (Timer_1_CC_MATCH_NO_CHANGE    |   \
                                                         Timer_1_OVERLOW_SET           |   \
                                                         Timer_1_UNDERFLOW_CLEAR )
