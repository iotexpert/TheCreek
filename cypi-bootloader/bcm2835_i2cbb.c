...
#define P4RESET 17
    ...
    printf("start reset\n");
    bcm2835_gpio_write(P4RESET,HIGH);
    printf("write pin\n");
    delay(2000);
    bcm2835_gpio_write(P4RESET,LOW);
    ...
    //    if(bcm2835_i2cbb_open(&ibb,0x08,RPI_GPIO_P1_03,RPI_GPIO_P1_05,250,1000000)) exit(1);
    if(bcm2835_i2cbb_open(&ibb,0x10,2,3,250,1000000)) exit(1);

    //    bcm8235_i2cbb_discover(&ibb, 0x02, 0xe0);    
    // discover addresses on bus


    ibb.address = 0x08;
    
    //bcm8235_i2cbb_puts("abc");
